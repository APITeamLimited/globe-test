...
func (es *ExecutorState) GetInitializedVUsCount() uint64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) GetCurrentlyActiveVUsCount() uint64 ***REMOVED***
...
func (es *ExecutorState) ReturnVU(vu VU) ***REMOVED***
	es.vus <- vu
