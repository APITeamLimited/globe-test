...
type ExecutorState struct ***REMOVED***
...
func NewExecutorState(options Options, maxPlannedVUs, maxPossibleVUs uint64) *ExecutorState ***REMOVED***
...
func (es *ExecutorState) GetUniqueVUIdentifier() uint64 ***REMOVED***
...
func (es *ExecutorState) GetInitializedVUsCount() int64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) ModInitializedVUsCount(mod int64) int64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) GetCurrentlyActiveVUsCount() int64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) ModCurrentlyActiveVUsCount(mod int64) int64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) GetFullIterationCount() uint64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) AddFullIterations(count uint64) uint64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) GetPartialIterationCount() uint64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) AddPartialIterations(count uint64) uint64 ***REMOVED***
...
// result in a panic!
func (es *ExecutorState) MarkStarted() ***REMOVED***
...
// result in a panic!
func (es *ExecutorState) MarkEnded() ***REMOVED***
...
func (es *ExecutorState) HasStarted() bool ***REMOVED***
...
func (es *ExecutorState) HasEnded() bool ***REMOVED***
...
func (es *ExecutorState) IsPaused() bool ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutorState) GetCurrentTestRunDuration() time.Duration ***REMOVED***
...
func (es *ExecutorState) Pause() error ***REMOVED***
...
func (es *ExecutorState) Resume() error ***REMOVED***
	es.pauseStateLock.Lock()
	defer es.pauseStateLock.Unlock()
...
//   ***REMOVED***
func (es *ExecutorState) ResumeNotify() <-chan struct***REMOVED******REMOVED*** ***REMOVED***
	es.pauseStateLock.RLock()
...
func (es *ExecutorState) GetPlannedVU(logger *logrus.Entry, modifyAtiveVUCount bool) (VU, error) ***REMOVED***
	for i := 1; i <= MaxRetriesGetPlannedVU; i++ ***REMOVED***
		select ***REMOVED***
		case vu := <-es.vus:
			if modifyAtiveVUCount ***REMOVED***
...
func (es *ExecutorState) SetInitVUFunc(initVUFunc InitVUFunc) ***REMOVED***
...
func (es *ExecutorState) GetUnplannedVU(ctx context.Context, logger *logrus.Entry) (VU, error) ***REMOVED***
...
// tracking counters.
func (es *ExecutorState) InitializeNewVU(ctx context.Context, logger *logrus.Entry) (VU, error) ***REMOVED***
...
func (es *ExecutorState) AddInitializedVU(vu VU) ***REMOVED***
	es.vus <- vu
	es.ModInitializedVUsCount(+1)
***REMOVED***
...
func (es *ExecutorState) ReturnVU(vu VU, wasActive bool) ***REMOVED***
	es.vus <- vu
