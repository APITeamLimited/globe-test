...
func NewExecutionState(options Options, maxPlannedVUs, maxPossibleVUs uint64) *ExecutionState ***REMOVED***
...
func (es *ExecutionState) GetUniqueVUIdentifier() uint64 ***REMOVED***
...
//
// IMPORTANT: for UI/information purposes only, don't use for synchronization.
func (es *ExecutionState) AddPartialIterations(count uint64) uint64 ***REMOVED***
...
func (es *ExecutionState) GetPlannedVU(logger *logrus.Entry, modifyAtiveVUCount bool) (VU, error) ***REMOVED***
