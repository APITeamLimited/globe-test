...
func NewOldEngine(r Runner) (*OldEngine, error) ***REMOVED***
	e := &OldEngine***REMOVED***
		Runner: r,
...
func (e *OldEngine) Apply(opts Options) error ***REMOVED***
...
func (e *OldEngine) Run(ctx context.Context) error ***REMOVED***
...
func (e *OldEngine) IsRunning() bool ***REMOVED***
	return e.ctx != nil
***REMOVED***

func (e *OldEngine) TotalTime() (total time.Duration, finite bool) ***REMOVED***
...
func (e *OldEngine) SetRunning(running bool) ***REMOVED***
...
func (e *OldEngine) SetVUs(v int64) error ***REMOVED***
...
func (e *OldEngine) SetMaxVUs(v int64) error ***REMOVED***
...
func (e *OldEngine) runVU(ctx context.Context, id int64, vu *vuEntry) ***REMOVED***
...
func (e *OldEngine) runThresholds(ctx context.Context) ***REMOVED***
			...
			for m, sink := range e.Metrics ***REMOVED***
				...
				***REMOVED***
				...
				for key, value := range sample ***REMOVED***
					...
					***REMOVED***
					...
					if err := e.thresholdVM.Set(key, value); err != nil ***REMOVED***
				...
				***REMOVED***
				...
				for key, _ := range sample ***REMOVED***
					if err := e.thresholdVM.Set(key, otto.UndefinedValue()); err != nil ***REMOVED***
...
func (e *OldEngine) getSink(m *stats.Metric) stats.Sink ***REMOVED***
	s, ok := e.Metrics[m]
	if !ok ***REMOVED***
...
func (e *OldEngine) consumeBuffer(buffer []stats.Sample) ***REMOVED***
...
func (e *OldEngine) consumeOldEngineStats() ***REMOVED***
	t := time.Now()
