...
func (t *Tracer) Done() Trail ***REMOVED***
	...
	***REMOVED***
	if t.wroteRequest != 0 ***REMOVED***
		...
		if t.tlsHandshakeDone != 0 ***REMOVED***
			trail.Sending = time.Duration(t.wroteRequest - t.tlsHandshakeDone)
		***REMOVED***

		if t.gotFirstResponseByte != 0 ***REMOVED***
