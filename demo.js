...
export const options = ***REMOVED***
    ...
    scenarios: ***REMOVED***
      contacts: ***REMOVED***
        ...
        startRate: 50,
        stages: [
          ***REMOVED*** target: 200, duration: '30s' ***REMOVED***, // linearly go from 50 iters/s to 200 iters/s for 30s
          ***REMOVED*** target: 500, duration: '0' ***REMOVED***, // instantly jump to 500 iters/s
          ***REMOVED*** target: 500, duration: '10m' ***REMOVED***, // continue with 500 iters/s for 10 minutes
        ],
      ***REMOVED***,
    ***REMOVED***,
  ***REMOVED***;
