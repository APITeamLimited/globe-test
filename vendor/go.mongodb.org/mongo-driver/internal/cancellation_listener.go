...
type CancellationListener struct ***REMOVED***
	aborted bool
	done    chan struct***REMOVED******REMOVED***
***REMOVED***

// NewCancellationListener constructs a CancellationListener.
func NewCancellationListener() *CancellationListener ***REMOVED***
	return &CancellationListener***REMOVED***
...
func (c *CancellationListener) Listen(ctx context.Context, abortFn func()) ***REMOVED***
	c.aborted = false
...
func (c *CancellationListener) StopListening() bool ***REMOVED***
