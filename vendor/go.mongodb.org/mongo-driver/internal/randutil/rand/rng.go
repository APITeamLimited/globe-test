...
func (pcg *PCGSource) Seed(seed uint64) ***REMOVED***
	pcg.low = seed
	pcg.high = seed // TODO: What is right?
***REMOVED***

// Uint64 returns a pseudo-random 64-bit unsigned integer as a uint64.
func (pcg *PCGSource) Uint64() uint64 ***REMOVED***
	pcg.multiply()
	pcg.add()
...
func (pcg *PCGSource) MarshalBinary() ([]byte, error) ***REMOVED***
	var buf [16]byte
...
func (pcg *PCGSource) UnmarshalBinary(data []byte) error ***REMOVED***
