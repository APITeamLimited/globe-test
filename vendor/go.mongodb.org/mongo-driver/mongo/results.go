...
type BulkWriteResult struct ***REMOVED***
...
// rewrapped data keys.
type RewrapManyDataKeyResult struct ***REMOVED***
	*BulkWriteResult
***REMOVED***
...
func newListDatabasesResultFromOperation(res operation.ListDatabasesResult) ListDatabasesResult ***REMOVED***
	...
	for _, spec := range res.Databases ***REMOVED***
		ldr.Databases = append(
			ldr.Databases,
			DatabaseSpecification***REMOVED***Name: spec.Name, SizeOnDisk: spec.SizeOnDisk, Empty: spec.Empty***REMOVED***,
		)
	***REMOVED***
...
type DatabaseSpecification struct ***REMOVED***
...
type UpdateResult struct ***REMOVED***
	...
	UpsertedID    interface***REMOVED******REMOVED*** // The _id field of the upserted document, or nil if no upsert was done.
***REMOVED***
...
func (result *UpdateResult) UnmarshalBSON(b []byte) error ***REMOVED***
		...
		case "upserted":
			...
			case bson.TypeArray:
				...
				if err != nil ***REMOVED***
					break
				***REMOVED***
				if e.Value().Type != bson.TypeEmbeddedDocument ***REMOVED***
					break
				***REMOVED***
				var d struct ***REMOVED***
...
type IndexSpecification struct ***REMOVED***
	// The index name.
	Name string
...
type unmarshalIndexSpecification struct ***REMOVED***
...
// UnmarshalBSON implements the bson.Unmarshaler interface.
func (i *IndexSpecification) UnmarshalBSON(data []byte) error ***REMOVED***
...
type CollectionSpecification struct ***REMOVED***
	// The collection name.
	Name string
...
type unmarshalCollectionSpecification struct ***REMOVED***
	Name string `bson:"name"`
...
// UnmarshalBSON implements the bson.Unmarshaler interface.
func (cs *CollectionSpecification) UnmarshalBSON(data []byte) error ***REMOVED***
