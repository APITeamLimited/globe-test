...
// mode.
func ModeFromString(mode string) (Mode, error) ***REMOVED***
	switch strings.ToLower(mode) ***REMOVED***
	case "primary":
...
func (mode Mode) String() string ***REMOVED***
	switch mode ***REMOVED***
	case PrimaryMode:
		return "primary"
...
func (mode Mode) IsValid() bool ***REMOVED***
	switch mode ***REMOVED***
	case PrimaryMode,
		PrimaryPreferredMode,
		SecondaryMode,
