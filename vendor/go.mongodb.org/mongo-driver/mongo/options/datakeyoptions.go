...
func (dk *DataKeyOptions) SetMasterKey(masterKey interface***REMOVED******REMOVED***) *DataKeyOptions ***REMOVED***
...
func (dk *DataKeyOptions) SetKeyAltNames(keyAltNames []string) *DataKeyOptions ***REMOVED***
...
func (dk *DataKeyOptions) SetKeyMaterial(keyMaterial []byte) *DataKeyOptions ***REMOVED***
	dk.KeyMaterial = keyMaterial
	return dk
***REMOVED***

// MergeDataKeyOptions combines the argued DataKeyOptions in a last-one wins fashion.
func MergeDataKeyOptions(opts ...*DataKeyOptions) *DataKeyOptions ***REMOVED***
	dko := DataKey()
	for _, opt := range opts ***REMOVED***
		...
		***REMOVED***
		...
		if opt.MasterKey != nil ***REMOVED***
			dko.MasterKey = opt.MasterKey
		***REMOVED***
		if opt.KeyAltNames != nil ***REMOVED***
			dko.KeyAltNames = opt.KeyAltNames
		***REMOVED***
		if opt.KeyMaterial != nil ***REMOVED***
