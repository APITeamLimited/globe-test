...
type ListDatabasesOptions struct ***REMOVED***
...
func ListDatabases() *ListDatabasesOptions ***REMOVED***
	return &ListDatabasesOptions***REMOVED******REMOVED***
***REMOVED***

// SetNameOnly sets the value for the NameOnly field.
func (ld *ListDatabasesOptions) SetNameOnly(b bool) *ListDatabasesOptions ***REMOVED***
	ld.NameOnly = &b
	return ld
***REMOVED***

// SetAuthorizedDatabases sets the value for the AuthorizedDatabases field.
func (ld *ListDatabasesOptions) SetAuthorizedDatabases(b bool) *ListDatabasesOptions ***REMOVED***
...
func MergeListDatabasesOptions(opts ...*ListDatabasesOptions) *ListDatabasesOptions ***REMOVED***
	ld := ListDatabases()
	for _, opt := range opts ***REMOVED***
		...
		***REMOVED***
		if opt.AuthorizedDatabases != nil ***REMOVED***
