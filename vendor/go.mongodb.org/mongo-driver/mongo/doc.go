...
//
//    res, err := collection.InsertOne(context.Background(), bson.M***REMOVED***"hello": "world"***REMOVED***)
//    if err != nil ***REMOVED*** return err ***REMOVED***
//    id := res.InsertedID
//
// Several methods return a cursor, which can be used like this:
//
//    cur, err := collection.Find(context.Background(), bson.D***REMOVED******REMOVED***)
//    if err != nil ***REMOVED*** log.Fatal(err) ***REMOVED***
//    defer cur.Close(context.Background())
//    for cur.Next(context.Background()) ***REMOVED***
//      // To decode into a struct, use cursor.Decode()
//      result := struct***REMOVED***
//        Foo string
//        Bar int32
...
//    ***REMOVED***
//    if err := cur.Err(); err != nil ***REMOVED***
//      return err
//    ***REMOVED***
//
// Cursor.All will decode all of the returned elements at once:
//
//    var results []struct***REMOVED***
//      Foo string
//      Bar int32
//    ***REMOVED***
//    if err = cur.All(context.Background(), &results); err != nil ***REMOVED***
//      log.Fatal(err)
//    ***REMOVED***
...
//      Bar int32
//    ***REMOVED******REMOVED******REMOVED***
//    filter := bson.D***REMOVED******REMOVED***"hello", "world"***REMOVED******REMOVED***
//    err := collection.FindOne(context.Background(), filter).Decode(&result)
//    if err != nil ***REMOVED*** return err ***REMOVED***
//    // do something with result...
//
// All Client, Collection, and Database methods that take parameters of type interface***REMOVED******REMOVED***
// will return ErrNilDocument if nil is passed in for an interface***REMOVED******REMOVED***.
//
