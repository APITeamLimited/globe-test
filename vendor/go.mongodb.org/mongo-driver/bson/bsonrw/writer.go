...
// the array.
type ArrayWriter interface ***REMOVED***
...
type DocumentWriter interface ***REMOVED***
...
// values.
type ValueWriter interface ***REMOVED***
...
type ValueWriterFlusher interface ***REMOVED***
	ValueWriter
	Flush() error
***REMOVED***
...
type BytesWriter interface ***REMOVED***
...
func (sw *SliceWriter) Write(p []byte) (int, error) ***REMOVED***
	written := len(p)
	*sw = append(*sw, p...)
	return written, nil
***REMOVED***
