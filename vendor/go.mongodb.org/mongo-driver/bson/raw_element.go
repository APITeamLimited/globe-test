...
func (re RawElement) Key() string ***REMOVED*** return bsoncore.Element(re).Key() ***REMOVED***

// KeyErr returns the key for this element, returning an error if the element is not valid.
func (re RawElement) KeyErr() (string, error) ***REMOVED*** return bsoncore.Element(re).KeyErr() ***REMOVED***
...
func (re RawElement) Value() RawValue ***REMOVED*** return convertFromCoreValue(bsoncore.Element(re).Value()) ***REMOVED***

// ValueErr returns the value for this element, returning an error if the element is not valid.
func (re RawElement) ValueErr() (RawValue, error) ***REMOVED***
	val, err := bsoncore.Element(re).ValueErr()
	return convertFromCoreValue(val), err
***REMOVED***

// Validate ensures re is a valid BSON element.
func (re RawElement) Validate() error ***REMOVED*** return bsoncore.Element(re).Validate() ***REMOVED***

// String implements the fmt.Stringer interface. The output will be in extended JSON format.
func (re RawElement) String() string ***REMOVED***
...
func (re RawElement) DebugString() string ***REMOVED*** return bsoncore.Element(re).DebugString() ***REMOVED***
