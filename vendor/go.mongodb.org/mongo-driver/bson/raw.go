...
// it.
func NewFromIOReader(r io.Reader) (Raw, error) ***REMOVED***
...
func (r Raw) Validate() (err error) ***REMOVED*** return bsoncore.Document(r).Validate() ***REMOVED***
...
func (r Raw) Lookup(key ...string) RawValue ***REMOVED***
...
func (r Raw) LookupErr(key ...string) (RawValue, error) ***REMOVED***
...
// along with an error.
func (r Raw) Elements() ([]RawElement, error) ***REMOVED***
...
// error.
func (r Raw) Values() ([]RawValue, error) ***REMOVED***
...
func (r Raw) Index(index uint) RawElement ***REMOVED*** return RawElement(bsoncore.Document(r).Index(index)) ***REMOVED***

// IndexErr searches for and retrieves the element at the given index.
func (r Raw) IndexErr(index uint) (RawElement, error) ***REMOVED***
	elem, err := bsoncore.Document(r).IndexErr(index)
	return RawElement(elem), err
***REMOVED***

// String implements the fmt.Stringer interface.
func (r Raw) String() string ***REMOVED*** return bsoncore.Document(r).String() ***REMOVED***
