...
//
//     5. When unmarshalling, a field of type interface***REMOVED******REMOVED*** will follow the D/M type mappings listed above. BSON documents
//     unmarshalled into an interface***REMOVED******REMOVED*** field will be unmarshalled as a D.
//
...
//     map field named "Map" with value map[string]interface***REMOVED******REMOVED******REMOVED***"foo": "bar"***REMOVED*** is inlined, the resulting document will be
//     ***REMOVED***"foo": "bar"***REMOVED*** instead of ***REMOVED***"map": ***REMOVED***"foo": "bar"***REMOVED******REMOVED***. There can only be one inlined map field in a struct. If there are
