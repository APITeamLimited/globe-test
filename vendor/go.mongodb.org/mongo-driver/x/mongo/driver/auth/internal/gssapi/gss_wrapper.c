...
***REMOVED***
    ...
    ***REMOVED***
        ...
        if (GSS_ERROR(local_maj_stat)) ***REMOVED***
            return GSSAPI_ERROR;
        ***REMOVED***
...
***REMOVED***
    ...
    if (GSS_ERROR(client->maj_stat)) ***REMOVED***
        return GSSAPI_ERROR;
    ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    if (output_buffer.length) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (GSS_ERROR(client->maj_stat)) ***REMOVED***
        return GSSAPI_ERROR;
    ***REMOVED*** else if (client->maj_stat == GSS_S_CONTINUE_NEEDED) ***REMOVED***
...
***REMOVED***
    OM_uint32 ignored;
    if (client->ctx != GSS_C_NO_CONTEXT) ***REMOVED***
        gss_delete_sec_context(&ignored, &client->ctx, GSS_C_NO_BUFFER);
    ***REMOVED***

    if (client->spn != GSS_C_NO_NAME) ***REMOVED***
        gss_release_name(&ignored, &client->spn);
    ***REMOVED***

    if (client->cred != GSS_C_NO_CREDENTIAL) ***REMOVED***
