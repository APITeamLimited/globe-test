...
func newMongoDBCRAuthenticator(cred *Cred) (Authenticator, error) ***REMOVED***
	return &MongoDBCRAuthenticator***REMOVED***
		DB:       cred.Source,
...
// The MONGODB-CR authentication mechanism is deprecated in MongoDB 3.6 and removed in
// MongoDB 4.0.
type MongoDBCRAuthenticator struct ***REMOVED***
	DB       string
	Username string
	Password string
***REMOVED***
...
// The MONGODB-CR authentication mechanism is deprecated in MongoDB 3.6 and removed in
// MongoDB 4.0.
func (a *MongoDBCRAuthenticator) Auth(ctx context.Context, cfg *Config) error ***REMOVED***
	...
	***REMOVED***
	...
	var getNonceResult struct ***REMOVED***
...
func (a *MongoDBCRAuthenticator) createKey(nonce string) string ***REMOVED***
