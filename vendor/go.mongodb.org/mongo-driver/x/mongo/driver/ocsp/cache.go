...
type ConcurrentCache struct ***REMOVED***
...
func NewCache() *ConcurrentCache ***REMOVED***
	return &ConcurrentCache***REMOVED***
...
func (c *ConcurrentCache) Update(request *ocsp.Request, response *ResponseDetails) *ResponseDetails ***REMOVED***
	...
	***REMOVED***
	...
	newest := current
	if response.NextUpdate.After(current.NextUpdate) ***REMOVED***
		c.cache[key] = response
		newest = response
	***REMOVED***
	return newest
...
func (c *ConcurrentCache) Get(request *ocsp.Request) *ResponseDetails ***REMOVED***
	key := createCacheKey(request)
	...
	***REMOVED***
	...
	if time.Now().UTC().Before(response.NextUpdate) ***REMOVED***
		return response
	***REMOVED***
	delete(c.cache, key)
	return nil
...
func createCacheKey(request *ocsp.Request) cacheKey ***REMOVED***
	return cacheKey***REMOVED***
