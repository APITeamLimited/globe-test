...
type KmsContext struct ***REMOVED***
	wrapped *C.mongocrypt_kms_ctx_t
***REMOVED***

// newKmsContext creates a KmsContext wrapper around the given C type.
func newKmsContext(wrapped *C.mongocrypt_kms_ctx_t) *KmsContext ***REMOVED***
	return &KmsContext***REMOVED***
		wrapped: wrapped,
	***REMOVED***
***REMOVED***
...
func (kc *KmsContext) HostName() (string, error) ***REMOVED***
	...
	if ok := C.mongocrypt_kms_ctx_endpoint(kc.wrapped, &hostname); !ok ***REMOVED***
...
func (kc *KmsContext) Message() ([]byte, error) ***REMOVED***
	...
	if ok := C.mongocrypt_kms_ctx_message(kc.wrapped, msgBinary.wrapped); !ok ***REMOVED***
...
func (kc *KmsContext) FeedResponse(response []byte) error ***REMOVED***
	...
	if ok := C.mongocrypt_kms_ctx_feed(kc.wrapped, responseBinary.wrapped); !ok ***REMOVED***
		return kc.createErrorFromStatus()
	***REMOVED***
	return nil
***REMOVED***
...
func (kc *KmsContext) createErrorFromStatus() error ***REMOVED***
