...
type Connection interface ***REMOVED***
...
type PinnedConnection interface ***REMOVED***
	Connection
	PinToCursor() error
...
type LocalAddresser interface ***REMOVED***
	LocalAddress() address.Address
***REMOVED***

// Expirable represents an expirable object.
type Expirable interface ***REMOVED***
	Expire() error
	Alive() bool
***REMOVED***
...
type StreamerConnection interface ***REMOVED***
	Connection
	SetStreaming(bool)
...
func (p ProcessErrorResult) ServerChanged() bool ***REMOVED***
	return p != NoChange
***REMOVED***
...
type ErrorProcessor interface ***REMOVED***
...
type HandshakeInformation struct ***REMOVED***
	Description             description.Server
...
type SingleServerDeployment struct***REMOVED*** Server ***REMOVED***

var _ Deployment = SingleServerDeployment***REMOVED******REMOVED***
...
func (ssd SingleServerDeployment) SelectServer(context.Context, description.ServerSelector) (Server, error) ***REMOVED***
	return ssd.Server, nil
***REMOVED***

// Kind implements the Deployment interface. It always returns description.Single.
func (SingleServerDeployment) Kind() description.TopologyKind ***REMOVED*** return description.Single ***REMOVED***
...
type SingleConnectionDeployment struct***REMOVED*** C Connection ***REMOVED***

var _ Deployment = SingleConnectionDeployment***REMOVED******REMOVED***
var _ Server = SingleConnectionDeployment***REMOVED******REMOVED***
...
func (ssd SingleConnectionDeployment) SelectServer(context.Context, description.ServerSelector) (Server, error) ***REMOVED***
	return ssd, nil
***REMOVED***

// Kind implements the Deployment interface. It always returns description.Single.
func (ssd SingleConnectionDeployment) Kind() description.TopologyKind ***REMOVED*** return description.Single ***REMOVED***

// Connection implements the Server interface. It always returns the embedded connection.
func (ssd SingleConnectionDeployment) Connection(context.Context) (Connection, error) ***REMOVED***
	return ssd.C, nil
***REMOVED***

// MinRTT always returns 0. It implements the driver.Server interface.
func (ssd SingleConnectionDeployment) MinRTT() time.Duration ***REMOVED***
	return 0
***REMOVED***

// RTT90 always returns 0. It implements the driver.Server interface.
func (ssd SingleConnectionDeployment) RTT90() time.Duration ***REMOVED***
	return 0
***REMOVED***
...
func (rm RetryMode) Enabled() bool ***REMOVED***
