...
type tlsConn interface ***REMOVED***
	net.Conn
...
type tlsConnectionSource interface ***REMOVED***
...
func (t tlsConnectionSourceFn) Client(nc net.Conn, cfg *tls.Config) tlsConn ***REMOVED***
	return t(nc, cfg)
***REMOVED***

var defaultTLSConnectionSource tlsConnectionSourceFn = func(nc net.Conn, cfg *tls.Config) tlsConn ***REMOVED***
...
func clientHandshake(ctx context.Context, client tlsConn) error ***REMOVED***
