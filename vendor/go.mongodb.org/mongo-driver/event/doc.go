...
//    cmdMonitor := &event.CommandMonitor***REMOVED***
//      Started: func(_ context.Context, evt *event.CommandStartedEvent) ***REMOVED***
...
//    poolMonitor := &event.PoolMonitor***REMOVED***
//      Event: func(evt *event.PoolEvent) ***REMOVED***
...
//    svrMonitor := &event.ServerMonitor***REMOVED***
//      ServerHeartbeatStarted: func(e *event.ServerHeartbeatStartedEvent) ***REMOVED***
