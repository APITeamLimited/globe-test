...
type CommandStartedEvent struct ***REMOVED***
	Command      bson.Raw
	DatabaseName string
	CommandName  string
	RequestID    int64
...
type CommandFinishedEvent struct ***REMOVED***
	DurationNanos int64
	CommandName   string
	RequestID     int64
	ConnectionID  string
...
type CommandSucceededEvent struct ***REMOVED***
	CommandFinishedEvent
	Reply bson.Raw
***REMOVED***

// CommandFailedEvent represents an event generated when a command's execution fails.
type CommandFailedEvent struct ***REMOVED***
	CommandFinishedEvent
	Failure string
***REMOVED***

// CommandMonitor represents a monitor that is triggered for different events.
type CommandMonitor struct ***REMOVED***
...
type MonitorPoolOptions struct ***REMOVED***
...
type ServerHeartbeatSucceededEvent struct ***REMOVED***
	DurationNanos int64
...
type ServerHeartbeatFailedEvent struct ***REMOVED***
	DurationNanos int64
	Failure       error
	ConnectionID  string // The address this heartbeat was sent to with a unique identifier
	Awaited       bool   // If this heartbeat was awaitable
...
type ServerMonitor struct ***REMOVED***
