...
type FileDescriptor interface ***REMOVED***
	...
	isFileDescriptor
***REMOVED***
type isFileDescriptor interface***REMOVED*** ProtoType(FileDescriptor) ***REMOVED***

// FileImports is a list of file imports.
type FileImports interface ***REMOVED***
...
type FileImport struct ***REMOVED***
...
type MessageDescriptor interface ***REMOVED***
	Descriptor
	...
	isMessageDescriptor
***REMOVED***
type isMessageDescriptor interface***REMOVED*** ProtoType(MessageDescriptor) ***REMOVED***

// MessageType encapsulates a MessageDescriptor with a concrete Go implementation.
// It is recommended that implementations of this interface also implement the
// MessageFieldTypes interface.
type MessageType interface ***REMOVED***
...
type MessageFieldTypes interface ***REMOVED***
	MessageType
...
type MessageDescriptors interface ***REMOVED***
...
type FieldDescriptor interface ***REMOVED***
	Descriptor
	...
	isFieldDescriptor
***REMOVED***
type isFieldDescriptor interface***REMOVED*** ProtoType(FieldDescriptor) ***REMOVED***

// FieldDescriptors is a list of field declarations.
type FieldDescriptors interface ***REMOVED***
...
type OneofDescriptor interface ***REMOVED***
	Descriptor
	...
	isOneofDescriptor
***REMOVED***
type isOneofDescriptor interface***REMOVED*** ProtoType(OneofDescriptor) ***REMOVED***

// OneofDescriptors is a list of oneof declarations.
type OneofDescriptors interface ***REMOVED***
...
type ExtensionTypeDescriptor interface ***REMOVED***
	ExtensionDescriptor
...
type ExtensionDescriptors interface ***REMOVED***
	// Len reports the number of fields.
	Len() int
...
//	***REMOVED***
//	message BarMessage ***REMOVED***
//		extends FooMessage ***REMOVED*** optional BarMessage bar_field = 100; ***REMOVED***
//	***REMOVED***
//
...
type ExtensionType interface ***REMOVED***
	...
	ValueOf(interface***REMOVED******REMOVED***) Value
	...
	InterfaceOf(Value) interface***REMOVED******REMOVED***

	// IsValidValue reports whether the Value is valid to assign to the field.
	IsValidValue(Value) bool

	// IsValidInterface reports whether the input is valid to assign to the field.
	IsValidInterface(interface***REMOVED******REMOVED***) bool
***REMOVED***
...
// Nested declarations:
// EnumValueDescriptor.
type EnumDescriptor interface ***REMOVED***
	Descriptor
	...
	isEnumDescriptor
***REMOVED***
type isEnumDescriptor interface***REMOVED*** ProtoType(EnumDescriptor) ***REMOVED***

// EnumType encapsulates an EnumDescriptor with a concrete Go implementation.
type EnumType interface ***REMOVED***
...
type EnumDescriptors interface ***REMOVED***
...
type EnumValueDescriptor interface ***REMOVED***
	Descriptor
...
***REMOVED***
type isEnumValueDescriptor interface***REMOVED*** ProtoType(EnumValueDescriptor) ***REMOVED***

// EnumValueDescriptors is a list of enum value declarations.
type EnumValueDescriptors interface ***REMOVED***
...
type ServiceDescriptor interface ***REMOVED***
	Descriptor
	...
	isServiceDescriptor
***REMOVED***
type isServiceDescriptor interface***REMOVED*** ProtoType(ServiceDescriptor) ***REMOVED***

// ServiceDescriptors is a list of service declarations.
type ServiceDescriptors interface ***REMOVED***
...
type MethodDescriptor interface ***REMOVED***
	Descriptor
	...
	isMethodDescriptor
***REMOVED***
type isMethodDescriptor interface***REMOVED*** ProtoType(MethodDescriptor) ***REMOVED***

// MethodDescriptors is a list of method declarations.
type MethodDescriptors interface ***REMOVED***
