...
func Unmarshal(tag string, goType reflect.Type, evs protoreflect.EnumValueDescriptors) protoreflect.FieldDescriptor ***REMOVED***
	...
	***REMOVED***
	...
	if f.L1.Kind == protoreflect.GroupKind ***REMOVED***
...
func Marshal(fd protoreflect.FieldDescriptor, enumName string) string ***REMOVED***
	var tag []string
	...
	***REMOVED***
	...
	// for consistency.
	if fd.Syntax() == protoreflect.Proto3 && !fd.IsExtension() ***REMOVED***
		tag = append(tag, "proto3")
	***REMOVED***
	if fd.Kind() == protoreflect.EnumKind && enumName != "" ***REMOVED***
