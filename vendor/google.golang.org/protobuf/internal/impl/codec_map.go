...
func encoderFuncsForMap(fd protoreflect.FieldDescriptor, ft reflect.Type) (valueMessage *MessageInfo, funcs pointerCoderFuncs) ***REMOVED***
	...
	mapi := &mapInfo***REMOVED***
		...
		conv:       conv,
	***REMOVED***
	if valField.Kind() == protoreflect.MessageKind ***REMOVED***
