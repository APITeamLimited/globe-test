...
func (ed *Enum) unmarshalSeed(b []byte, sb *strs.Builder, pf *File, pd protoreflect.Descriptor, i int) ***REMOVED***
	ed.L0.ParentFile = pf
	ed.L0.Parent = pd
	ed.L0.Index = i
...
func (md *Message) unmarshalSeed(b []byte, sb *strs.Builder, pf *File, pd protoreflect.Descriptor, i int) ***REMOVED***
	md.L0.ParentFile = pf
	md.L0.Parent = pd
	md.L0.Index = i
...
func (xd *Extension) unmarshalSeed(b []byte, sb *strs.Builder, pf *File, pd protoreflect.Descriptor, i int) ***REMOVED***
	xd.L0.ParentFile = pf
	xd.L0.Parent = pd
	xd.L0.Index = i
...
func (sd *Service) unmarshalSeed(b []byte, sb *strs.Builder, pf *File, pd protoreflect.Descriptor, i int) ***REMOVED***
	sd.L0.ParentFile = pf
	sd.L0.Parent = pd
	sd.L0.Index = i
...
func makeFullName(sb *strs.Builder, b []byte) protoreflect.FullName ***REMOVED***
...
func appendFullName(sb *strs.Builder, prefix protoreflect.FullName, suffix []byte) protoreflect.FullName ***REMOVED***
