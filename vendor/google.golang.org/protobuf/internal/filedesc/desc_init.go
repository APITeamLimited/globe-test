	...
	for len(b) > 0 ***REMOVED***
		...
		case protowire.BytesType:
			...
			case fieldnum.FileDescriptorProto_EnumType:
				if prevField != fieldnum.FileDescriptorProto_EnumType ***REMOVED***
			...
			case fieldnum.FileDescriptorProto_MessageType:
				if prevField != fieldnum.FileDescriptorProto_MessageType ***REMOVED***
			...
			case fieldnum.FileDescriptorProto_Extension:
				if prevField != fieldnum.FileDescriptorProto_Extension ***REMOVED***
			...
			case fieldnum.FileDescriptorProto_Service:
				if prevField != fieldnum.FileDescriptorProto_Service ***REMOVED***
	...
	for len(b) > 0 ***REMOVED***
		...
		case protowire.BytesType:
			...
			case fieldnum.DescriptorProto_EnumType:
				if prevField != fieldnum.DescriptorProto_EnumType ***REMOVED***
					if numEnums > 0 ***REMOVED***
						panic("non-contiguous repeated field")
					***REMOVED***
					posEnums = len(b0) - len(b) - n - m
			...
			case fieldnum.DescriptorProto_NestedType:
				if prevField != fieldnum.DescriptorProto_NestedType ***REMOVED***
					if numMessages > 0 ***REMOVED***
						panic("non-contiguous repeated field")
					***REMOVED***
					posMessages = len(b0) - len(b) - n - m
			...
			case fieldnum.DescriptorProto_Extension:
				if prevField != fieldnum.DescriptorProto_Extension ***REMOVED***
					if numExtensions > 0 ***REMOVED***
						panic("non-contiguous repeated field")
					***REMOVED***
					posExtensions = len(b0) - len(b) - n - m
