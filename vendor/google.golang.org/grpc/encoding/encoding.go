...
func RegisterCompressor(c Compressor) ***REMOVED***
	registeredCompressor[c.Name()] = c
***REMOVED***

// GetCompressor returns Compressor for the given compressor name.
func GetCompressor(name string) Compressor ***REMOVED***
...
// an init() function), and is not thread-safe.  If multiple Compressors are
// registered with the same name, the one registered last will take effect.
func RegisterCodec(codec Codec) ***REMOVED***
	if codec == nil ***REMOVED***
		panic("cannot register a nil Codec")
	***REMOVED***
	if codec.Name() == "" ***REMOVED***
...
func GetCodec(contentSubtype string) Codec ***REMOVED***
