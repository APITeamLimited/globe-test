...
func (t *http2Server) operateHeaders(frame *http2.MetaHeadersFrame, handle func(*Stream), traceCtx func(context.Context, string) context.Context) (fatal bool) ***REMOVED***
	...
	***REMOVED***
	if state.data.timeoutSet ***REMOVED***
	...
	***REMOVED***
	if state.data.statsTags != nil ***REMOVED***
		s.ctx = stats.SetIncomingTags(s.ctx, state.data.statsTags)
	***REMOVED***
	if state.data.statsTrace != nil ***REMOVED***
		...
		case <-idleTimer.C:
			...
			***REMOVED***
			...
			if val <= 0 ***REMOVED***
				...
				t.drain(http2.ErrCodeNo, []byte***REMOVED******REMOVED***)
				return
			***REMOVED***
			idleTimer.Reset(val)
		case <-ageTimer.C:
...
func (t *http2Server) Close() error ***REMOVED***
	t.mu.Lock()
...
func (t *http2Server) drain(code http2.ErrCode, debugData []byte) ***REMOVED***
	t.mu.Lock()
	defer t.mu.Unlock()
	...
	***REMOVED***
	...
	t.controlBuf.put(&goAway***REMOVED***code: code, debugData: debugData, headsUp: true***REMOVED***)
***REMOVED***
