...
func dial(ctx context.Context, fn func(context.Context, string) (net.Conn, error), addr string) (net.Conn, error) ***REMOVED***
	if fn != nil ***REMOVED***
		return fn(ctx, addr)
	***REMOVED***
	return (&net.Dialer***REMOVED******REMOVED***).DialContext(ctx, "tcp", addr)
***REMOVED***
			...
			for i, v := range vv ***REMOVED***
				...
				***REMOVED***
				...
				if isReservedHeader(k) ***REMOVED***
					continue
				***REMOVED***
				headerFields = append(headerFields, hpack.HeaderField***REMOVED***Name: strings.ToLower(k), Value: encodeMetadataHeader(k, v)***REMOVED***)
			***REMOVED***
		***REMOVED***
	***REMOVED***
...
func (t *http2Client) getCallAuthData(ctx context.Context, audience string, callHdr *CallHdr) (map[string]string, error) ***REMOVED***
	...
	if callCreds := callHdr.Creds; callCreds != nil ***REMOVED***
		if !t.isSecure && callCreds.RequireTransportSecurity() ***REMOVED***
