...
var (
	...
	WithHealthCheckFunc interface***REMOVED******REMOVED*** // func (HealthChecker) DialOption
	...
	ParseServiceConfig interface***REMOVED******REMOVED*** // func(string) *serviceconfig.ParseResult
	...
	// bootstrap file.
	GetCertificateProviderBuilder interface***REMOVED******REMOVED*** // func(string) certprovider.Builder
	// GetXDSHandshakeInfoForTesting returns a pointer to the xds.HandshakeInfo
	// stored in the passed in attributes. This is set by
	// credentials/xds/xds.go.
	GetXDSHandshakeInfoForTesting interface***REMOVED******REMOVED*** // func (*attributes.Attributes) *xds.HandshakeInfo
	// GetServerCredentials returns the transport credentials configured on a
	// gRPC server. An xDS-enabled server needs to know what type of credentials
	// is configured on the underlying gRPC server. This is set by server.go.
	GetServerCredentials interface***REMOVED******REMOVED*** // func (*grpc.Server) credentials.TransportCredentials
	// DrainServerTransports initiates a graceful close of existing connections
	// on a gRPC server accepted on the provided listener address. An
	// xDS-enabled server invokes this method on a grpc.Server when a particular
	// listener moves to "not-serving" mode.
	DrainServerTransports interface***REMOVED******REMOVED*** // func(*grpc.Server, string)
	// AddExtraServerOptions adds an array of ServerOption that will be
	// effective globally for newly created servers. The priority will be: 1.
	// user-provided; 2. this method; 3. default values.
	AddExtraServerOptions interface***REMOVED******REMOVED*** // func(opt ...ServerOption)
	...
	// user-provided; 2. this method; 3. default values.
	AddExtraDialOptions interface***REMOVED******REMOVED*** // func(opt ...DialOption)
	...
	NewXDSResolverWithConfigForTesting interface***REMOVED******REMOVED*** // func([]byte) (resolver.Builder, error)
...
type HealthChecker func(ctx context.Context, newStream func(string) (interface***REMOVED******REMOVED***, error), setConnectivityState func(connectivity.State, error), serviceName string) error
