...
func FromError(err error) (s *Status, ok bool) ***REMOVED***
	if err == nil ***REMOVED***
		return nil, true
	***REMOVED***
	if se, ok := err.(interface ***REMOVED***
		GRPCStatus() *Status
	***REMOVED***); ok ***REMOVED***
...
func Convert(err error) *Status ***REMOVED***
	s, _ := FromError(err)
	return s
***REMOVED***
...
func FromContextError(err error) *Status ***REMOVED***
	if err == nil ***REMOVED***
		return nil
	***REMOVED***
	if errors.Is(err, context.DeadlineExceeded) ***REMOVED***
