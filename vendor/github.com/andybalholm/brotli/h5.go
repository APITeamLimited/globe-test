...
func (*h5) HashTypeLength() uint ***REMOVED***
	return 4
***REMOVED***

func (*h5) StoreLookahead() uint ***REMOVED***
	return 4
***REMOVED***

/* HashBytes is the function that chooses the bucket to place the address in. */
func hashBytesH5(data []byte, shift int) uint32 ***REMOVED***
...
func (h *h5) Initialize(params *encoderParams) ***REMOVED***
...
func (h *h5) Prepare(one_shot bool, input_size uint, data []byte) ***REMOVED***
...
func (h *h5) Store(data []byte, mask uint, ix uint) ***REMOVED***
	var num []uint16 = h.num
...
func (h *h5) StoreRange(data []byte, mask uint, ix_start uint, ix_end uint) ***REMOVED***
	var i uint
...
func (h *h5) StitchToPreviousBlock(num_bytes uint, position uint, ringbuffer []byte, ringbuffer_mask uint) ***REMOVED***
...
func (h *h5) PrepareDistanceCache(distance_cache []int) ***REMOVED***
...
func (h *h5) FindLongestMatch(dictionary *encoderDictionary, data []byte, ring_buffer_mask uint, distance_cache []int, cur_ix uint, max_length uint, max_backward uint, gap uint, max_distance uint, out *hasherSearchResult) ***REMOVED***
	var num []uint16 = h.num
