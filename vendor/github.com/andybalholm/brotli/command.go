...
func makeCommand(dist *distanceParams, insertlen uint, copylen uint, copylen_code_delta int, distance_code uint) (cmd command) ***REMOVED***
...
func makeInsertCommand(insertlen uint) (cmd command) ***REMOVED***
	cmd.insert_len_ = uint32(insertlen)
	cmd.copy_len_ = 4 << 25
	cmd.dist_extra_ = 0
