 ...
 */
type blockSplitterDistance struct ***REMOVED***
	alphabet_size_     uint
...
func initBlockSplitterDistance(self *blockSplitterDistance, alphabet_size uint, min_block_size uint, split_threshold float64, num_symbols uint, split *blockSplit, histograms *[]histogramDistance, histograms_size *uint) ***REMOVED***
...
func blockSplitterFinishBlockDistance(self *blockSplitterDistance, is_final bool) ***REMOVED***
	...
	***REMOVED*** else if self.block_size_ > 0 ***REMOVED***
		...
		***REMOVED***
		...
		if split.num_types < maxNumberOfBlockTypes && diff[0] > self.split_threshold_ && diff[1] > self.split_threshold_ ***REMOVED***
			/* Create new block. */
...
func blockSplitterAddSymbolDistance(self *blockSplitterDistance, symbol uint) ***REMOVED***
