...
func compareAndPushToQueueLiteral(out []histogramLiteral, cluster_size []uint32, idx1 uint32, idx2 uint32, max_num_pairs uint, pairs []histogramPair, num_pairs *uint) ***REMOVED***
...
func histogramCombineLiteral(out []histogramLiteral, cluster_size []uint32, symbols []uint32, clusters []uint32, pairs []histogramPair, num_clusters uint, symbols_size uint, max_clusters uint, max_num_pairs uint) uint ***REMOVED***
...
func histogramBitCostDistanceLiteral(histogram *histogramLiteral, candidate *histogramLiteral) float64 ***REMOVED***
...
func histogramRemapLiteral(in []histogramLiteral, in_size uint, clusters []uint32, num_clusters uint, out []histogramLiteral, symbols []uint32) ***REMOVED***
	var i uint
...
func histogramReindexLiteral(out []histogramLiteral, symbols []uint32, length uint) uint ***REMOVED***
	...
	***REMOVED***
	...
	next_index = 0
	for i = 0; i < length; i++ ***REMOVED***
		if new_index[symbols[i]] == histogramReindexLiteral_kInvalidIndex ***REMOVED***
...
func clusterHistogramsLiteral(in []histogramLiteral, in_size uint, max_histograms uint, out []histogramLiteral, out_size *uint, histogram_symbols []uint32) ***REMOVED***
