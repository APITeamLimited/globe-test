...
func compareAndPushToQueueDistance(out []histogramDistance, cluster_size []uint32, idx1 uint32, idx2 uint32, max_num_pairs uint, pairs []histogramPair, num_pairs *uint) ***REMOVED***
...
func histogramCombineDistance(out []histogramDistance, cluster_size []uint32, symbols []uint32, clusters []uint32, pairs []histogramPair, num_clusters uint, symbols_size uint, max_clusters uint, max_num_pairs uint) uint ***REMOVED***
...
func histogramBitCostDistanceDistance(histogram *histogramDistance, candidate *histogramDistance) float64 ***REMOVED***
...
func histogramRemapDistance(in []histogramDistance, in_size uint, clusters []uint32, num_clusters uint, out []histogramDistance, symbols []uint32) ***REMOVED***
	var i uint
	for i = 0; i < in_size; i++ ***REMOVED***
		var best_out uint32
		if i == 0 ***REMOVED***
			best_out = symbols[0]
		***REMOVED*** else ***REMOVED***
		...
		***REMOVED***
		...
		var j uint
		for j = 0; j < num_clusters; j++ ***REMOVED***
...
func histogramReindexDistance(out []histogramDistance, symbols []uint32, length uint) uint ***REMOVED***
	...
	***REMOVED***
	...
	next_index = 0
	for i = 0; i < length; i++ ***REMOVED***
		if new_index[symbols[i]] == histogramReindexDistance_kInvalidIndex ***REMOVED***
	...
	***REMOVED***
	...
	next_index = 0
	for i = 0; i < length; i++ ***REMOVED***
		if new_index[symbols[i]] == next_index ***REMOVED***
	...
	***REMOVED***
	...
	new_index = nil
	for i = 0; uint32(i) < next_index; i++ ***REMOVED***
		out[i] = tmp[i]
	***REMOVED***
...
func clusterHistogramsDistance(in []histogramDistance, in_size uint, max_histograms uint, out []histogramDistance, out_size *uint, histogram_symbols []uint32) ***REMOVED***
	...
	***REMOVED***
	...
	for i = 0; i < in_size; i += max_input_histograms ***REMOVED***
