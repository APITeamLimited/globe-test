...
func (*h6) HashTypeLength() uint ***REMOVED***
	return 8
***REMOVED***

func (*h6) StoreLookahead() uint ***REMOVED***
	return 8
***REMOVED***

/* HashBytes is the function that chooses the bucket to place the address in. */
func hashBytesH6(data []byte, mask uint64, shift int) uint32 ***REMOVED***
...
func (h *h6) Initialize(params *encoderParams) ***REMOVED***
...
func (h *h6) Prepare(one_shot bool, input_size uint, data []byte) ***REMOVED***
	...
	***REMOVED*** else ***REMOVED***
		for i := 0; i < int(h.bucket_size_); i++ ***REMOVED***
			num[i] = 0
		***REMOVED***
	***REMOVED***
***REMOVED***
...
func (h *h6) Store(data []byte, mask uint, ix uint) ***REMOVED***
	var num []uint16 = h.num
...
func (h *h6) StoreRange(data []byte, mask uint, ix_start uint, ix_end uint) ***REMOVED***
	var i uint
...
func (h *h6) StitchToPreviousBlock(num_bytes uint, position uint, ringbuffer []byte, ringbuffer_mask uint) ***REMOVED***
...
func (h *h6) PrepareDistanceCache(distance_cache []int) ***REMOVED***
...
func (h *h6) FindLongestMatch(dictionary *encoderDictionary, data []byte, ring_buffer_mask uint, distance_cache []int, cur_ix uint, max_length uint, max_backward uint, gap uint, max_distance uint, out *hasherSearchResult) ***REMOVED***
	var num []uint16 = h.num
	...
	for i = 0; i < uint(h.params.num_last_distances_to_check); i++ ***REMOVED***
	...
	***REMOVED***
		...
		var down uint
		if uint(num[key]) > h.block_size_ ***REMOVED***
			down = uint(num[key]) - h.block_size_
		***REMOVED*** else ***REMOVED***
			down = 0
		***REMOVED***
		for i = uint(num[key]); i > down; ***REMOVED***
			var prev_ix uint
			i--
	...
	***REMOVED***
	...
	if min_score == out.score ***REMOVED***
