...
func decoderStateInit(s *Reader) bool ***REMOVED***
...
func decoderStateMetablockBegin(s *Reader) ***REMOVED***
...
func decoderStateCleanupAfterMetablock(s *Reader) ***REMOVED***
	s.context_modes = nil
	s.context_map = nil
	s.dist_context_map = nil
	s.literal_hgroup.htrees = nil
...
func decoderHuffmanTreeGroupInit(s *Reader, group *huffmanTreeGroup, alphabet_size uint32, max_symbol uint32, ntrees uint32) bool ***REMOVED***
