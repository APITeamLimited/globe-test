 ...
 */
type blockSplitterCommand struct ***REMOVED***
	alphabet_size_     uint
...
func initBlockSplitterCommand(self *blockSplitterCommand, alphabet_size uint, min_block_size uint, split_threshold float64, num_symbols uint, split *blockSplit, histograms *[]histogramCommand, histograms_size *uint) ***REMOVED***
...
func blockSplitterFinishBlockCommand(self *blockSplitterCommand, is_final bool) ***REMOVED***
...
func blockSplitterAddSymbolCommand(self *blockSplitterCommand, symbol uint) ***REMOVED***
