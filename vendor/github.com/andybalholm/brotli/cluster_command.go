...
func histogramRemapCommand(in []histogramCommand, in_size uint, clusters []uint32, num_clusters uint, out []histogramCommand, symbols []uint32) ***REMOVED***
	var i uint
...
func histogramReindexCommand(out []histogramCommand, symbols []uint32, length uint) uint ***REMOVED***
	...
	***REMOVED***
	...
	next_index = 0
	for i = 0; i < length; i++ ***REMOVED***
		if new_index[symbols[i]] == histogramReindexCommand_kInvalidIndex ***REMOVED***
...
func clusterHistogramsCommand(in []histogramCommand, in_size uint, max_histograms uint, out []histogramCommand, out_size *uint, histogram_symbols []uint32) ***REMOVED***
