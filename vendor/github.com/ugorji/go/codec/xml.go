...
Consequently, we cannot "DecodeNaked" into a map[string]interface***REMOVED******REMOVED*** (for example).
We have to "DecodeNaked" into something that resembles XML data.

To support DecodeNaked (decode into nil interface***REMOVED******REMOVED***), we have to define some "supporting" types:
    type Name struct ***REMOVED*** // Preferred. Less allocations due to conversions.
      Local string
      Space string
    ***REMOVED***
    type Element struct ***REMOVED***
      ...
      Children []interface***REMOVED******REMOVED*** // each child is either *Element or string
    ***REMOVED***
...
*** WE DECIDED AGAINST THIS. ***
    ...
    ***REMOVED***
    func (x *Element) child(i) interface***REMOVED******REMOVED*** // returns string or *Element
...
- bi-directional encode->decode->encode is not a MUST.
  ...
  func main() ***REMOVED***
	...
	v := []interface***REMOVED******REMOVED******REMOVED***"hello", 1, true, nil, time.Now()***REMOVED***
	s, err := xml.Marshal(v)
	fmt.Printf("err: %v, \ns: %s\n", err, s)
  ...
  ***REMOVED***
  Output:
    ...
    err: <nil>,
    v4: ***REMOVED***[<nil> <nil> <nil> <nil>]***REMOVED***
-
*/
...
type xmlToken struct ***REMOVED***
	Type      xmlTokenType
	Value     string
	Namespace string // blank for AttrVal and Text
***REMOVED***

type xmlParser struct ***REMOVED***
	r    decReader
...
func (x *xmlParser) nextTag() ***REMOVED***
	// TODO: implement.
***REMOVED***

// ----------- ENCODER -------------------

type xmlEncDriver struct ***REMOVED***
	e  *Encoder
	w  encWriter
	h  *XMLHandle
	b  [64]byte // scratch
...
type xmlDecDriver struct ***REMOVED***
	d    *Decoder
	h    *XMLHandle
...
type XMLElement struct ***REMOVED***
	Name  Name
...
func (h *XMLHandle) newEncDriver(e *Encoder) encDriver ***REMOVED***
	return &xmlEncDriver***REMOVED***e: e, w: e.w, h: h***REMOVED***
***REMOVED***

func (h *XMLHandle) newDecDriver(d *Decoder) decDriver ***REMOVED***
	// d := xmlDecDriver***REMOVED***r: r.(*bytesDecReader), h: h***REMOVED***
	hd := xmlDecDriver***REMOVED***d: d, r: d.r, h: h***REMOVED***
	hd.n.bytes = d.b[:]
	return &hd
***REMOVED***
