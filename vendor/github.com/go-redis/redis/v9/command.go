...
type StringIntMapCmd struct ***REMOVED***
	baseCmd
...
func NewStringIntMapCmd(ctx context.Context, args ...interface***REMOVED******REMOVED***) *StringIntMapCmd ***REMOVED***
	return &StringIntMapCmd***REMOVED***
		baseCmd: baseCmd***REMOVED***
			ctx:  ctx,
			args: args,
		***REMOVED***,
...
func (cmd *StringIntMapCmd) SetVal(val map[string]int64) ***REMOVED***
	cmd.val = val
***REMOVED***

func (cmd *StringIntMapCmd) Val() map[string]int64 ***REMOVED***
	return cmd.val
***REMOVED***

func (cmd *StringIntMapCmd) Result() (map[string]int64, error) ***REMOVED***
	return cmd.val, cmd.err
***REMOVED***

func (cmd *StringIntMapCmd) String() string ***REMOVED***
	return cmdString(cmd, cmd.val)
***REMOVED***

func (cmd *StringIntMapCmd) readReply(rd *proto.Reader) error ***REMOVED***
	n, err := rd.ReadMapLen()
	if err != nil ***REMOVED***
		return err
	***REMOVED***
			...
			***REMOVED***
			...
			if nn >= 4 ***REMOVED***
				...
				***REMOVED***
				...
				if metadataLength%2 != 0 ***REMOVED***
					return fmt.Errorf(
						"got %d elements in metadata, expected an even number", metadataLength)
				***REMOVED***

				for i := 0; i < metadataLength; i += 2 ***REMOVED***
					key, err := rd.ReadString()
					if err != nil ***REMOVED***
						return err
					***REMOVED***
