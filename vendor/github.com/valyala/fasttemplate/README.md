...
```go
	template := "http://***REMOVED******REMOVED***host***REMOVED******REMOVED***/?q=***REMOVED******REMOVED***query***REMOVED******REMOVED***&foo=***REMOVED******REMOVED***bar***REMOVED******REMOVED******REMOVED******REMOVED***bar***REMOVED******REMOVED***"
	t := fasttemplate.New(template, "***REMOVED******REMOVED***", "***REMOVED******REMOVED***")
	s := t.ExecuteString(map[string]interface***REMOVED******REMOVED******REMOVED***
		"host":  "google.com",
...
```go
	...
	***REMOVED***
	s := t.ExecuteFuncString(func(w io.Writer, tag string) (int, error) ***REMOVED***
		switch tag ***REMOVED***
		case "user":
