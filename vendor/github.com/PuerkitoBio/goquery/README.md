...
*    **2021-01-11 (v1.6.1)** : Fix panic when calling `***REMOVED***Prepend,Append,Set***REMOVED***Html` on a `Selection` that contains non-Element nodes.
...
func ExampleScrape() ***REMOVED***
  ...
  ***REMOVED***
  ...
  doc.Find(".left-content article .post-title").Each(func(i int, s *goquery.Selection) ***REMOVED***
