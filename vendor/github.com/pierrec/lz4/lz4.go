...
var bsMapID = map[byte]int***REMOVED***4: 64 << 10, 5: 256 << 10, 6: 1 << 20, 7: 4 << 20***REMOVED***
var bsMapValue = map[int]byte***REMOVED******REMOVED***

// Reversed.
func init() ***REMOVED***
	for i, v := range bsMapID ***REMOVED***
		bsMapValue[v] = i
	***REMOVED***
***REMOVED***
...
type xxhPool struct ***REMOVED***
	sync.Pool
***REMOVED***

func (p *xxhPool) Get() hash.Hash32 ***REMOVED***
	return p.Pool.Get().(hash.Hash32)
***REMOVED***

func (p *xxhPool) Put(h hash.Hash32) ***REMOVED***
	h.Reset()
	p.Pool.Put(h)
***REMOVED***

// hashPool is used by readers and writers and contains xxHash items.
var hashPool = xxhPool***REMOVED***
	Pool: sync.Pool***REMOVED***
		New: func() interface***REMOVED******REMOVED*** ***REMOVED*** return xxHash32.New(0) ***REMOVED***,
	***REMOVED***,
***REMOVED***
