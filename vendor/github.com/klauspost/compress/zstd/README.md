...
func Compress(in io.Reader, out io.Writer) error ***REMOVED***
...
func Compress(src []byte) []byte ***REMOVED***
...
```Go
    s := zstd.SnappyConverter***REMOVED******REMOVED***
...
func Decompress(in io.Reader, out io.Writer) error ***REMOVED***
...
func Decompress(src []byte) ([]byte, error) ***REMOVED***
