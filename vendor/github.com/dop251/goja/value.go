...
//
// For a Map, returns the list of entries as [][2]interface***REMOVED******REMOVED***.
//
// For a Set, returns the list of elements as []interface***REMOVED******REMOVED***.
//
...
//
// For an array, returns its items as []interface***REMOVED******REMOVED***.
//
// In all other cases returns own enumerable non-symbol properties as map[string]interface***REMOVED******REMOVED***.
//
...
// returns nil.
func (o *Object) Prototype() *Object ***REMOVED***
	return o.self.proto()
***REMOVED***
