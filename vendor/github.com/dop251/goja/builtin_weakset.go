...
func (r *Runtime) weakSetProto_add(call FunctionCall) Value ***REMOVED***
	...
	if !ok ***REMOVED***
		panic(r.NewTypeError("Method WeakSet.prototype.add called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: thisObj***REMOVED***)))
	***REMOVED***
...
func (r *Runtime) weakSetProto_delete(call FunctionCall) Value ***REMOVED***
	...
	wso, ok := thisObj.self.(*weakSetObject)
	if !ok ***REMOVED***
		panic(r.NewTypeError("Method WeakSet.prototype.delete called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: thisObj***REMOVED***)))
	***REMOVED***
...
func (r *Runtime) weakSetProto_has(call FunctionCall) Value ***REMOVED***
	...
	wso, ok := thisObj.self.(*weakSetObject)
	if !ok ***REMOVED***
		panic(r.NewTypeError("Method WeakSet.prototype.has called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: thisObj***REMOVED***)))
	***REMOVED***
	obj, ok := call.Argument(0).(*Object)
