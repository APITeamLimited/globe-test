...
func (r *Runtime) initErrors() ***REMOVED***
	...
	r.global.TypeErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
	...
	r.global.ReferenceErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
	...
	r.global.SyntaxErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
	...
	r.global.RangeErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
	...
	r.global.EvalErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
	...
	r.global.URIErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
	...
	r.global.GoErrorPrototype = r.builtin_new(r.global.Error, []Value***REMOVED******REMOVED***)
