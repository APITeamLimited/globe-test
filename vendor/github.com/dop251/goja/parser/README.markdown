...
```go
func ParseFile(fileSet *file.FileSet, filename string, src interface***REMOVED******REMOVED***, mode Mode) (*ast.Program, error)
```
...
```go
func ReadSource(filename string, src interface***REMOVED******REMOVED***) ([]byte, error)
```
