...
func (r *Runtime) newRegExpp(pattern *regexpPattern, patternStr valueString, proto *Object) *regexpObject ***REMOVED***
...
func (r *Runtime) _newRegExp(patternStr valueString, flags string, proto *Object) *regexpObject ***REMOVED***
...
func (r *Runtime) newRegExp(patternVal, flagsVal Value, proto *Object) *regexpObject ***REMOVED***
...
func (r *Runtime) regexpproto_compile(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED***
	...
	panic(r.NewTypeError("Method RegExp.prototype.compile called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
***REMOVED***
...
func (r *Runtime) regexpproto_exec(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED*** else ***REMOVED***
		r.typeErrorResult(true, "Method RegExp.prototype.exec called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***))
		return nil
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_test(call FunctionCall) Value ***REMOVED***
	if this, ok := r.toObject(call.This).self.(*regexpObject); ok ***REMOVED***
		...
		***REMOVED***
	***REMOVED*** else ***REMOVED***
		panic(r.NewTypeError("Method RegExp.prototype.test called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_getGlobal(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED*** else if call.This == r.global.RegExpPrototype ***REMOVED***
		return _undefined
	***REMOVED*** else ***REMOVED***
		panic(r.NewTypeError("Method RegExp.prototype.global getter called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_getMultiline(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED*** else if call.This == r.global.RegExpPrototype ***REMOVED***
		return _undefined
	***REMOVED*** else ***REMOVED***
		panic(r.NewTypeError("Method RegExp.prototype.multiline getter called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_getIgnoreCase(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED*** else if call.This == r.global.RegExpPrototype ***REMOVED***
		return _undefined
	***REMOVED*** else ***REMOVED***
		panic(r.NewTypeError("Method RegExp.prototype.ignoreCase getter called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_getUnicode(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED*** else if call.This == r.global.RegExpPrototype ***REMOVED***
		return _undefined
	***REMOVED*** else ***REMOVED***
		panic(r.NewTypeError("Method RegExp.prototype.unicode getter called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_getSticky(call FunctionCall) Value ***REMOVED***
	...
	***REMOVED*** else if call.This == r.global.RegExpPrototype ***REMOVED***
		return _undefined
	***REMOVED*** else ***REMOVED***
		panic(r.NewTypeError("Method RegExp.prototype.sticky getter called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: call.This***REMOVED***)))
	***REMOVED***
***REMOVED***
...
func (r *Runtime) regexpproto_stdMatcherAll(call FunctionCall) Value ***REMOVED***
	thisObj := r.toObject(call.This)
	s := call.Argument(0).toString()
	flags := nilSafe(thisObj.self.getStr("flags", nil)).toString()
	c := r.speciesConstructorObj(call.This.(*Object), r.global.RegExp)
	matcher := r.toConstructor(c)([]Value***REMOVED***call.This, flags***REMOVED***, nil)
...
func (r *Runtime) createRegExpStringIterator(matcher *Object, s valueString, global, fullUnicode bool) Value ***REMOVED***
	o := &Object***REMOVED***runtime: r***REMOVED***

	ri := &regExpStringIterObject***REMOVED***
		matcher:     matcher,
		s:           s,
		global:      global,
...
type regExpStringIterObject struct ***REMOVED***
	baseObject
	matcher                   *Object
	s                         valueString
...
func regExpExec(r *Object, s valueString) Value ***REMOVED***
	exec := r.self.getStr("exec", nil)
	if execObject, ok := exec.(*Object); ok ***REMOVED***
		if execFn, ok := execObject.self.assertCallable(); ok ***REMOVED***
			return r.runtime.regExpExec(execFn, r, s)
		***REMOVED***
	***REMOVED***
	if rx, ok := r.self.(*regexpObject); ok ***REMOVED***
		return rx.exec(s)
	***REMOVED***
	panic(r.runtime.NewTypeError("no RegExpMatcher internal slot"))
***REMOVED***

func (ri *regExpStringIterObject) next() (v Value) ***REMOVED***
	if ri.done ***REMOVED***
		return ri.val.runtime.createIterResultObject(_undefined, true)
	***REMOVED***

	match := regExpExec(ri.matcher, ri.s)
	if IsNull(match) ***REMOVED***
		ri.done = true
		return ri.val.runtime.createIterResultObject(_undefined, true)
	***REMOVED***
	if !ri.global ***REMOVED***
		ri.done = true
...
func (r *Runtime) regExpStringIteratorProto_next(call FunctionCall) Value ***REMOVED***
	thisObj := r.toObject(call.This)
	if iter, ok := thisObj.self.(*regExpStringIterObject); ok ***REMOVED***
		return iter.next()
	***REMOVED***
	panic(r.NewTypeError("Method RegExp String Iterator.prototype.next called on incompatible receiver %s", r.objectproto_toString(FunctionCall***REMOVED***This: thisObj***REMOVED***)))
***REMOVED***

func (r *Runtime) createRegExpStringIteratorPrototype(val *Object) objectImpl ***REMOVED***
