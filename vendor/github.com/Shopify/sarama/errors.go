...
type PacketEncodingError struct ***REMOVED***
	Info string
***REMOVED***

func (err PacketEncodingError) Error() string ***REMOVED***
	return fmt.Sprintf("kafka: error encoding packet: %s", err.Info)
***REMOVED***

// PacketDecodingError is returned when there was an error (other than truncated data) decoding the Kafka broker's response.
// This can be a bad CRC or length field, or any other invalid value.
type PacketDecodingError struct ***REMOVED***
	Info string
***REMOVED***

func (err PacketDecodingError) Error() string ***REMOVED***
...
func (err ConfigurationError) Error() string ***REMOVED***
...
func (err KError) Error() string ***REMOVED***
