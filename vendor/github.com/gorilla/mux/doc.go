...
Groups can be used inside patterns, as long as they are non-capturing (?:re). For example:
	...
	r.HandleFunc("/articles/***REMOVED***category***REMOVED***/***REMOVED***sort:(?:asc|desc|new)***REMOVED***", ArticlesCategoryHandler)
...
this, convert any capturing groups to non-capturing, e.g. change "/***REMOVED***sort:(asc|desc)***REMOVED***" to
"/***REMOVED***sort:(?:asc|desc)***REMOVED***". This is a change from prior versions which behaved unpredictably
