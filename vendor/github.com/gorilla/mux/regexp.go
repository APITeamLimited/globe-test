...
func newRouteRegexp(tpl string, matchHost, matchPrefix, matchQuery, strictSlash, useEncodedPath bool) (*routeRegexp, error) ***REMOVED***
	...
	***REMOVED***
	...
	if matchQuery ***REMOVED***
		defaultPattern = ".*"
	***REMOVED*** else if matchHost ***REMOVED***
		defaultPattern = "[^.]+"
		matchPrefix = false
	***REMOVED***
	// Only match strict slash if not matching
	if matchPrefix || matchHost || matchQuery ***REMOVED***
		strictSlash = false
	***REMOVED***
	// Set a flag for strictSlash.
	endSlash := false
	if strictSlash && strings.HasSuffix(tpl, "/") ***REMOVED***
		tpl = tpl[:len(tpl)-1]
		endSlash = true
	***REMOVED***
...
func (r *routeRegexp) Match(req *http.Request, match *RouteMatch) bool ***REMOVED***
	if !r.matchHost ***REMOVED***
		if r.matchQuery ***REMOVED***
