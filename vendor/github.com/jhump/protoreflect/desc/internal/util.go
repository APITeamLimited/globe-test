...
func JsonName(name string) string ***REMOVED***
	var js []rune
	nextUpper := false
	for i, r := range name ***REMOVED***
		if r == '_' ***REMOVED***
			nextUpper = true
			continue
		***REMOVED***
		if i == 0 ***REMOVED***
			js = append(js, r)
		***REMOVED*** else if nextUpper ***REMOVED***
			nextUpper = false
...
func InitCap(name string) string ***REMOVED***
...
func CreatePrefixList(pkg string) []string ***REMOVED***
	if pkg == "" ***REMOVED***
	...
	***REMOVED***
	...
	for i := 0; i < len(pkg); i++ ***REMOVED***
		if pkg[i] == '.' ***REMOVED***
			numDots++
		***REMOVED***
	***REMOVED***
	if numDots == 0 ***REMOVED***
		return []string***REMOVED***pkg, ""***REMOVED***
	***REMOVED***
...
func GetMaxTag(isMessageSet bool) int32 ***REMOVED***
