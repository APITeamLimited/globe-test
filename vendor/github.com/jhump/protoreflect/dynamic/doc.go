...
// elements as a slice []interface***REMOVED******REMOVED***. Similarly, using GetField for a map field
// will return a copy of all mappings as a map[interface***REMOVED******REMOVED***]interface***REMOVED******REMOVED***. You can
// also use SetField to supply an entire slice or map for repeated or map fields.
// The slice need not be []interface***REMOVED******REMOVED*** but can actually be typed according to
