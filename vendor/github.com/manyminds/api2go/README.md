  ...
  ***REMOVED***,
  "relationships": ***REMOVED***
    "author": ***REMOVED***
      ...
      ***REMOVED***,
      "data": ***REMOVED*** "type": "people", "id": "9" ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
```
...
```go
func (s UnicornPost) GetName() string ***REMOVED***
...
```go
comment1 = Comment***REMOVED***ID: 1, Text: "First!"***REMOVED***
comment2 = Comment***REMOVED***ID: 2, Text: "Second!"***REMOVED***
post = Post***REMOVED***ID: 1, Title: "Foobar", Comments: []Comment***REMOVED***comment1, comment2***REMOVED******REMOVED***
...
// posts[0] == Post***REMOVED***ID: 1, Title: "Foobar", CommentsIDs: []int***REMOVED***1, 2***REMOVED******REMOVED***
```
## SQL Null-Types
...
```go
  ...
  func main() ***REMOVED***
    ...
    api.AddResource(model.User***REMOVED******REMOVED***, resource.UserResource***REMOVED***ChocStorage: chocStorage, UserStorage: userStorage***REMOVED***)
    api.AddResource(model.Chocolate***REMOVED******REMOVED***, resource.ChocolateResource***REMOVED***ChocStorage: chocStorage, UserStorage: userStorage***REMOVED***)
...
```go
type fixtureSource struct ***REMOVED******REMOVED***

// FindOne returns an object by its ID
// Possible success status code 200
func (s *fixtureSource) FindOne(ID string, r api2go.Request) (Responder, error) ***REMOVED******REMOVED***
...
//   the server
func (s *fixtureSource) Create(obj interface***REMOVED******REMOVED***, r api2go.Request) (Responder, err error) ***REMOVED******REMOVED***
...
func (s *fixtureSource) Delete(id string, r api2go.Request) (Responder, err error) ***REMOVED******REMOVED***
...
func (s *fixtureSource) Update(obj interface***REMOVED******REMOVED***, r api2go.Request) (Responder, err error) ***REMOVED******REMOVED***
```
...
api.AddResource(Post***REMOVED******REMOVED***, &PostsSource***REMOVED******REMOVED***)
...
func (s *fixtureSource) FindAll(req api2go.Request) (Responder, error) ***REMOVED***
  for key, values range req.QueryParams ***REMOVED***
    ...
  ***REMOVED***
  ...
***REMOVED***
...
```go
resolver := NewCallbackResolver(func(r http.Request) string***REMOVED******REMOVED***)
