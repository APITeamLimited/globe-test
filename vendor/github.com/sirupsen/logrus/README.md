...
```go
	log.SetFormatter(&log.TextFormatter***REMOVED***
		DisableColors: true,
		FullTimestamp: true,
	***REMOVED***)
```
...
```json
***REMOVED***"animal":"penguin","level":"fatal","method":"github.com/sirupsen/arcticcreatures.migrate","msg":"a penguin swims by",
"time":"2014-03-10 19:57:38.562543129 -0400 EDT"***REMOVED***
```
