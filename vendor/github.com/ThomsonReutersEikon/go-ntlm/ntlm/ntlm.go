...
func CreateClientSession(version Version, mode Mode) (n ClientSession, err error) ***REMOVED***
...
type ClientSession interface ***REMOVED***
...
// mode - This must be ConnectionlessMode or ConnectionOrientedMode depending on what type of NTLM is used
// version - This must be Version1 or Version2 depending on the version of NTLM used
func CreateServerSession(version Version, mode Mode) (n ServerSession, err error) ***REMOVED***
	switch version ***REMOVED***
	case Version1:
...
type ServerSession interface ***REMOVED***
	SetUserInfo(username string, password string, domain string)
...
type SessionData struct ***REMOVED***
	mode Mode
