...
// NTLMv1
// ******
type NtlmV1Response struct ***REMOVED***
	// 24 byte array
	Response []byte
***REMOVED***

func (n *NtlmV1Response) String() string ***REMOVED***
	return fmt.Sprintf("NtlmV1Response: %s", hex.EncodeToString(n.Response))
***REMOVED***

func ReadNtlmV1Response(bytes []byte) (*NtlmV1Response, error) ***REMOVED***
...
type NtlmV2ClientChallenge struct ***REMOVED***
...
func (n *NtlmV2ClientChallenge) String() string ***REMOVED***
...
type NtlmV2Response struct ***REMOVED***
...
func (n *NtlmV2Response) String() string ***REMOVED***
	var buffer bytes.Buffer
...
func ReadNtlmV2Response(bytes []byte) (*NtlmV2Response, error) ***REMOVED***
	...
	if c.RespType != 1 || c.HiRespType != 1 ***REMOVED***
...
// LMv1
// ****
type LmV1Response struct ***REMOVED***
	// 24 bytes
	Response []byte
***REMOVED***

func ReadLmV1Response(bytes []byte) *LmV1Response ***REMOVED***
	r := new(LmV1Response)
	r.Response = bytes[0:24]
	return r
***REMOVED***

func (l *LmV1Response) String() string ***REMOVED***
	return fmt.Sprintf("LmV1Response: %s", hex.EncodeToString(l.Response))
***REMOVED***

// *** LMv2
type LmV2Response struct ***REMOVED***
...
func ReadLmV2Response(bytes []byte) *LmV2Response ***REMOVED***
	r := new(LmV2Response)
	r.Response = bytes[0:16]
...
func (l *LmV2Response) String() string ***REMOVED***
	var buffer bytes.Buffer
