...
type V1Session struct ***REMOVED***
	SessionData
***REMOVED***

func (n *V1Session) SetUserInfo(username string, password string, domain string) ***REMOVED***
	n.user = username
	n.password = password
	n.userDomain = domain
***REMOVED***

func (n *V1Session) GetUserInfo() (string, string, string) ***REMOVED***
	return n.user, n.password, n.userDomain
***REMOVED***

func (n *V1Session) SetMode(mode Mode) ***REMOVED***
	n.mode = mode
***REMOVED***

func (n *V1Session) Version() int ***REMOVED***
	return 1
***REMOVED***

func (n *V1Session) fetchResponseKeys() (err error) ***REMOVED***
...
func (n *V1Session) computeExpectedResponses() (err error) ***REMOVED***
	if NTLMSSP_NEGOTIATE_EXTENDED_SESSIONSECURITY.IsSet(n.NegotiateFlags) ***REMOVED***
...
func (n *V1Session) computeSessionBaseKey() (err error) ***REMOVED***
	n.sessionBaseKey = md4(n.responseKeyNT)
	return
***REMOVED***

func (n *V1Session) computeKeyExchangeKey() (err error) ***REMOVED***
	if NTLMSSP_NEGOTIATE_EXTENDED_SESSIONSECURITY.IsSet(n.NegotiateFlags) ***REMOVED***
...
func (n *V1Session) calculateKeys(ntlmRevisionCurrent uint8) (err error) ***REMOVED***
...
func (n *V1Session) Seal(message []byte) ([]byte, error) ***REMOVED***
	return nil, nil
***REMOVED***

func (n *V1Session) Sign(message []byte) ([]byte, error) ***REMOVED***
	return nil, nil
***REMOVED***

func ntlmV1Mac(message []byte, sequenceNumber int, handle *rc4P.Cipher, sealingKey, signingKey []byte, NegotiateFlags uint32) []byte ***REMOVED***
...
func (n *V1ServerSession) Mac(message []byte, sequenceNumber int) ([]byte, error) ***REMOVED***
	mac := ntlmV1Mac(message, sequenceNumber, n.serverHandle, n.ServerSealingKey, n.ServerSigningKey, n.NegotiateFlags)
	return mac, nil
***REMOVED***

func (n *V1ClientSession) Mac(message []byte, sequenceNumber int) ([]byte, error) ***REMOVED***
	mac := ntlmV1Mac(message, sequenceNumber, n.clientHandle, n.ClientSealingKey, n.ClientSigningKey, n.NegotiateFlags)
	return mac, nil
***REMOVED***

func (n *V1ServerSession) VerifyMac(message, expectedMac []byte, sequenceNumber int) (bool, error) ***REMOVED***
	mac := ntlmV1Mac(message, sequenceNumber, n.clientHandle, n.ClientSealingKey, n.ClientSigningKey, n.NegotiateFlags)
	return MacsEqual(mac, expectedMac), nil
***REMOVED***

func (n *V1ClientSession) VerifyMac(message, expectedMac []byte, sequenceNumber int) (bool, error) ***REMOVED***
	mac := ntlmV1Mac(message, sequenceNumber, n.serverHandle, n.ServerSealingKey, n.ServerSigningKey, n.NegotiateFlags)
	return MacsEqual(mac, expectedMac), nil
***REMOVED***
...
type V1ServerSession struct ***REMOVED***
	V1Session
***REMOVED***

func (n *V1ServerSession) ProcessNegotiateMessage(nm *NegotiateMessage) (err error) ***REMOVED***
	n.negotiateMessage = nm
	return
***REMOVED***

func (n *V1ServerSession) GenerateChallengeMessage() (cm *ChallengeMessage, err error) ***REMOVED***
	// TODO: Generate this challenge message
	return
***REMOVED***

func (n *V1ServerSession) SetServerChallenge(challenge []byte) ***REMOVED***
	n.serverChallenge = challenge
***REMOVED***

func (n *V1ServerSession) GetSessionData() *SessionData ***REMOVED***
	return &n.SessionData
***REMOVED***

func (n *V1ServerSession) ProcessAuthenticateMessage(am *AuthenticateMessage) (err error) ***REMOVED***
	...
	***REMOVED***
	...
	if !bytes.Equal(am.NtChallengeResponseFields.Payload, n.ntChallengeResponse) ***REMOVED***
		...
		// be the same
		if !bytes.Equal(am.LmChallengeResponse.Payload, n.lmChallengeResponse) || NTLMSSP_NEGOTIATE_EXTENDED_SESSIONSECURITY.IsSet(n.NegotiateFlags) ***REMOVED***
...
func (n *V1ServerSession) computeExportedSessionKey() (err error) ***REMOVED***
...
type V1ClientSession struct ***REMOVED***
	V1Session
***REMOVED***

func (n *V1ClientSession) GenerateNegotiateMessage() (nm *NegotiateMessage, err error) ***REMOVED***
	return nil, nil
***REMOVED***

func (n *V1ClientSession) ProcessChallengeMessage(cm *ChallengeMessage) (err error) ***REMOVED***
...
func (n *V1ClientSession) GenerateAuthenticateMessage() (am *AuthenticateMessage, err error) ***REMOVED***
...
func (n *V1ClientSession) computeEncryptedSessionKey() (err error) ***REMOVED***
	if NTLMSSP_NEGOTIATE_KEY_EXCH.IsSet(n.NegotiateFlags) ***REMOVED***
