...
func ParseChallengeMessage(body []byte) (*ChallengeMessage, error) ***REMOVED***
	...
	***REMOVED***
	...
	if NTLMSSP_NEGOTIATE_VERSION.IsSet(challenge.NegotiateFlags) ***REMOVED***
...
func (c *ChallengeMessage) Bytes() []byte ***REMOVED***
...
func (c *ChallengeMessage) getLowestPayloadOffset() int ***REMOVED***
	payloadStructs := [...]*PayloadStruct***REMOVED***c.TargetName, c.TargetInfoPayloadStruct***REMOVED***
...
func (c *ChallengeMessage) String() string ***REMOVED***
