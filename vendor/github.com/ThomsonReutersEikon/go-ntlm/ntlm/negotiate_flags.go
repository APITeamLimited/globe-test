...
func (f NegotiateFlag) Set(flags uint32) uint32 ***REMOVED***
	return flags | uint32(f)
***REMOVED***

func (f NegotiateFlag) IsSet(flags uint32) bool ***REMOVED***
	return (flags & uint32(f)) != 0
***REMOVED***

func (f NegotiateFlag) Unset(flags uint32) uint32 ***REMOVED***
	return flags &^ uint32(f)
***REMOVED***

func (f NegotiateFlag) String() string ***REMOVED***
	return reflect.TypeOf(f).Name()
***REMOVED***

func GetFlagName(flag NegotiateFlag) string ***REMOVED***
	nameMap := map[NegotiateFlag]string***REMOVED***
		...
		NTLMSSP_NEGOTIATE_UNICODE:                  "NTLMSSP_NEGOTIATE_UNICODE"***REMOVED***

	return nameMap[flag]
***REMOVED***

func FlagsToString(flags uint32) string ***REMOVED***
	allFlags := [...]NegotiateFlag***REMOVED***
		NTLMSSP_NEGOTIATE_56,
		NTLMSSP_NEGOTIATE_KEY_EXCH,
		NTLMSSP_NEGOTIATE_128,
		NTLMSSP_NEGOTIATE_VERSION,
		...
		NTLMSSP_REQUEST_TARGET,
		NTLM_NEGOTIATE_OEM,
		NTLMSSP_NEGOTIATE_UNICODE***REMOVED***

	var buffer bytes.Buffer
	for i := range allFlags ***REMOVED***
		f := allFlags[i]
