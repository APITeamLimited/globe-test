...
func (hs HostSwitch) ServeHTTP(w http.ResponseWriter, r *http.Request) ***REMOVED***
	// Check if a http.Handler is registered for the given host.
	// If yes, use it to handle the request.
	if handler := hs[r.Host]; handler != nil ***REMOVED***
...
func BasicAuth(h httprouter.Handle, requiredUser, requiredPassword string) httprouter.Handle ***REMOVED***
	return func(w http.ResponseWriter, r *http.Request, ps httprouter.Params) ***REMOVED***
		// Get the Basic Authentication credentials
		user, password, hasAuth := r.BasicAuth()

		if hasAuth && user == requiredUser && password == requiredPassword ***REMOVED***
...
func Protected(w http.ResponseWriter, r *http.Request, _ httprouter.Params) ***REMOVED***
