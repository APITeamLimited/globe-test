...
var file_github_com_golang_protobuf_ptypes_struct_struct_proto_rawDesc = []byte***REMOVED***
...
var file_github_com_golang_protobuf_ptypes_struct_struct_proto_goTypes = []interface***REMOVED******REMOVED******REMOVED******REMOVED***
var file_github_com_golang_protobuf_ptypes_struct_struct_proto_depIdxs = []int32***REMOVED***
...
func init() ***REMOVED*** file_github_com_golang_protobuf_ptypes_struct_struct_proto_init() ***REMOVED***
func file_github_com_golang_protobuf_ptypes_struct_struct_proto_init() ***REMOVED***
	if File_github_com_golang_protobuf_ptypes_struct_struct_proto != nil ***REMOVED***
		return
	***REMOVED***
