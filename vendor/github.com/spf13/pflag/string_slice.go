...
func (s *stringSliceValue) Append(val string) error ***REMOVED***
	*s.value = append(*s.value, val)
	return nil
***REMOVED***

func (s *stringSliceValue) Replace(val []string) error ***REMOVED***
	*s.value = val
	return nil
***REMOVED***

func (s *stringSliceValue) GetSlice() []string ***REMOVED***
	return *s.value
***REMOVED***
