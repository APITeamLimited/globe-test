...
Zsh:
  ...
  # To load completions for each session, execute once:
  $ yourprogram completion zsh > "$***REMOVED***fpath[1]***REMOVED***/_yourprogram"
...
`,
	...
	ValidArgs:             []string***REMOVED***"bash", "zsh", "fish", "powershell"***REMOVED***,
...
cmd := &cobra.Command***REMOVED***
	...
	Long:  status_long,
	RunE: func(cmd *cobra.Command, args []string) ***REMOVED***
		RunGet(args[0])
	***REMOVED***,
	ValidArgsFunction: func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) ***REMOVED***
...
//    return []string***REMOVED***"yaml", "json"***REMOVED***, ShellCompDirectiveFilterFileExt
...
//    return []string***REMOVED***"themes"***REMOVED***, ShellCompDirectiveFilterDirs
//
...
cobra.CompDebug(msg string, printToStdErr bool) ***REMOVED***
...
```go
flagName := "output"
cmd.RegisterFlagCompletionFunc(flagName, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) ***REMOVED***
	return []string***REMOVED***"json", "table", "yaml"***REMOVED***, cobra.ShellCompDirectiveDefault
***REMOVED***)
```
...
flagName := "output"
cmd.RegisterFlagCompletionFunc(flagName, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) ***REMOVED***
	return []string***REMOVED***"yaml", "json"***REMOVED***, ShellCompDirectiveFilterFileExt***REMOVED***)
```
...
flagName := "output"
cmd.RegisterFlagCompletionFunc(flagName, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) ***REMOVED***
	return []string***REMOVED***"themes"***REMOVED***, cobra.ShellCompDirectiveFilterDirs
***REMOVED***)
```
...
```go
ValidArgsFunction: func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) ***REMOVED***
	return []string***REMOVED***"harbor\tAn image registry", "thanos\tLong-term metrics"***REMOVED***, cobra.ShellCompDirectiveNoFileComp
***REMOVED******REMOVED***
```
or
```go
ValidArgs: []string***REMOVED***"bash\tCompletions for bash", "zsh\tCompletions for zsh"***REMOVED***
```
## Bash completions
