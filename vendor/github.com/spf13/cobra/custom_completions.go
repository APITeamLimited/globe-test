...
func (d ShellCompDirective) string() string ***REMOVED***
	var directives []string
	if d&ShellCompDirectiveError != 0 ***REMOVED***
		directives = append(directives, "ShellCompDirectiveError")
	***REMOVED***
	if d&ShellCompDirectiveNoSpace != 0 ***REMOVED***
		directives = append(directives, "ShellCompDirectiveNoSpace")
	***REMOVED***
	if d&ShellCompDirectiveNoFileComp != 0 ***REMOVED***
		directives = append(directives, "ShellCompDirectiveNoFileComp")
	***REMOVED***
	if d&ShellCompDirectiveFilterFileExt != 0 ***REMOVED***
		directives = append(directives, "ShellCompDirectiveFilterFileExt")
	***REMOVED***
	if d&ShellCompDirectiveFilterDirs != 0 ***REMOVED***
		directives = append(directives, "ShellCompDirectiveFilterDirs")
	***REMOVED***
	if len(directives) == 0 ***REMOVED***
		directives = append(directives, "ShellCompDirectiveDefault")
	***REMOVED***

	if d >= shellCompDirectiveMaxValue ***REMOVED***
...
func (c *Command) initCompleteCmd(args []string) ***REMOVED***
	completeCmd := &Command***REMOVED***
		Use:                   fmt.Sprintf("%s [command-line]", ShellCompRequestCmd),
		Aliases:               []string***REMOVED***ShellCompNoDescRequestCmd***REMOVED***,
		...
		Run: func(cmd *Command, args []string) ***REMOVED***
			...
			***REMOVED***
			...
			for _, comp := range completions ***REMOVED***
				if noDescriptions ***REMOVED***
	...
	***REMOVED***
	...
	if err != nil || subCmd.Name() != ShellCompRequestCmd ***REMOVED***
...
func (c *Command) getCompletions(args []string) (*Command, []string, ShellCompDirective, error) ***REMOVED***
	...
	***REMOVED***
	...
	if flag != nil ***REMOVED***
		...
		***REMOVED***
		...
		if subDir, present := flag.Annotations[BashCompSubdirsInDir]; present ***REMOVED***
			if len(subDir) == 1 ***REMOVED***
				// Directory completion from within a directory
				return finalCmd, subDir, ShellCompDirectiveFilterDirs, nil
			***REMOVED***
			// Directory completion
			return finalCmd, []string***REMOVED******REMOVED***, ShellCompDirectiveFilterDirs, nil
		***REMOVED***
	***REMOVED***
	...
	if flag == nil && len(toComplete) > 0 && toComplete[0] == '-' && !strings.Contains(toComplete, "=") ***REMOVED***
		...
		if len(completions) == 0 ***REMOVED***
			doCompleteFlags := func(flag *pflag.Flag) ***REMOVED***
				if !flag.Changed ||
					strings.Contains(flag.Value.Type(), "Slice") ||
					strings.Contains(flag.Value.Type(), "Array") ***REMOVED***
			...
			***REMOVED***
			...
			// non-inherited flags.
			finalCmd.InheritedFlags().VisitAll(func(flag *pflag.Flag) ***REMOVED***
...
func getFlagNameCompletions(flag *pflag.Flag, toComplete string) []string ***REMOVED***
	...
	***REMOVED***
	...
	var completions []string
	flagName := "--" + flag.Name
	if strings.HasPrefix(flagName, toComplete) ***REMOVED***
		// Flag without the =
	...
	***REMOVED***
	...
	if len(flag.Shorthand) > 0 && strings.HasPrefix(flagName, toComplete) ***REMOVED***
		completions = append(completions, fmt.Sprintf("%s\t%s", flagName, flag.Usage))
	***REMOVED***
...
func completeRequireFlags(finalCmd *Command, toComplete string) []string ***REMOVED***
	var completions []string

	doCompleteRequiredFlags := func(flag *pflag.Flag) ***REMOVED***
		if _, present := flag.Annotations[BashCompOneRequiredFlag]; present ***REMOVED***
...
func checkIfFlagCompletion(finalCmd *Command, args []string, lastArg string) (*pflag.Flag, []string, string, error) ***REMOVED***
	if finalCmd.DisableFlagParsing ***REMOVED***
	...
	***REMOVED***
	...
	if len(flagName) == 0 ***REMOVED***
		if len(args) > 0 ***REMOVED***
			prevArg := args[len(args)-1]
			if isFlagArg(prevArg) ***REMOVED***
...
func findFlag(cmd *Command, name string) *pflag.Flag ***REMOVED***
	...
	if len(name) == 1 ***REMOVED***
		...
		if short := flagSet.ShorthandLookup(name); short != nil ***REMOVED***
			name = short.Name
		***REMOVED*** else ***REMOVED***
			set := cmd.InheritedFlags()
			if short = set.ShorthandLookup(name); short != nil ***REMOVED***
				name = short.Name
			***REMOVED*** else ***REMOVED***
				return nil
			***REMOVED***
...
func CompDebug(msg string, printToStdErr bool) ***REMOVED***
	msg = fmt.Sprintf("[Debug] %s", msg)

	// Such logs are only printed when the user has set the environment
	// variable BASH_COMP_DEBUG_FILE to the path of some file to be used.
	if path := os.Getenv("BASH_COMP_DEBUG_FILE"); path != "" ***REMOVED***
...
// Such logs are only printed when the user has set the environment
// variable BASH_COMP_DEBUG_FILE to the path of some file to be used.
func CompDebugln(msg string, printToStdErr bool) ***REMOVED***
	CompDebug(fmt.Sprintf("%s\n", msg), printToStdErr)
***REMOVED***

// CompError prints the specified completion message to stderr.
func CompError(msg string) ***REMOVED***
	msg = fmt.Sprintf("[Error] %s", msg)
	CompDebug(msg, true)
***REMOVED***

// CompErrorln prints the specified completion message to stderr with a newline at the end.
func CompErrorln(msg string) ***REMOVED***
