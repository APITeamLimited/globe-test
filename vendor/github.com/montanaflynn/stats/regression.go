...
func LinearRegression(s Series) (regressions Series, err error) ***REMOVED***
	...
	***REMOVED***
	...
	for j := 0; j < len(s); j++ ***REMOVED***
		regressions = append(regressions, Coordinate***REMOVED***
			X: s[j].X,
...
func ExponentialRegression(s Series) (regressions Series, err error) ***REMOVED***
...
func LogarithmicRegression(s Series) (regressions Series, err error) ***REMOVED***
