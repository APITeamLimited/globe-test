...
type headersResponse struct ***REMOVED***
	Headers http.Header `json:"headers"`
***REMOVED***

type ipResponse struct ***REMOVED***
	Origin string `json:"origin"`
***REMOVED***

type userAgentResponse struct ***REMOVED***
...
type bodyResponse struct ***REMOVED***
	Args    url.Values  `json:"args"`
	Headers http.Header `json:"headers"`
	Origin  string      `json:"origin"`
	URL     string      `json:"url"`
	...
	JSON  interface***REMOVED******REMOVED***         `json:"json"`
***REMOVED***

type cookiesResponse map[string]string

type authResponse struct ***REMOVED***
	Authorized bool   `json:"authorized"`
	User       string `json:"user"`
***REMOVED***

type gzipResponse struct ***REMOVED***
	Headers http.Header `json:"headers"`
	Origin  string      `json:"origin"`
	Gzipped bool        `json:"gzipped"`
***REMOVED***

type deflateResponse struct ***REMOVED***
	Headers  http.Header `json:"headers"`
	Origin   string      `json:"origin"`
...
type streamResponse struct ***REMOVED***
	ID      int         `json:"id"`
	Args    url.Values  `json:"args"`
	Headers http.Header `json:"headers"`
	Origin  string      `json:"origin"`
...
func (h *HTTPBin) Handler() http.Handler ***REMOVED***
...
func New(opts ...OptionFunc) *HTTPBin ***REMOVED***
	h := &HTTPBin***REMOVED***
...
func WithMaxBodySize(m int64) OptionFunc ***REMOVED***
	return func(h *HTTPBin) ***REMOVED***
		h.MaxBodySize = m
	***REMOVED***
***REMOVED***

// WithMaxDuration sets the maximum amount of time httpbin may take to respond
func WithMaxDuration(d time.Duration) OptionFunc ***REMOVED***
	return func(h *HTTPBin) ***REMOVED***
		h.MaxDuration = d
	***REMOVED***
***REMOVED***
...
func WithObserver(o Observer) OptionFunc ***REMOVED***
	return func(h *HTTPBin) ***REMOVED***
		h.Observer = o
	***REMOVED***
***REMOVED***
