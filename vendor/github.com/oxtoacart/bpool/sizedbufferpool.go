...
type SizedBufferPool struct ***REMOVED***
	c chan *bytes.Buffer
	a int
***REMOVED***
...
func NewSizedBufferPool(size int, alloc int) (bp *SizedBufferPool) ***REMOVED***
	return &SizedBufferPool***REMOVED***
...
func (bp *SizedBufferPool) Get() (b *bytes.Buffer) ***REMOVED***
	select ***REMOVED***
	case b = <-bp.c:
...
func (bp *SizedBufferPool) Put(b *bytes.Buffer) ***REMOVED***
	b.Reset()
