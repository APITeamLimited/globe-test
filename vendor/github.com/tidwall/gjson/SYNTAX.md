...
`***REMOVED***...***REMOVED***` will result in a new array or object, respectively.
...
```
***REMOVED***name.first,age,"company":!"Happysoft","employed":!true***REMOVED***
```
...
```json
***REMOVED***"first":"Tom","age":37,"company":"Happysoft","employed":true***REMOVED***
```
