...
var SHA1 HashGeneratorFcn = func() hash.Hash ***REMOVED*** return sha1.New() ***REMOVED***
...
var SHA256 HashGeneratorFcn = func() hash.Hash ***REMOVED*** return sha256.New() ***REMOVED***
...
var SHA512 HashGeneratorFcn = func() hash.Hash ***REMOVED*** return sha512.New() ***REMOVED***
...
func (f HashGeneratorFcn) NewClient(username, password, authzID string) (*Client, error) ***REMOVED***
	var userprep, passprep, authprep string
	var err error

	if userprep, err = stringprep.SASLprep.Prepare(username); err != nil ***REMOVED***
		return nil, fmt.Errorf("Error SASLprepping username '%s': %v", username, err)
	***REMOVED***
	if passprep, err = stringprep.SASLprep.Prepare(password); err != nil ***REMOVED***
		return nil, fmt.Errorf("Error SASLprepping password '%s': %v", password, err)
	***REMOVED***
	if authprep, err = stringprep.SASLprep.Prepare(authzID); err != nil ***REMOVED***
...
func (f HashGeneratorFcn) NewClientUnprepped(username, password, authzID string) (*Client, error) ***REMOVED***
...
func (f HashGeneratorFcn) NewServer(cl CredentialLookup) (*Server, error) ***REMOVED***
