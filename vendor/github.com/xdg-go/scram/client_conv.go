...
type ClientConversation struct ***REMOVED***
	client   *Client
...
func (cc *ClientConversation) Step(challenge string) (response string, err error) ***REMOVED***
	switch cc.state ***REMOVED***
	case clientStarting:
...
func (cc *ClientConversation) Done() bool ***REMOVED***
...
func (cc *ClientConversation) Valid() bool ***REMOVED***
	return cc.valid
***REMOVED***

func (cc *ClientConversation) firstMsg() (string, error) ***REMOVED***
...
func (cc *ClientConversation) finalMsg(s1 string) (string, error) ***REMOVED***
	...
	***REMOVED***
	...
	dk := cc.client.getDerivedKeys(KeyFactors***REMOVED***Salt: string(msg.salt), Iters: msg.iters***REMOVED***)
...
func (cc *ClientConversation) validateServer(s2 string) (string, error) ***REMOVED***
	msg, err := parseServerFinal(s2)
	if err != nil ***REMOVED***
		return "", err
	***REMOVED***

	if len(msg.err) > 0 ***REMOVED***
		return "", fmt.Errorf("server error: %s", msg.err)
	***REMOVED***

	if !hmac.Equal(msg.verifier, cc.serveSig) ***REMOVED***
...
func (cc *ClientConversation) gs2Header() string ***REMOVED***
	if cc.client.authzID == "" ***REMOVED***
		return "n,,"
	***REMOVED***
