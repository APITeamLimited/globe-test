...
type ServerConversation struct ***REMOVED***
...
func (sc *ServerConversation) Step(challenge string) (response string, err error) ***REMOVED***
	switch sc.state ***REMOVED***
	case serverFirst:
...
func (sc *ServerConversation) AuthzID() string ***REMOVED***
	return sc.authzID
***REMOVED***

func (sc *ServerConversation) firstMsg(c1 string) (string, error) ***REMOVED***
...
func (sc *ServerConversation) finalMsg(c2 string) (string, error) ***REMOVED***
	...
	***REMOVED***
	...
	if string(msg.cbind) != sc.gs2Header ***REMOVED***
	...
	***REMOVED***
	...
	if !hmac.Equal(storedKey, sc.credential.StoredKey) ***REMOVED***
