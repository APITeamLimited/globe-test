...
func (rr RuneRange) Contains(r rune) bool ***REMOVED***
	return rr[0] <= r && r <= rr[1]
***REMOVED***

func (rr RuneRange) isAbove(r rune) bool ***REMOVED***
	return r <= rr[0]
***REMOVED***
...
// Set.
func (s Set) Contains(r rune) bool ***REMOVED***
	i := sort.Search(len(s), func(i int) bool ***REMOVED*** return s[i].Contains(r) || s[i].isAbove(r) ***REMOVED***)
	if i < len(s) && s[i].Contains(r) ***REMOVED***
		return true
	***REMOVED***
	return false
***REMOVED***
