...
field, and what validation failed so we could provide a localized error.
	...
	if fieldErr.Field == "Name" ***REMOVED***
...
Custom functions can be added. Example:
	...
	// Structure
	func customFunc(v *Validate, topStruct reflect.Value, currentStructOrField reflect.Value, field reflect.Value, fieldType reflect.Type, fieldKind reflect.Kind, param string) bool ***REMOVED***
...
used "eqcsfield" it could be multiple levels down. Example:
	...
	type Inner struct ***REMOVED***
		StartDate time.Time
	***REMOVED***

	type Outer struct ***REMOVED***
