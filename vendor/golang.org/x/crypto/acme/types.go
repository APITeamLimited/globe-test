...
func (a *AuthorizationError) Error() string ***REMOVED***
	e := make([]string, len(a.Errors))
	for i, err := range a.Errors ***REMOVED***
		e[i] = err.Error()
	***REMOVED***

	if a.Identifier != "" ***REMOVED***
...
type OrderError struct ***REMOVED***
	OrderURL string
	Status   string
***REMOVED***

func (oe *OrderError) Error() string ***REMOVED***
...
func RateLimit(err error) (time.Duration, bool) ***REMOVED***
	e, ok := err.(*Error)
	if !ok ***REMOVED***
		return 0, false
	***REMOVED***
	...
	if !strings.HasSuffix(strings.ToLower(e.ProblemType), ":ratelimited") ***REMOVED***
		return 0, false
	***REMOVED***
	if e.Header == nil ***REMOVED***
		return 0, true
	***REMOVED***
...
func (d *Directory) rfcCompliant() bool ***REMOVED***
	return d.OrderURL != ""
***REMOVED***

// Order represents a client's request for a certificate.
// It tracks the request flow progress through to issuance.
type Order struct ***REMOVED***
...
type OrderOption interface ***REMOVED***
	privateOrderOpt()
***REMOVED***

// WithOrderNotBefore sets order's NotBefore field.
func WithOrderNotBefore(t time.Time) OrderOption ***REMOVED***
	return orderNotBeforeOpt(t)
***REMOVED***

// WithOrderNotAfter sets order's NotAfter field.
func WithOrderNotAfter(t time.Time) OrderOption ***REMOVED***
	return orderNotAfterOpt(t)
***REMOVED***

type orderNotBeforeOpt time.Time

func (orderNotBeforeOpt) privateOrderOpt() ***REMOVED******REMOVED***

type orderNotAfterOpt time.Time

func (orderNotAfterOpt) privateOrderOpt() ***REMOVED******REMOVED***
...
func DomainIDs(names ...string) []AuthzID ***REMOVED***
	a := make([]AuthzID, len(names))
	for i, v := range names ***REMOVED***
		a[i] = AuthzID***REMOVED***Type: "dns", Value: v***REMOVED***
	***REMOVED***
	return a
***REMOVED***
...
func IPIDs(addr ...string) []AuthzID ***REMOVED***
	a := make([]AuthzID, len(addr))
	for i, v := range addr ***REMOVED***
		a[i] = AuthzID***REMOVED***Type: "ip", Value: v***REMOVED***
	***REMOVED***
	return a
***REMOVED***

// wireAuthzID is ACME JSON representation of authorization identifier objects.
type wireAuthzID struct ***REMOVED***
	Type  string `json:"type"`
	Value string `json:"value"`
***REMOVED***

// wireAuthz is ACME JSON representation of Authorization objects.
type wireAuthz struct ***REMOVED***
...
func (z *wireAuthz) authorization(uri string) *Authorization ***REMOVED***
	a := &Authorization***REMOVED***
		URI:          uri,
		Status:       z.Status,
		Identifier:   AuthzID***REMOVED***Type: z.Identifier.Type, Value: z.Identifier.Value***REMOVED***,
		Expires:      z.Expires,
		Wildcard:     z.Wildcard,
		Challenges:   make([]*Challenge, len(z.Challenges)),
		Combinations: z.Combinations, // shallow copy
	***REMOVED***
	for i, v := range z.Challenges ***REMOVED***
		a.Challenges[i] = v.challenge()
	***REMOVED***
	return a
***REMOVED***

func (z *wireAuthz) error(uri string) *AuthorizationError ***REMOVED***
	err := &AuthorizationError***REMOVED***
		URI:        uri,
		Identifier: z.Identifier.Value,
	***REMOVED***

	if z.Error != nil ***REMOVED***
		err.Errors = append(err.Errors, z.Error.error(nil))
	***REMOVED***

	for _, raw := range z.Challenges ***REMOVED***
		if raw.Error != nil ***REMOVED***
...
type wireChallenge struct ***REMOVED***
...
func (c *wireChallenge) challenge() *Challenge ***REMOVED***
	v := &Challenge***REMOVED***
		URI:    c.URL,
		Type:   c.Type,
		Token:  c.Token,
...
func (e *wireError) error(h http.Header) *Error ***REMOVED***
...
type CertOption interface ***REMOVED***
	privateCertOpt()
***REMOVED***

// WithKey creates an option holding a private/public key pair.
// The private part signs a certificate, and the public part represents the signee.
func WithKey(key crypto.Signer) CertOption ***REMOVED***
	return &certOptKey***REMOVED***key***REMOVED***
***REMOVED***

type certOptKey struct ***REMOVED***
	key crypto.Signer
***REMOVED***

func (*certOptKey) privateCertOpt() ***REMOVED******REMOVED***
...
func WithTemplate(t *x509.Certificate) CertOption ***REMOVED***
	return (*certOptTemplate)(t)
***REMOVED***

type certOptTemplate x509.Certificate

func (*certOptTemplate) privateCertOpt() ***REMOVED******REMOVED***
