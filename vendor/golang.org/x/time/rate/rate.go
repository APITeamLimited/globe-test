...
func (lim *Limiter) WaitN(ctx context.Context, n int) (err error) ***REMOVED***
	...
	newTimer := func(d time.Duration) (<-chan time.Time, func() bool, func()) ***REMOVED***
		timer := time.NewTimer(d)
		return timer.C, timer.Stop, func() ***REMOVED******REMOVED***
	***REMOVED***
...
func (lim *Limiter) wait(ctx context.Context, n int, now time.Time, newTimer func(d time.Duration) (<-chan time.Time, func() bool, func())) error ***REMOVED***
	lim.mu.Lock()
	burst := lim.burst
	limit := lim.limit
	lim.mu.Unlock()
...
func (lim *Limiter) reserveN(now time.Time, n int, maxFutureReserve time.Duration) Reservation ***REMOVED***
	...
	if lim.limit == Inf ***REMOVED***
		return Reservation***REMOVED***
			...
			timeToAct: now,
		***REMOVED***
	***REMOVED*** else if lim.limit == 0 ***REMOVED***
		var ok bool
		if lim.burst >= n ***REMOVED***
			ok = true
			lim.burst -= n
		***REMOVED***
		return Reservation***REMOVED***
