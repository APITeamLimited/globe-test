...
func ConfigureServer(s *http.Server, conf *Server) error ***REMOVED***
	...
	***REMOVED*** else if s.TLSConfig.CipherSuites != nil && s.TLSConfig.MinVersion < tls.VersionTLS13 ***REMOVED***
		// If they already provided a TLS 1.0–1.2 CipherSuite list, return an
		// error if it is missing ECDHE_RSA_WITH_AES_128_GCM_SHA256 or
		// ECDHE_ECDSA_WITH_AES_128_GCM_SHA256.
		haveRequired := false
		for _, cs := range s.TLSConfig.CipherSuites ***REMOVED***
			switch cs ***REMOVED***
...
func (s *Server) ServeConn(c net.Conn, opts *ServeConnOpts) ***REMOVED***
	...
	***REMOVED***
	...
	if opts.Settings != nil ***REMOVED***
		fr := &SettingsFrame***REMOVED***
			FrameHeader: FrameHeader***REMOVED***valid: true***REMOVED***,
			p:           opts.Settings,
		***REMOVED***
		if err := fr.ForeachSetting(sc.processSetting); err != nil ***REMOVED***
	...
	***REMOVED***
	...
	if opts.UpgradeRequest != nil ***REMOVED***
...
func (sc *serverConn) canonicalHeader(v string) string ***REMOVED***
	...
	***REMOVED***
	...
	if len(sc.canonHeader) < maxCachedCanonicalHeaders ***REMOVED***
		sc.canonHeader[v] = cv
	***REMOVED***
	return cv
***REMOVED***
	...
	***REMOVED***
	...
	for ***REMOVED***
		...
		case res := <-sc.readFrameCh:
			...
			if sc.writingFrameAsync ***REMOVED***
				select ***REMOVED***
...
func (sc *serverConn) readPreface() error ***REMOVED***
	if sc.sawClientPreface ***REMOVED***
		return nil
	***REMOVED***
...
func (sc *serverConn) processData(f *DataFrame) error ***REMOVED***
	...
	if sc.inGoAway && (sc.goAwayCode != ErrCodeNo || id > sc.maxClientStreamID) ***REMOVED***
...
func (sc *serverConn) processHeaders(f *MetaHeadersFrame) error ***REMOVED***
	...
	***REMOVED***
	...
	if f.HasPriority() ***REMOVED***
		if err := sc.checkPriority(f.StreamID, f.Priority); err != nil ***REMOVED***
			return err
		***REMOVED***
...
func (sc *serverConn) upgradeRequest(req *http.Request) ***REMOVED***
	sc.serveG.check()
	id := uint32(1)
	sc.maxClientStreamID = id
...
func (sc *serverConn) checkPriority(streamID uint32, p PriorityParam) error ***REMOVED***
...
func (sc *serverConn) processPriority(f *PriorityFrame) error ***REMOVED***
	if sc.inGoAway ***REMOVED***
		return nil
	***REMOVED***
	if err := sc.checkPriority(f.StreamID, f.PriorityParam); err != nil ***REMOVED***
		return err
	***REMOVED***
...
func (sc *serverConn) newResponseWriter(st *stream, req *http.Request) *responseWriter ***REMOVED***
	...
	*rws = responseWriterState***REMOVED******REMOVED*** // zero all the fields
	...
	rws.stream = st
	rws.req = req
	return &responseWriter***REMOVED***rws: rws***REMOVED***
***REMOVED***
...
func (b *requestBody) Close() error ***REMOVED***
	b.closeOnce.Do(func() ***REMOVED***
		if b.pipe != nil ***REMOVED***
	...
	***REMOVED***
	...
	if code >= 100 && code <= 199 ***REMOVED***
		...
		***REMOVED***
		...
		if rws.conn.writeHeaders(rws.stream, &writeResHeaders***REMOVED***
			streamID:    rws.stream.id,
			httpResCode: code,
			h:           h,
...
func (sc *serverConn) countError(name string, err error) error ***REMOVED***
	if sc == nil || sc.srv == nil ***REMOVED***
		return err
	***REMOVED***
	f := sc.srv.CountError
	if f == nil ***REMOVED***
