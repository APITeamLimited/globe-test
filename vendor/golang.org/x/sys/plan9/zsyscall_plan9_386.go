...
func fd2path(fd int, buf []byte) (err error) ***REMOVED***
...
func await(s []byte) (n int, err error) ***REMOVED***
	var _p0 unsafe.Pointer
	if len(s) > 0 ***REMOVED***
...
func Dup(oldfd int, newfd int) (fd int, err error) ***REMOVED***
...
func Fstat(fd int, edir []byte) (n int, err error) ***REMOVED***
	var _p0 unsafe.Pointer
	if len(edir) > 0 ***REMOVED***
...
func Fwstat(fd int, edir []byte) (err error) ***REMOVED***
	var _p0 unsafe.Pointer
	if len(edir) > 0 ***REMOVED***
		_p0 = unsafe.Pointer(&edir[0])
	***REMOVED*** else ***REMOVED***
