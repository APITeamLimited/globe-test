...
var (
	...
	WINTRUST_ACTION_GENERIC_VERIFY_V2 = GUID***REMOVED***
		Data1: 0xaac56b,
		Data2: 0xcd44,
		Data3: 0x11d0,
		Data4: [8]byte***REMOVED***0x8c, 0xc2, 0x0, 0xc0, 0x4f, 0xc2, 0x95, 0xee***REMOVED***,
	***REMOVED***
)
...
// doing so.
type Pointer *struct***REMOVED******REMOVED***
...
type StartupInfoEx struct ***REMOVED***
	StartupInfo
...
type ProcThreadAttributeList struct***REMOVED******REMOVED***

type ProcThreadAttributeListContainer struct ***REMOVED***
...
type ThreadEntry32 struct ***REMOVED***
	Size           uint32
	Usage          uint32
	ThreadID       uint32
...
type ModuleEntry32 struct ***REMOVED***
	Size         uint32
	ModuleID     uint32
	ProcessID    uint32
	GlblcntUsage uint32
...
const SizeofModuleEntry32 = unsafe.Sizeof(ModuleEntry32***REMOVED******REMOVED***)
...
type CertExtension struct ***REMOVED***
	ObjId    *byte
	Critical int32
	Value    CryptObjidBlob
***REMOVED***

type CryptAlgorithmIdentifier struct ***REMOVED***
	ObjId      *byte
	Parameters CryptObjidBlob
***REMOVED***

type CertPublicKeyInfo struct ***REMOVED***
	Algorithm CryptAlgorithmIdentifier
	PublicKey CryptBitBlob
***REMOVED***

type DataBlob struct ***REMOVED***
	Size uint32
	Data *byte
***REMOVED***
...
type CryptBitBlob struct ***REMOVED***
	Size       uint32
	Data       *byte
	UnusedBits uint32
***REMOVED***
...
type CertTrustListInfo struct ***REMOVED***
	// Not implemented
***REMOVED***
...
type CertRevocationCrlInfo struct ***REMOVED***
	// Not implemented
***REMOVED***
...
type CertPolicyInfo struct ***REMOVED***
	Identifier      *byte
	CountQualifiers uint32
	Qualifiers      *CertPolicyQualifierInfo
***REMOVED***

type CertPoliciesInfo struct ***REMOVED***
	Count       uint32
	PolicyInfos *CertPolicyInfo
***REMOVED***

type CertPolicyQualifierInfo struct ***REMOVED***
	// Not implemented
***REMOVED***

type CertStrongSignPara struct ***REMOVED***
	Size                      uint32
	InfoChoice                uint32
	InfoOrSerializedInfoOrOID unsafe.Pointer
***REMOVED***

type CryptProtectPromptStruct struct ***REMOVED***
	Size        uint32
	PromptFlags uint32
	App         HWND
	Prompt      *uint16
...
type CertChainFindByIssuerPara struct ***REMOVED***
	Size                   uint32
...
type WinTrustData struct ***REMOVED***
	Size                            uint32
...
type WinTrustFileInfo struct ***REMOVED***
	Size         uint32
	FilePath     *uint16
	File         Handle
	KnownSubject *GUID
...
type WinTrustSignatureSettings struct ***REMOVED***
	Size             uint32
	Index            uint32
	Flags            uint32
...
var WSAID_WSASENDMSG = GUID***REMOVED***
	0xa441e712,
	0x754f,
	0x43ca,
	[8]byte***REMOVED***0x84, 0xa7, 0x0d, 0xee, 0x44, 0xcf, 0x60, 0x6d***REMOVED***,
***REMOVED***

var WSAID_WSARECVMSG = GUID***REMOVED***
	0xf689d7c8,
	0x6f1f,
	0x436b,
	[8]byte***REMOVED***0x8a, 0x53, 0xe5, 0x4f, 0xe3, 0x51, 0xc3, 0x22***REMOVED***,
***REMOVED***
...
func (addr *SocketAddress) IP() net.IP ***REMOVED***
	if uintptr(addr.SockaddrLength) >= unsafe.Sizeof(RawSockaddrInet4***REMOVED******REMOVED***) && addr.Sockaddr.Addr.Family == AF_INET ***REMOVED***
		return (*RawSockaddrInet4)(unsafe.Pointer(addr.Sockaddr)).Addr[:]
	***REMOVED*** else if uintptr(addr.SockaddrLength) >= unsafe.Sizeof(RawSockaddrInet6***REMOVED******REMOVED***) && addr.Sockaddr.Addr.Family == AF_INET6 ***REMOVED***
...
type IO_COUNTERS struct ***REMOVED***
...
type JOBOBJECT_EXTENDED_LIMIT_INFORMATION struct ***REMOVED***
...
type JOBOBJECT_BASIC_UI_RESTRICTIONS struct ***REMOVED***
...
type CommTimeouts struct ***REMOVED***
...
type NTUnicodeString struct ***REMOVED***
	Length        uint16
...
type NTString struct ***REMOVED***
	Length        uint16
	MaximumLength uint16
	Buffer        *byte
***REMOVED***

type LIST_ENTRY struct ***REMOVED***
	Flink *LIST_ENTRY
	Blink *LIST_ENTRY
***REMOVED***

type RUNTIME_FUNCTION struct ***REMOVED***
	BeginAddress uint32
	EndAddress   uint32
	UnwindData   uint32
***REMOVED***

type LDR_DATA_TABLE_ENTRY struct ***REMOVED***
	reserved1          [2]uintptr
...
type PEB_LDR_DATA struct ***REMOVED***
	reserved1               [8]byte
	reserved2               [3]uintptr
	InMemoryOrderModuleList LIST_ENTRY
***REMOVED***

type CURDIR struct ***REMOVED***
	DosPath NTUnicodeString
	Handle  Handle
***REMOVED***

type RTL_DRIVE_LETTER_CURDIR struct ***REMOVED***
	Flags     uint16
	Length    uint16
	TimeStamp uint32
	DosPath   NTString
...
type RTL_USER_PROCESS_PARAMETERS struct ***REMOVED***
...
type OBJECT_ATTRIBUTES struct ***REMOVED***
	Length             uint32
...
type IO_STATUS_BLOCK struct ***REMOVED***
	Status      NTStatus
	Information uintptr
***REMOVED***

type RTLP_CURDIR_REF struct ***REMOVED***
	RefCount int32
	Handle   Handle
***REMOVED***

type RTL_RELATIVE_NAME struct ***REMOVED***
...
type PROCESS_BASIC_INFORMATION struct ***REMOVED***
	ExitStatus                   NTStatus
	PebBaseAddress               *PEB
...
type SYSTEM_PROCESS_INFORMATION struct ***REMOVED***
	NextEntryOffset              uint32
...
type RTL_PROCESS_MODULE_INFORMATION struct ***REMOVED***
	Section          Handle
	MappedBase       uintptr
	ImageBase        uintptr
	ImageSize        uint32
...
type RTL_PROCESS_MODULES struct ***REMOVED***
...
type ResourceIDOrString interface***REMOVED******REMOVED***
...
type VS_FIXEDFILEINFO struct ***REMOVED***
	Signature        uint32
	StrucVersion     uint32
...
type COAUTHIDENTITY struct ***REMOVED***
	User           *uint16
	UserLength     uint32
	Domain         *uint16
	DomainLength   uint32
...
type COAUTHINFO struct ***REMOVED***
	AuthnSvc           uint32
	AuthzSvc           uint32
...
type COSERVERINFO struct ***REMOVED***
	Reserved1 uint32
	Aame      *uint16
	AuthInfo  *COAUTHINFO
	Reserved2 uint32
...
type BIND_OPTS3 struct ***REMOVED***
	CbStruct          uint32
	Flags             uint32
	Mode              uint32
...
type ModuleInfo struct ***REMOVED***
	BaseOfDll   uintptr
	SizeOfImage uint32
	EntryPoint  uintptr
***REMOVED***
