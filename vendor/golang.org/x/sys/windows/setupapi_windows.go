...
type DevInfoData struct ***REMOVED***
	size      uint32
	ClassGUID GUID
	DevInst   DEVINST
	_         uintptr
...
type DevInfoListDetailData struct ***REMOVED***
...
func (*DevInfoListDetailData) unsafeSizeOf() uint32 ***REMOVED***
	if unsafe.Sizeof(uintptr(0)) == 4 ***REMOVED***
		// Windows declares this with pshpack1.h
		return uint32(unsafe.Offsetof(DevInfoListDetailData***REMOVED******REMOVED***.remoteMachineName) + unsafe.Sizeof(DevInfoListDetailData***REMOVED******REMOVED***.remoteMachineName))
	***REMOVED***
	return uint32(unsafe.Sizeof(DevInfoListDetailData***REMOVED******REMOVED***))
***REMOVED***

func (data *DevInfoListDetailData) RemoteMachineName() string ***REMOVED***
	return UTF16ToString(data.remoteMachineName[:])
***REMOVED***

func (data *DevInfoListDetailData) SetRemoteMachineName(remoteMachineName string) error ***REMOVED***
...
type DevInstallParams struct ***REMOVED***
	size                     uint32
	Flags                    DI_FLAGS
	FlagsEx                  DI_FLAGSEX
	hwndParent               uintptr
...
func (params *DevInstallParams) DriverPath() string ***REMOVED***
	return UTF16ToString(params.driverPath[:])
***REMOVED***

func (params *DevInstallParams) SetDriverPath(driverPath string) error ***REMOVED***
...
type ClassInstallHeader struct ***REMOVED***
	size            uint32
	InstallFunction DI_FUNCTION
***REMOVED***

func MakeClassInstallHeader(installFunction DI_FUNCTION) *ClassInstallHeader ***REMOVED***
	hdr := &ClassInstallHeader***REMOVED***InstallFunction: installFunction***REMOVED***
...
type PropChangeParams struct ***REMOVED***
...
type RemoveDeviceParams struct ***REMOVED***
	ClassInstallHeader ClassInstallHeader
...
type DrvInfoData struct ***REMOVED***
	size          uint32
	DriverType    uint32
	_             uintptr
...
func (data *DrvInfoData) Description() string ***REMOVED***
	return UTF16ToString(data.description[:])
***REMOVED***

func (data *DrvInfoData) SetDescription(description string) error ***REMOVED***
...
func (data *DrvInfoData) MfgName() string ***REMOVED***
	return UTF16ToString(data.mfgName[:])
***REMOVED***

func (data *DrvInfoData) SetMfgName(mfgName string) error ***REMOVED***
...
func (data *DrvInfoData) ProviderName() string ***REMOVED***
	return UTF16ToString(data.providerName[:])
***REMOVED***

func (data *DrvInfoData) SetProviderName(providerName string) error ***REMOVED***
...
func (data *DrvInfoData) IsNewer(driverDate Filetime, driverVersion uint64) bool ***REMOVED***
	if data.DriverDate.HighDateTime > driverDate.HighDateTime ***REMOVED***
		return true
	***REMOVED***
	if data.DriverDate.HighDateTime < driverDate.HighDateTime ***REMOVED***
		return false
	***REMOVED***
	...
	if data.DriverDate.LowDateTime > driverDate.LowDateTime ***REMOVED***
		return true
	***REMOVED***
	if data.DriverDate.LowDateTime < driverDate.LowDateTime ***REMOVED***
		return false
	***REMOVED***
	...
	if data.DriverVersion > driverVersion ***REMOVED***
		return true
	***REMOVED***
	if data.DriverVersion < driverVersion ***REMOVED***
		return false
...
type DrvInfoDetailData struct ***REMOVED***
	size            uint32 // Use unsafeSizeOf method
	InfDate         Filetime
...
func (*DrvInfoDetailData) unsafeSizeOf() uint32 ***REMOVED***
	if unsafe.Sizeof(uintptr(0)) == 4 ***REMOVED***
		// Windows declares this with pshpack1.h
		return uint32(unsafe.Offsetof(DrvInfoDetailData***REMOVED******REMOVED***.hardwareID) + unsafe.Sizeof(DrvInfoDetailData***REMOVED******REMOVED***.hardwareID))
	***REMOVED***
	return uint32(unsafe.Sizeof(DrvInfoDetailData***REMOVED******REMOVED***))
***REMOVED***

func (data *DrvInfoDetailData) SectionName() string ***REMOVED***
	return UTF16ToString(data.sectionName[:])
***REMOVED***

func (data *DrvInfoDetailData) InfFileName() string ***REMOVED***
	return UTF16ToString(data.infFileName[:])
***REMOVED***

func (data *DrvInfoDetailData) DrvDescription() string ***REMOVED***
	return UTF16ToString(data.drvDescription[:])
***REMOVED***

func (data *DrvInfoDetailData) HardwareID() string ***REMOVED***
	if data.compatIDsOffset > 1 ***REMOVED***
		bufW := data.getBuf()
...
func (data *DrvInfoDetailData) CompatIDs() []string ***REMOVED***
	a := make([]string, 0)

	if data.compatIDsLength > 0 ***REMOVED***
		bufW := data.getBuf()
		bufW = bufW[data.compatIDsOffset : data.compatIDsOffset+data.compatIDsLength]
		for i := 0; i < len(bufW); ***REMOVED***
			j := i + wcslen(bufW[i:])
			if i < j ***REMOVED***
...
func (data *DrvInfoDetailData) getBuf() []uint16 ***REMOVED***
	len := (data.size - uint32(unsafe.Offsetof(data.hardwareID))) / 2
	sl := struct ***REMOVED***
		addr *uint16
		len  int
		cap  int
	***REMOVED******REMOVED***&data.hardwareID[0], int(len), int(len)***REMOVED***
	return *(*[]uint16)(unsafe.Pointer(&sl))
***REMOVED***

// IsCompatible method tests if given hardware ID matches the driver or is listed on the compatible ID list.
func (data *DrvInfoDetailData) IsCompatible(hwid string) bool ***REMOVED***
	hwidLC := strings.ToLower(hwid)
	if strings.ToLower(data.HardwareID()) == hwidLC ***REMOVED***
		return true
	***REMOVED***
	a := data.CompatIDs()
	for i := range a ***REMOVED***
		if strings.ToLower(a[i]) == hwidLC ***REMOVED***
			return true
		***REMOVED***
	***REMOVED***
...
type DEVPROPKEY struct ***REMOVED***
	FmtID DEVPROPGUID
	PID   DEVPROPID
***REMOVED***
...
func SetupDiCreateDeviceInfoListEx(classGUID *GUID, hwndParent uintptr, machineName string) (deviceInfoSet DevInfo, err error) ***REMOVED***
	var machineNameUTF16 *uint16
	if machineName != "" ***REMOVED***
...
func SetupDiGetDeviceInfoListDetail(deviceInfoSet DevInfo) (deviceInfoSetDetailData *DevInfoListDetailData, err error) ***REMOVED***
	data := &DevInfoListDetailData***REMOVED******REMOVED***
...
func (deviceInfoSet DevInfo) DeviceInfoListDetail() (*DevInfoListDetailData, error) ***REMOVED***
...
func SetupDiCreateDeviceInfo(deviceInfoSet DevInfo, deviceName string, classGUID *GUID, deviceDescription string, hwndParent uintptr, creationFlags DICD) (deviceInfoData *DevInfoData, err error) ***REMOVED***
	...
	***REMOVED***
	...
	data := &DevInfoData***REMOVED******REMOVED***
...
func (deviceInfoSet DevInfo) CreateDeviceInfo(deviceName string, classGUID *GUID, deviceDescription string, hwndParent uintptr, creationFlags DICD) (*DevInfoData, error) ***REMOVED***
...
func SetupDiEnumDeviceInfo(deviceInfoSet DevInfo, memberIndex int) (*DevInfoData, error) ***REMOVED***
	data := &DevInfoData***REMOVED******REMOVED***
	data.size = uint32(unsafe.Sizeof(*data))
...
func (deviceInfoSet DevInfo) EnumDeviceInfo(memberIndex int) (*DevInfoData, error) ***REMOVED***
...
func (deviceInfoSet DevInfo) Close() error ***REMOVED***
...
func (deviceInfoSet DevInfo) BuildDriverInfoList(deviceInfoData *DevInfoData, driverType SPDIT) error ***REMOVED***
...
func (deviceInfoSet DevInfo) CancelDriverInfoSearch() error ***REMOVED***
...
func SetupDiEnumDriverInfo(deviceInfoSet DevInfo, deviceInfoData *DevInfoData, driverType SPDIT, memberIndex int) (*DrvInfoData, error) ***REMOVED***
	data := &DrvInfoData***REMOVED******REMOVED***
	data.size = uint32(unsafe.Sizeof(*data))
...
func (deviceInfoSet DevInfo) EnumDriverInfo(deviceInfoData *DevInfoData, driverType SPDIT, memberIndex int) (*DrvInfoData, error) ***REMOVED***
...
func SetupDiGetSelectedDriver(deviceInfoSet DevInfo, deviceInfoData *DevInfoData) (*DrvInfoData, error) ***REMOVED***
	data := &DrvInfoData***REMOVED******REMOVED***
	data.size = uint32(unsafe.Sizeof(*data))
...
func (deviceInfoSet DevInfo) SelectedDriver(deviceInfoData *DevInfoData) (*DrvInfoData, error) ***REMOVED***
...
func (deviceInfoSet DevInfo) SetSelectedDriver(deviceInfoData *DevInfoData, driverInfoData *DrvInfoData) error ***REMOVED***
...
func SetupDiGetDriverInfoDetail(deviceInfoSet DevInfo, deviceInfoData *DevInfoData, driverInfoData *DrvInfoData) (*DrvInfoDetailData, error) ***REMOVED***
	reqSize := uint32(2048)
	for ***REMOVED***
...
func (deviceInfoSet DevInfo) DriverInfoDetail(deviceInfoData *DevInfoData, driverInfoData *DrvInfoData) (*DrvInfoDetailData, error) ***REMOVED***
...
func (deviceInfoSet DevInfo) DestroyDriverInfoList(deviceInfoData *DevInfoData, driverType SPDIT) error ***REMOVED***
...
func SetupDiGetClassDevsEx(classGUID *GUID, enumerator string, hwndParent uintptr, flags DIGCF, deviceInfoSet DevInfo, machineName string) (handle DevInfo, err error) ***REMOVED***
...
func (deviceInfoSet DevInfo) CallClassInstaller(installFunction DI_FUNCTION, deviceInfoData *DevInfoData) error ***REMOVED***
...
func (deviceInfoSet DevInfo) OpenDevRegKey(DeviceInfoData *DevInfoData, Scope DICS_FLAG, HwProfile uint32, KeyType DIREG, samDesired uint32) (Handle, error) ***REMOVED***
...
func SetupDiGetDeviceProperty(deviceInfoSet DevInfo, deviceInfoData *DevInfoData, propertyKey *DEVPROPKEY) (value interface***REMOVED******REMOVED***, err error) ***REMOVED***
	reqSize := uint32(256)
	for ***REMOVED***
...
func SetupDiGetDeviceRegistryProperty(deviceInfoSet DevInfo, deviceInfoData *DevInfoData, property SPDRP) (value interface***REMOVED******REMOVED***, err error) ***REMOVED***
	reqSize := uint32(256)
	for ***REMOVED***
		var dataType uint32
		buf := make([]byte, reqSize)
...
func getRegistryValue(buf []byte, dataType uint32) (interface***REMOVED******REMOVED***, error) ***REMOVED***
	switch dataType ***REMOVED***
	case REG_SZ:
		ret := UTF16ToString(bufToUTF16(buf))
		runtime.KeepAlive(buf)
...
func bufToUTF16(buf []byte) []uint16 ***REMOVED***
	sl := struct ***REMOVED***
		addr *uint16
		len  int
		cap  int
	***REMOVED******REMOVED***(*uint16)(unsafe.Pointer(&buf[0])), len(buf) / 2, cap(buf) / 2***REMOVED***
	return *(*[]uint16)(unsafe.Pointer(&sl))
***REMOVED***

// utf16ToBuf function reinterprets []uint16 as []byte
func utf16ToBuf(buf []uint16) []byte ***REMOVED***
	sl := struct ***REMOVED***
		addr *byte
		len  int
		cap  int
	***REMOVED******REMOVED***(*byte)(unsafe.Pointer(&buf[0])), len(buf) * 2, cap(buf) * 2***REMOVED***
	return *(*[]byte)(unsafe.Pointer(&sl))
***REMOVED***

func wcslen(str []uint16) int ***REMOVED***
...
func (deviceInfoSet DevInfo) DeviceRegistryProperty(deviceInfoData *DevInfoData, property SPDRP) (interface***REMOVED******REMOVED***, error) ***REMOVED***
...
func SetupDiSetDeviceRegistryProperty(deviceInfoSet DevInfo, deviceInfoData *DevInfoData, property SPDRP, propertyBuffers []byte) error ***REMOVED***
	return setupDiSetDeviceRegistryProperty(deviceInfoSet, deviceInfoData, property, &propertyBuffers[0], uint32(len(propertyBuffers)))
***REMOVED***

// SetDeviceRegistryProperty function sets a Plug and Play device property for a device.
func (deviceInfoSet DevInfo) SetDeviceRegistryProperty(deviceInfoData *DevInfoData, property SPDRP, propertyBuffers []byte) error ***REMOVED***
	return SetupDiSetDeviceRegistryProperty(deviceInfoSet, deviceInfoData, property, propertyBuffers)
***REMOVED***

// SetDeviceRegistryPropertyString method sets a Plug and Play device property string for a device.
func (deviceInfoSet DevInfo) SetDeviceRegistryPropertyString(deviceInfoData *DevInfoData, property SPDRP, str string) error ***REMOVED***
...
func SetupDiGetDeviceInstallParams(deviceInfoSet DevInfo, deviceInfoData *DevInfoData) (*DevInstallParams, error) ***REMOVED***
	params := &DevInstallParams***REMOVED******REMOVED***
...
func (deviceInfoSet DevInfo) DeviceInstallParams(deviceInfoData *DevInfoData) (*DevInstallParams, error) ***REMOVED***
...
func SetupDiGetDeviceInstanceId(deviceInfoSet DevInfo, deviceInfoData *DevInfoData) (string, error) ***REMOVED***
	reqSize := uint32(1024)
	for ***REMOVED***
...
func (deviceInfoSet DevInfo) DeviceInstanceID(deviceInfoData *DevInfoData) (string, error) ***REMOVED***
...
func (deviceInfoSet DevInfo) ClassInstallParams(deviceInfoData *DevInfoData, classInstallParams *ClassInstallHeader, classInstallParamsSize uint32, requiredSize *uint32) error ***REMOVED***
...
func (deviceInfoSet DevInfo) SetDeviceInstallParams(deviceInfoData *DevInfoData, deviceInstallParams *DevInstallParams) error ***REMOVED***
...
func (deviceInfoSet DevInfo) SetClassInstallParams(deviceInfoData *DevInfoData, classInstallParams *ClassInstallHeader, classInstallParamsSize uint32) error ***REMOVED***
...
func SetupDiClassNameFromGuidEx(classGUID *GUID, machineName string) (className string, err error) ***REMOVED***
...
func SetupDiClassGuidsFromNameEx(className string, machineName string) ([]GUID, error) ***REMOVED***
...
func SetupDiGetSelectedDevice(deviceInfoSet DevInfo) (*DevInfoData, error) ***REMOVED***
	data := &DevInfoData***REMOVED******REMOVED***
	data.size = uint32(unsafe.Sizeof(*data))
...
func (deviceInfoSet DevInfo) SelectedDevice() (*DevInfoData, error) ***REMOVED***
...
func (deviceInfoSet DevInfo) SetSelectedDevice(deviceInfoData *DevInfoData) error ***REMOVED***
...
func SetupUninstallOEMInf(infFileName string, flags SUOI) error ***REMOVED***
...
func CM_Get_Device_Interface_List(deviceID string, interfaceClass *GUID, flags uint32) ([]string, error) ***REMOVED***
	...
	***REMOVED***
	...
	var buflen uint32
	for ***REMOVED***
		if ret := cm_Get_Device_Interface_List_Size(&buflen, interfaceClass, deviceID16, flags); ret != CR_SUCCESS ***REMOVED***
			return nil, ret
		***REMOVED***
		buf = make([]uint16, buflen)
		if ret := cm_Get_Device_Interface_List(interfaceClass, deviceID16, &buf[0], buflen, flags); ret == CR_SUCCESS ***REMOVED***
			break
		***REMOVED*** else if ret != CR_BUFFER_SMALL ***REMOVED***
			return nil, ret
		***REMOVED***
	***REMOVED***
...
func CM_Get_DevNode_Status(status *uint32, problemNumber *uint32, devInst DEVINST, flags uint32) error ***REMOVED***
	ret := cm_Get_DevNode_Status(status, problemNumber, devInst, flags)
	if ret == CR_SUCCESS ***REMOVED***
		return nil
	***REMOVED***
	return ret
***REMOVED***
