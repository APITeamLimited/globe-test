...
func UTF16PtrToString(p *uint16) string ***REMOVED***
	if p == nil ***REMOVED***
		return ""
	***REMOVED***
	if *p == 0 ***REMOVED***
	...
	***REMOVED***
	...
	// Find NUL terminator.
	n := 0
	for ptr := unsafe.Pointer(p); *(*uint16)(ptr) != 0; n++ ***REMOVED***
...
// error.
func GetCurrentProcess() (Handle, error) ***REMOVED***
	return CurrentProcess(), nil
***REMOVED***

// CurrentProcess returns the handle for the current process.
// It is a pseudo handle that does not need to be closed.
func CurrentProcess() Handle ***REMOVED*** return Handle(^uintptr(1 - 1)) ***REMOVED***
...
// error.
func GetCurrentThread() (Handle, error) ***REMOVED***
	return CurrentThread(), nil
***REMOVED***

// CurrentThread returns the handle for the current thread.
// It is a pseudo handle that does not need to be closed.
func CurrentThread() Handle ***REMOVED*** return Handle(^uintptr(2 - 1)) ***REMOVED***
...
func DurationSinceBoot() time.Duration ***REMOVED***
...
func WaitForMultipleObjects(handles []Handle, waitAll bool, waitMilliseconds uint32) (event uint32, err error) ***REMOVED***
	// Every other win32 array API takes arguments as "pointer, count", except for this function. So we
	// can't declare it as a usual [] type, because mksyscall will use the opposite order. We therefore
	// trivially stub this ourselves.

	var handlePtr *Handle
	if len(handles) > 0 ***REMOVED***
		handlePtr = &handles[0]
	***REMOVED***
...
func Sendto(fd Handle, p []byte, flags int, to Sockaddr) (err error) ***REMOVED***
...
func GetsockoptInt(fd Handle, level, opt int) (int, error) ***REMOVED***
	v := int32(0)
...
// "***REMOVED***XXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX***REMOVED***" into a GUID.
func GUIDFromString(str string) (GUID, error) ***REMOVED***
	guid := GUID***REMOVED******REMOVED***
...
func GenerateGUID() (GUID, error) ***REMOVED***
	guid := GUID***REMOVED******REMOVED***
...
// in the form of "***REMOVED***XXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX***REMOVED***".
func (guid GUID) String() string ***REMOVED***
	var str [100]uint16
...
func KnownFolderPath(folderID *KNOWNFOLDERID, flags uint32) (string, error) ***REMOVED***
	return Token(0).KnownFolderPath(folderID, flags)
***REMOVED***

// KnownFolderPath returns a well-known folder path for the user token, specified by one of
// the FOLDERID_ constants, and chosen and optionally created based on a KF_ flag.
func (t Token) KnownFolderPath(folderID *KNOWNFOLDERID, flags uint32) (string, error) ***REMOVED***
	var p *uint16
...
func RtlGetVersion() *OsVersionInfoEx ***REMOVED***
	info := &OsVersionInfoEx***REMOVED******REMOVED***
...
func RtlGetNtVersionNumbers() (majorVersion, minorVersion, buildNumber uint32) ***REMOVED***
...
func GetProcessPreferredUILanguages(flags uint32) ([]string, error) ***REMOVED***
	return getUILanguages(flags, getProcessPreferredUILanguages)
***REMOVED***

// GetThreadPreferredUILanguages retrieves the thread preferred UI languages for the current thread.
func GetThreadPreferredUILanguages(flags uint32) ([]string, error) ***REMOVED***
	return getUILanguages(flags, getThreadPreferredUILanguages)
***REMOVED***

// GetUserPreferredUILanguages retrieves information about the user preferred UI languages.
func GetUserPreferredUILanguages(flags uint32) ([]string, error) ***REMOVED***
	return getUILanguages(flags, getUserPreferredUILanguages)
***REMOVED***

// GetSystemPreferredUILanguages retrieves the system preferred UI languages.
func GetSystemPreferredUILanguages(flags uint32) ([]string, error) ***REMOVED***
	return getUILanguages(flags, getSystemPreferredUILanguages)
***REMOVED***

func getUILanguages(flags uint32, f func(flags uint32, numLanguages *uint32, buf *uint16, bufSize *uint32) error) ([]string, error) ***REMOVED***
	size := uint32(128)
	for ***REMOVED***
		...
		***REMOVED***
		buf = buf[:size]
		if numLanguages == 0 || len(buf) == 0 ***REMOVED*** // GetProcessPreferredUILanguages may return numLanguages==0 with "\0\0"
			return []string***REMOVED******REMOVED***, nil
		***REMOVED***
		if buf[len(buf)-1] == 0 ***REMOVED***
...
func SetConsoleCursorPosition(console Handle, position Coord) error ***REMOVED***
	return setConsoleCursorPosition(console, *((*uint32)(unsafe.Pointer(&position))))
***REMOVED***

func (s NTStatus) Errno() syscall.Errno ***REMOVED***
	return rtlNtStatusToDosErrorNoTeb(s)
***REMOVED***

func langID(pri, sub uint16) uint32 ***REMOVED*** return uint32(sub)<<10 | uint32(pri) ***REMOVED***

func (s NTStatus) Error() string ***REMOVED***
	b := make([]uint16, 300)
...
func NewNTUnicodeString(s string) (*NTUnicodeString, error) ***REMOVED***
...
func (s *NTUnicodeString) Slice() []uint16 ***REMOVED***
	var slice []uint16
...
func (s *NTUnicodeString) String() string ***REMOVED***
...
// the more common *uint16 string type.
func NewNTString(s string) (*NTString, error) ***REMOVED***
	var nts NTString
...
func (s *NTString) Slice() []byte ***REMOVED***
	var slice []byte
	hdr := (*unsafeheader.Slice)(unsafe.Pointer(&slice))
	hdr.Data = unsafe.Pointer(s.Buffer)
	hdr.Len = int(s.Length)
...
func (s *NTString) String() string ***REMOVED***
	return ByteSliceToString(s.Slice())
***REMOVED***

// FindResource resolves a resource of the given name and resource type.
func FindResource(module Handle, name, resType ResourceIDOrString) (Handle, error) ***REMOVED***
	var namePtr, resTypePtr uintptr
	var name16, resType16 *uint16
	var err error
	resolvePtr := func(i interface***REMOVED******REMOVED***, keep **uint16) (uintptr, error) ***REMOVED***
...
func LoadResourceData(module, resInfo Handle) (data []byte, err error) ***REMOVED***
