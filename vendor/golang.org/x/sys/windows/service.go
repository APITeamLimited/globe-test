...
type SERVICE_DELAYED_AUTO_START_INFO struct ***REMOVED***
...
type SERVICE_NOTIFY struct ***REMOVED***
	Version               uint32
...
type SERVICE_FAILURE_ACTIONS struct ***REMOVED***
	ResetPeriod  uint32
	RebootMsg    *uint16
	Command      *uint16
	ActionsCount uint32
...
type SC_ACTION struct ***REMOVED***
	Type  uint32
	Delay uint32
***REMOVED***

type QUERY_SERVICE_LOCK_STATUS struct ***REMOVED***
	IsLocked     uint32
	LockOwner    *uint16
	LockDuration uint32
***REMOVED***
