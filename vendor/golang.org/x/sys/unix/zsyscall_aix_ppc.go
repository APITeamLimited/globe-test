...
func utimensat(dirfd int, path string, times *[2]Timespec, flag int) (err error) ***REMOVED***
	_p0 := uintptr(unsafe.Pointer(C.CString(path)))
...
func getcwd(buf []byte) (err error) ***REMOVED***
	var _p0 *byte
...
func getdirent(fd int, buf []byte) (n int, err error) ***REMOVED***
	var _p0 *byte
	if len(buf) > 0 ***REMOVED***
		_p0 = &buf[0]
	***REMOVED***
...
func wait4(pid Pid_t, status *_C_int, options int, rusage *Rusage) (wpid Pid_t, err error) ***REMOVED***
...
func FcntlInt(fd uintptr, cmd int, arg int) (r int, err error) ***REMOVED***
...
func FcntlFlock(fd uintptr, cmd int, lk *Flock_t) (err error) ***REMOVED***
...
func fsyncRange(fd int, how int, start int64, length int64) (err error) ***REMOVED***
...
func Kill(pid int, sig Signal) (err error) ***REMOVED***
...
func Mkdir(dirfd int, path string, mode uint32) (err error) ***REMOVED***
	_p0 := uintptr(unsafe.Pointer(C.CString(path)))
...
func Times(tms *Tms) (ticks uintptr, err error) ***REMOVED***
	...
	ticks = uintptr(r0)
	if uintptr(r0) == ^uintptr(0) && er != nil ***REMOVED***
		err = er
	***REMOVED***
	return
***REMOVED***
...
func stat(path string, statptr *Stat_t) (err error) ***REMOVED***
	_p0 := uintptr(unsafe.Pointer(C.CString(path)))
...
func gettimeofday(tv *Timeval, tzp *Timezone) (err error) ***REMOVED***
...
func Getsystemcfg(label int) (n uint64) ***REMOVED***
...
func umount(target string) (err error) ***REMOVED***
