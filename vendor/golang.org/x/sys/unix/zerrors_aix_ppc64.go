...
var errorList = [...]struct ***REMOVED***
	...
	desc string
***REMOVED******REMOVED***
	***REMOVED***1, "EPERM", "not owner"***REMOVED***,
	...
	***REMOVED***5, "EIO", "I/O error"***REMOVED***,
	***REMOVED***6, "ENXIO", "no such device or address"***REMOVED***,
	***REMOVED***7, "E2BIG", "arg list too long"***REMOVED***,
	***REMOVED***8, "ENOEXEC", "exec format error"***REMOVED***,
	***REMOVED***9, "EBADF", "bad file number"***REMOVED***,
	***REMOVED***10, "ECHILD", "no child processes"***REMOVED***,
	***REMOVED***11, "EWOULDBLOCK", "resource temporarily unavailable"***REMOVED***,
	***REMOVED***12, "ENOMEM", "not enough space"***REMOVED***,
	...
	***REMOVED***16, "EBUSY", "device busy"***REMOVED***,
	***REMOVED***17, "ENOTEMPTY", "file exists"***REMOVED***,
	***REMOVED***18, "EXDEV", "cross-device link"***REMOVED***,
	...
	***REMOVED***23, "ENFILE", "file table overflow"***REMOVED***,
	***REMOVED***24, "EMFILE", "too many open files"***REMOVED***,
	***REMOVED***25, "ENOTTY", "not a typewriter"***REMOVED***,
	...
	***REMOVED***33, "EDOM", "argument out of domain"***REMOVED***,
	***REMOVED***34, "ERANGE", "result too large"***REMOVED***,
	...
	***REMOVED***45, "EDEADLK", "deadlock condition if locked"***REMOVED***,
	***REMOVED***46, "ENOTREADY", "device not ready"***REMOVED***,
	***REMOVED***47, "EWRPROTECT", "write-protected media"***REMOVED***,
	***REMOVED***48, "EFORMAT", "unformatted or incompatible media"***REMOVED***,
	***REMOVED***49, "ENOLCK", "no locks available"***REMOVED***,
	***REMOVED***50, "ENOCONNECT", "cannot Establish Connection"***REMOVED***,
	***REMOVED***52, "ESTALE", "missing file or filesystem"***REMOVED***,
	***REMOVED***53, "EDIST", "requests blocked by Administrator"***REMOVED***,
	***REMOVED***55, "EINPROGRESS", "operation now in progress"***REMOVED***,
	***REMOVED***56, "EALREADY", "operation already in progress"***REMOVED***,
	***REMOVED***57, "ENOTSOCK", "socket operation on non-socket"***REMOVED***,
	***REMOVED***58, "EDESTADDREQ", "destination address required"***REMOVED***,
	***REMOVED***59, "EMSGSIZE", "message too long"***REMOVED***,
	***REMOVED***60, "EPROTOTYPE", "protocol wrong type for socket"***REMOVED***,
	***REMOVED***61, "ENOPROTOOPT", "protocol not available"***REMOVED***,
	***REMOVED***62, "EPROTONOSUPPORT", "protocol not supported"***REMOVED***,
	***REMOVED***63, "ESOCKTNOSUPPORT", "socket type not supported"***REMOVED***,
	***REMOVED***64, "EOPNOTSUPP", "operation not supported on socket"***REMOVED***,
	***REMOVED***65, "EPFNOSUPPORT", "protocol family not supported"***REMOVED***,
	***REMOVED***66, "EAFNOSUPPORT", "addr family not supported by protocol"***REMOVED***,
	***REMOVED***67, "EADDRINUSE", "address already in use"***REMOVED***,
	***REMOVED***68, "EADDRNOTAVAIL", "can't assign requested address"***REMOVED***,
	***REMOVED***69, "ENETDOWN", "network is down"***REMOVED***,
	***REMOVED***70, "ENETUNREACH", "network is unreachable"***REMOVED***,
	***REMOVED***71, "ENETRESET", "network dropped connection on reset"***REMOVED***,
	***REMOVED***72, "ECONNABORTED", "software caused connection abort"***REMOVED***,
	***REMOVED***73, "ECONNRESET", "connection reset by peer"***REMOVED***,
	***REMOVED***74, "ENOBUFS", "no buffer space available"***REMOVED***,
	***REMOVED***75, "EISCONN", "socket is already connected"***REMOVED***,
	***REMOVED***76, "ENOTCONN", "socket is not connected"***REMOVED***,
	***REMOVED***77, "ESHUTDOWN", "can't send after socket shutdown"***REMOVED***,
	***REMOVED***78, "ETIMEDOUT", "connection timed out"***REMOVED***,
	***REMOVED***79, "ECONNREFUSED", "connection refused"***REMOVED***,
	***REMOVED***80, "EHOSTDOWN", "host is down"***REMOVED***,
	***REMOVED***81, "EHOSTUNREACH", "no route to host"***REMOVED***,
	***REMOVED***82, "ERESTART", "restart the system call"***REMOVED***,
	***REMOVED***83, "EPROCLIM", "too many processes"***REMOVED***,
	***REMOVED***84, "EUSERS", "too many users"***REMOVED***,
	***REMOVED***85, "ELOOP", "too many levels of symbolic links"***REMOVED***,
	***REMOVED***86, "ENAMETOOLONG", "file name too long"***REMOVED***,
	***REMOVED***88, "EDQUOT", "disk quota exceeded"***REMOVED***,
	***REMOVED***89, "ECORRUPT", "invalid file system control data detected"***REMOVED***,
	***REMOVED***90, "ESYSERROR", "for future use "***REMOVED***,
	***REMOVED***93, "EREMOTE", "item is not local to host"***REMOVED***,
	***REMOVED***94, "ENOTRECOVERABLE", "state not recoverable "***REMOVED***,
	***REMOVED***95, "EOWNERDEAD", "previous owner died "***REMOVED***,
	***REMOVED***109, "ENOSYS", "function not implemented"***REMOVED***,
	***REMOVED***110, "EMEDIA", "media surface error"***REMOVED***,
	***REMOVED***111, "ESOFT", "I/O completed, but needs relocation"***REMOVED***,
	***REMOVED***112, "ENOATTR", "no attribute found"***REMOVED***,
	***REMOVED***113, "ESAD", "security Authentication Denied"***REMOVED***,
	***REMOVED***114, "ENOTRUST", "not a Trusted Program"***REMOVED***,
	***REMOVED***115, "ETOOMANYREFS", "too many references: can't splice"***REMOVED***,
	***REMOVED***116, "EILSEQ", "invalid wide character"***REMOVED***,
	***REMOVED***117, "ECANCELED", "asynchronous I/O cancelled"***REMOVED***,
	***REMOVED***118, "ENOSR", "out of STREAMS resources"***REMOVED***,
	***REMOVED***119, "ETIME", "system call timed out"***REMOVED***,
	***REMOVED***120, "EBADMSG", "next message has wrong type"***REMOVED***,
	***REMOVED***121, "EPROTO", "error in protocol"***REMOVED***,
	***REMOVED***122, "ENODATA", "no message on stream head read q"***REMOVED***,
	***REMOVED***123, "ENOSTR", "fd not associated with a stream"***REMOVED***,
	***REMOVED***124, "ENOTSUP", "unsupported attribute value"***REMOVED***,
	***REMOVED***125, "EMULTIHOP", "multihop is not allowed"***REMOVED***,
	***REMOVED***126, "ENOLINK", "the server link has been severed"***REMOVED***,
	***REMOVED***127, "EOVERFLOW", "value too large to be stored in data type"***REMOVED***,
***REMOVED***
...
***REMOVED******REMOVED***
	...
	***REMOVED***5, "SIGTRAP", "trace/BPT trap"***REMOVED***,
	***REMOVED***6, "SIGIOT", "IOT/Abort trap"***REMOVED***,
	...
	***REMOVED***16, "SIGURG", "urgent I/O condition"***REMOVED***,
	***REMOVED***17, "SIGSTOP", "stopped (signal)"***REMOVED***,
	***REMOVED***18, "SIGTSTP", "stopped"***REMOVED***,
	...
	***REMOVED***23, "SIGIO", "I/O possible/complete"***REMOVED***,
	***REMOVED***24, "SIGXCPU", "cputime limit exceeded"***REMOVED***,
	***REMOVED***25, "SIGXFSZ", "filesize limit exceeded"***REMOVED***,
	***REMOVED***27, "SIGMSG", "input device data"***REMOVED***,
	***REMOVED***28, "SIGWINCH", "window size changes"***REMOVED***,
	***REMOVED***29, "SIGPWR", "power-failure"***REMOVED***,
	***REMOVED***30, "SIGUSR1", "user defined signal 1"***REMOVED***,
	***REMOVED***31, "SIGUSR2", "user defined signal 2"***REMOVED***,
	***REMOVED***32, "SIGPROF", "profiling timer expired"***REMOVED***,
	***REMOVED***33, "SIGDANGER", "paging space low"***REMOVED***,
	***REMOVED***34, "SIGVTALRM", "virtual timer expired"***REMOVED***,
	***REMOVED***35, "SIGMIGRATE", "signal 35"***REMOVED***,
	***REMOVED***36, "SIGPRE", "signal 36"***REMOVED***,
	***REMOVED***37, "SIGVIRT", "signal 37"***REMOVED***,
	***REMOVED***38, "SIGTALRM", "signal 38"***REMOVED***,
	***REMOVED***39, "SIGWAITING", "signal 39"***REMOVED***,
	***REMOVED***48, "SIGSYSERROR", "signal 48"***REMOVED***,
	***REMOVED***49, "SIGCAPI", "signal 49"***REMOVED***,
	***REMOVED***58, "SIGRECONFIG", "signal 58"***REMOVED***,
	***REMOVED***59, "SIGCPUFAIL", "CPU Failure Predicted"***REMOVED***,
	***REMOVED***60, "SIGGRANT", "monitor mode granted"***REMOVED***,
	***REMOVED***61, "SIGRETRACT", "monitor mode retracted"***REMOVED***,
	***REMOVED***62, "SIGSOUND", "sound completed"***REMOVED***,
	***REMOVED***63, "SIGMAX32", "secure attention"***REMOVED***,
	***REMOVED***255, "SIGMAX", "signal 255"***REMOVED***,
***REMOVED***
