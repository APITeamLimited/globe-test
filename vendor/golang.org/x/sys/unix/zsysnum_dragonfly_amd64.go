...
const (
	...
	SYS_EXTPREADV              = 289 // ***REMOVED*** ssize_t extpreadv(int fd, struct iovec *iovp, u_int iovcnt, int flags, off_t offset); ***REMOVED***
	SYS_EXTPWRITEV             = 290 // ***REMOVED*** ssize_t extpwritev(int fd, struct iovec *iovp,u_int iovcnt, int flags, off_t offset); ***REMOVED***
