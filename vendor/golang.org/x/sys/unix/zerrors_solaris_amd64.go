...
***REMOVED******REMOVED***
	...
	***REMOVED***45, "EDEADLK", "deadlock situation detected/avoided"***REMOVED***,
	***REMOVED***46, "ENOLCK", "no record locks available"***REMOVED***,
	***REMOVED***47, "ECANCELED", "operation canceled"***REMOVED***,
	***REMOVED***48, "ENOTSUP", "operation not supported"***REMOVED***,
	***REMOVED***49, "EDQUOT", "disc quota exceeded"***REMOVED***,
	***REMOVED***50, "EBADE", "bad exchange descriptor"***REMOVED***,
	***REMOVED***51, "EBADR", "bad request descriptor"***REMOVED***,
	***REMOVED***52, "EXFULL", "message tables full"***REMOVED***,
	***REMOVED***53, "ENOANO", "anode table overflow"***REMOVED***,
	***REMOVED***54, "EBADRQC", "bad request code"***REMOVED***,
	***REMOVED***55, "EBADSLT", "invalid slot"***REMOVED***,
	***REMOVED***56, "EDEADLOCK", "file locking deadlock"***REMOVED***,
	***REMOVED***57, "EBFONT", "bad font file format"***REMOVED***,
	***REMOVED***58, "EOWNERDEAD", "owner of the lock died"***REMOVED***,
	***REMOVED***59, "ENOTRECOVERABLE", "lock is not recoverable"***REMOVED***,
	***REMOVED***60, "ENOSTR", "not a stream device"***REMOVED***,
	***REMOVED***61, "ENODATA", "no data available"***REMOVED***,
	***REMOVED***62, "ETIME", "timer expired"***REMOVED***,
	***REMOVED***63, "ENOSR", "out of stream resources"***REMOVED***,
	...
	***REMOVED***72, "ELOCKUNMAPPED", "locked lock was unmapped "***REMOVED***,
	***REMOVED***73, "ENOTACTIVE", "facility is not active"***REMOVED***,
	***REMOVED***74, "EMULTIHOP", "multihop attempted"***REMOVED***,
	***REMOVED***77, "EBADMSG", "not a data message"***REMOVED***,
	...
	***REMOVED***86, "ELIBMAX", "attempting to link in more shared libraries than system limit"***REMOVED***,
	***REMOVED***87, "ELIBEXEC", "can not exec a shared library directly"***REMOVED***,
	***REMOVED***88, "EILSEQ", "illegal byte sequence"***REMOVED***,
	***REMOVED***89, "ENOSYS", "operation not applicable"***REMOVED***,
	***REMOVED***90, "ELOOP", "number of symbolic links encountered during path name traversal exceeds MAXSYMLINKS"***REMOVED***,
	***REMOVED***91, "ERESTART", "error 91"***REMOVED***,
	***REMOVED***92, "ESTRPIPE", "error 92"***REMOVED***,
	...
	***REMOVED***99, "ENOPROTOOPT", "option not supported by protocol"***REMOVED***,
	***REMOVED***120, "EPROTONOSUPPORT", "protocol not supported"***REMOVED***,
	***REMOVED***121, "ESOCKTNOSUPPORT", "socket type not supported"***REMOVED***,
	***REMOVED***122, "EOPNOTSUPP", "operation not supported on transport endpoint"***REMOVED***,
	***REMOVED***123, "EPFNOSUPPORT", "protocol family not supported"***REMOVED***,
	***REMOVED***124, "EAFNOSUPPORT", "address family not supported by protocol family"***REMOVED***,
	...
	***REMOVED***129, "ENETRESET", "network dropped connection because of reset"***REMOVED***,
	...
	***REMOVED***143, "ESHUTDOWN", "cannot send after socket shutdown"***REMOVED***,
	...
	***REMOVED***151, "ESTALE", "stale NFS file handle"***REMOVED***,
***REMOVED***
...
***REMOVED******REMOVED***
	...
	***REMOVED***6, "SIGABRT", "abort"***REMOVED***,
	***REMOVED***7, "SIGEMT", "emulation Trap"***REMOVED***,
	***REMOVED***8, "SIGFPE", "arithmetic Exception"***REMOVED***,
	...
	***REMOVED***16, "SIGUSR1", "user Signal 1"***REMOVED***,
	***REMOVED***17, "SIGUSR2", "user Signal 2"***REMOVED***,
	***REMOVED***18, "SIGCHLD", "child Status Changed"***REMOVED***,
	***REMOVED***19, "SIGPWR", "power-Fail/Restart"***REMOVED***,
	***REMOVED***20, "SIGWINCH", "window Size Change"***REMOVED***,
	***REMOVED***21, "SIGURG", "urgent Socket Condition"***REMOVED***,
	***REMOVED***22, "SIGIO", "pollable Event"***REMOVED***,
	***REMOVED***23, "SIGSTOP", "stopped (signal)"***REMOVED***,
	***REMOVED***24, "SIGTSTP", "stopped (user)"***REMOVED***,
	...
	***REMOVED***30, "SIGXCPU", "cpu Limit Exceeded"***REMOVED***,
	***REMOVED***31, "SIGXFSZ", "file Size Limit Exceeded"***REMOVED***,
	***REMOVED***32, "SIGWAITING", "no runnable lwp"***REMOVED***,
	***REMOVED***33, "SIGLWP", "inter-lwp signal"***REMOVED***,
	***REMOVED***34, "SIGFREEZE", "checkpoint Freeze"***REMOVED***,
	***REMOVED***35, "SIGTHAW", "checkpoint Thaw"***REMOVED***,
	***REMOVED***36, "SIGCANCEL", "thread Cancellation"***REMOVED***,
	***REMOVED***37, "SIGLOST", "resource Lost"***REMOVED***,
	***REMOVED***38, "SIGXRES", "resource Control Exceeded"***REMOVED***,
	***REMOVED***39, "SIGJVM1", "reserved for JVM 1"***REMOVED***,
	***REMOVED***40, "SIGJVM2", "reserved for JVM 2"***REMOVED***,
	***REMOVED***41, "SIGINFO", "information Request"***REMOVED***,
***REMOVED***
