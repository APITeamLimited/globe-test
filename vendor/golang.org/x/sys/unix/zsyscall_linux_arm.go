...
func armSyncFileRange(fd int, flags int, off int64, n int64) (err error) ***REMOVED***
...
func kexecFileLoad(kernelFd int, initrdFd int, cmdlineLen int, cmdline string, flags int) (err error) ***REMOVED***
	var _p0 *byte
