...
func IoctlRetInt(fd int, req uint) (int, error) ***REMOVED***
...
type FileDedupeRange struct ***REMOVED***
	Src_offset uint64
	Src_length uint64
	Reserved1  uint16
	Reserved2  uint32
...
type FileDedupeRangeInfo struct ***REMOVED***
	Dest_fd       int64
	Dest_offset   uint64
...
func IoctlFileDedupeRange(srcFd int, value *FileDedupeRange) error ***REMOVED***
