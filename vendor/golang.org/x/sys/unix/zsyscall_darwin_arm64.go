...
func pipe(p *[2]int32) (err error) ***REMOVED***
...
func getxattr(path string, attr string, dest *byte, size int, position uint32, options int) (sz int, err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func fgetxattr(fd int, attr string, dest *byte, size int, position uint32, options int) (sz int, err error) ***REMOVED***
	var _p0 *byte
...
func setxattr(path string, attr string, data *byte, size int, position uint32, options int) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func fsetxattr(fd int, attr string, data *byte, size int, position uint32, options int) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(attr)
	if err != nil ***REMOVED***
		return
...
func removexattr(path string, attr string, options int) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func fremovexattr(fd int, attr string, options int) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(attr)
	if err != nil ***REMOVED***
		return
...
func listxattr(path string, dest *byte, size int, options int) (sz int, err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func flistxattr(fd int, dest *byte, size int, options int) (sz int, err error) ***REMOVED***
...
func fcntl(fd int, cmd int, arg int) (val int, err error) ***REMOVED***
...
func kill(pid int, signum int, posix int) (err error) ***REMOVED***
...
func sendfile(infd int, outfd int, offset int64, len *int64, hdtr unsafe.Pointer, flags int) (err error) ***REMOVED***
...
func Clonefile(src string, dst string, flags int) (err error) ***REMOVED***
	var _p0 *byte
...
func Clonefileat(srcDirfd int, src string, dstDirfd int, dst string, flags int) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(src)
	if err != nil ***REMOVED***
		return
...
func Exchangedata(path1 string, path2 string, options int) (err error) ***REMOVED***
	var _p0 *byte
...
func Fclonefileat(srcDirfd int, dstDirfd int, dst string, flags int) (err error) ***REMOVED***
	var _p0 *byte
...
func Gettimeofday(tp *Timeval) (err error) ***REMOVED***
...
func Mount(fsType string, dir string, flags int, data unsafe.Pointer) (err error) ***REMOVED***
	var _p0 *byte
...
func Openat(dirfd int, path string, mode int, perm uint32) (fd int, err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func Setprivexec(flag int) (err error) ***REMOVED***
...
func Fstatat(fd int, path string, stat *Stat_t, flags int) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func getfsstat(buf unsafe.Pointer, size uintptr, flags int) (n int, err error) ***REMOVED***
...
func ptrace1(request int, pid int, addr uintptr, data uintptr) (err error) ***REMOVED***
