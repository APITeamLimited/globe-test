...
func FcntlInt(fd uintptr, cmd int, arg int) (retval int, err error) ***REMOVED***
	r0, _, e1 := syscall_syscall(SYS_FCNTL, uintptr(fd), uintptr(cmd), uintptr(arg))
	retval = int(r0)
	if e1 != 0 ***REMOVED***
		err = errnoErr(e1)
...
func fstat(fd int, stat *Stat_LE_t) (err error) ***REMOVED***
...
func Fstatvfs(fd int, stat *Statvfs_t) (err error) ***REMOVED***
...
func Getpagesize() (pgsize int) ***REMOVED***
...
func W_Getmntent(buff *byte, size int) (lastsys int, err error) ***REMOVED***
...
func W_Getmntent_A(buff *byte, size int) (lastsys int, err error) ***REMOVED***
...
func mount_LE(path string, filesystem string, fstype string, mtm uint32, parmlen int32, parm string) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func unmount(filesystem string, mtm int) (err error) ***REMOVED***
	var _p0 *byte
...
func Gethostname(buf []byte) (err error) ***REMOVED***
	var _p0 unsafe.Pointer
	if len(buf) > 0 ***REMOVED***
		_p0 = unsafe.Pointer(&buf[0])
	***REMOVED*** else ***REMOVED***
...
func getrusage(who int, rusage *rusage_zos) (err error) ***REMOVED***
...
func lstat(path string, stat *Stat_LE_t) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func Setrlimit(resource int, lim *Rlimit) (err error) ***REMOVED***
...
func stat(path string, statLE *Stat_LE_t) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func Tcgetattr(fildes int, termptr *Termios) (err error) ***REMOVED***
...
func Tcsetattr(fildes int, when int, termptr *Termios) (err error) ***REMOVED***
...
func Utime(path string, utim *Utimbuf) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func remove(path string) (err error) ***REMOVED***
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
...
func waitpid(pid int, wstatus *_C_int, options int) (wpid int, err error) ***REMOVED***
...
func gettimeofday(tv *timeval_zos) (err error) ***REMOVED***
...
func Select(nmsgsfds int, r *FdSet, w *FdSet, e *FdSet, timeout *Timeval) (ret int, err error) ***REMOVED***
