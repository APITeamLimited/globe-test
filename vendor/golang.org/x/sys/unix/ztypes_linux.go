...
type ItimerSpec struct ***REMOVED***
	Interval Timespec
	Value    Timespec
***REMOVED***
...
type FileCloneRange struct ***REMOVED***
	Src_fd      int64
	Src_offset  uint64
	Src_length  uint64
	Dest_offset uint64
...
type RawFileDedupeRange struct ***REMOVED***
	Src_offset uint64
	Src_length uint64
	Dest_count uint16
	Reserved1  uint16
...
type RawFileDedupeRangeInfo struct ***REMOVED***
	Dest_fd       int64
	Dest_offset   uint64
...
type FscryptPolicyV1 struct ***REMOVED***
	Version                   uint8
	Contents_encryption_mode  uint8
	Filenames_encryption_mode uint8
	Flags                     uint8
...
type FscryptPolicyV2 struct ***REMOVED***
	Version                   uint8
	Contents_encryption_mode  uint8
	Filenames_encryption_mode uint8
	Flags                     uint8
...
type FscryptGetPolicyExArg struct ***REMOVED***
	Size   uint64
	Policy [24]byte
***REMOVED***

type FscryptKeySpecifier struct ***REMOVED***
	Type uint32
	_    uint32
	U    [32]byte
***REMOVED***

type FscryptAddKeyArg struct ***REMOVED***
...
type FscryptRemoveKeyArg struct ***REMOVED***
	Key_spec             FscryptKeySpecifier
	Removal_status_flags uint32
	_                    [5]uint32
***REMOVED***

type FscryptGetKeyStatusArg struct ***REMOVED***
	Key_spec     FscryptKeySpecifier
	_            [6]uint32
	Status       uint32
	Status_flags uint32
...
type DmTargetSpec struct ***REMOVED***
	Sector_start uint64
	Length       uint64
	Status       int32
	Next         uint32
...
type DmTargetDeps struct ***REMOVED***
	Count uint32
	_     uint32
***REMOVED***

type DmTargetVersions struct ***REMOVED***
	Next    uint32
	Version [3]uint32
***REMOVED***

type DmTargetMsg struct ***REMOVED***
	Sector uint64
***REMOVED***
...
type RawSockaddrRFCOMM struct ***REMOVED***
	Family  uint16
	Bdaddr  [6]uint8
	Channel uint8
	_       [1]byte
...
type RawSockaddrXDP struct ***REMOVED***
	Family         uint16
	Flags          uint16
	Ifindex        uint32
	Queue_id       uint32
...
type RawSockaddrTIPC struct ***REMOVED***
	Family   uint16
	Addrtype uint8
	Scope    int8
	Addr     [12]byte
...
type RawSockaddrL2TPIP struct ***REMOVED***
	Family  uint16
	Unused  uint16
	Addr    [4]byte /* in_addr */
	Conn_id uint32
...
type RawSockaddrL2TPIP6 struct ***REMOVED***
	Family   uint16
	Unused   uint16
	Flowinfo uint32
	Addr     [16]byte /* in6_addr */
...
type RawSockaddrIUCV struct ***REMOVED***
	Family  uint16
	Port    uint16
	Addr    uint32
	Nodeid  [8]int8
...
type RawSockaddrNFC struct ***REMOVED***
	Sa_family    uint16
	Dev_idx      uint32
	Target_idx   uint32
	Nfc_protocol uint32
...
type CanFilter struct ***REMOVED***
	Id   uint32
	Mask uint32
***REMOVED***

type TCPRepairOpt struct ***REMOVED***
	Code uint32
	Val  uint32
***REMOVED***
...
type NdUseroptmsg struct ***REMOVED***
	Family    uint8
	Pad1      uint8
	Opts_len  uint16
	Ifindex   int32
...
type SignalfdSiginfo struct ***REMOVED***
	Signo     uint32
	Errno     int32
	Code      int32
	Pid       uint32
...
type PerfEventAttr struct ***REMOVED***
	Type               uint32
	Size               uint32
	Config             uint64
	Sample             uint64
...
type PerfEventMmapPage struct ***REMOVED***
	Version        uint32
...
type HDDriveCmdHdr struct ***REMOVED***
	Command uint8
	Number  uint8
	Feature uint8
	Count   uint8
...
type Tpacket2Hdr struct ***REMOVED***
	Status    uint32
	Len       uint32
	Snaplen   uint32
	Mac       uint16
...
type Tpacket3Hdr struct ***REMOVED***
	Next_offset uint32
	Sec         uint32
	Nsec        uint32
	Snaplen     uint32
...
type TpacketHdrVariant1 struct ***REMOVED***
	Rxhash    uint32
	Vlan_tci  uint32
	Vlan_tpid uint16
	_         uint16
...
type TpacketBlockDesc struct ***REMOVED***
	Version uint32
	To_priv uint32
	Hdr     [40]byte
***REMOVED***

type TpacketBDTS struct ***REMOVED***
	Sec  uint32
	Usec uint32
***REMOVED***

type TpacketHdrV1 struct ***REMOVED***
	Block_status        uint32
	Num_pkts            uint32
...
type TpacketReq struct ***REMOVED***
	Block_size uint32
	Block_nr   uint32
	Frame_size uint32
	Frame_nr   uint32
...
type TpacketReq3 struct ***REMOVED***
	Block_size       uint32
	Block_nr         uint32
	Frame_size       uint32
	Frame_nr         uint32
...
type TpacketStats struct ***REMOVED***
	Packets uint32
	Drops   uint32
***REMOVED***

type TpacketStatsV3 struct ***REMOVED***
	Packets      uint32
	Drops        uint32
	Freeze_q_cnt uint32
***REMOVED***

type TpacketAuxdata struct ***REMOVED***
	Status    uint32
	Len       uint32
	Snaplen   uint32
	Mac       uint16
...
type RTCWkAlrm struct ***REMOVED***
	Enabled uint8
	Pending uint8
	Time    RTCTime
***REMOVED***

type BlkpgIoctlArg struct ***REMOVED***
	Op      int32
	Flags   int32
	Datalen int32
	Data    *byte
...
type XDPRingOffset struct ***REMOVED***
	Producer uint64
	Consumer uint64
	Desc     uint64
	Flags    uint64
...
type XDPMmapOffsets struct ***REMOVED***
	Rx XDPRingOffset
	Tx XDPRingOffset
	Fr XDPRingOffset
	Cr XDPRingOffset
...
type XDPStatistics struct ***REMOVED***
	Rx_dropped               uint64
...
type ScmTimestamping struct ***REMOVED***
	Ts [3]Timespec
***REMOVED***
...
type FanotifyEventMetadata struct ***REMOVED***
	Event_len    uint32
	Vers         uint8
	Reserved     uint8
	Metadata_len uint16
...
type FanotifyResponse struct ***REMOVED***
	Fd       int32
	Response uint32
***REMOVED***
...
type CapUserHeader struct ***REMOVED***
	Version uint32
	Pid     int32
***REMOVED***

type CapUserData struct ***REMOVED***
	Effective   uint32
	Permitted   uint32
	Inheritable uint32
***REMOVED***
...
type TIPCSocketAddr struct ***REMOVED***
	Ref  uint32
	Node uint32
***REMOVED***

type TIPCServiceRange struct ***REMOVED***
	Type  uint32
	Lower uint32
	Upper uint32
***REMOVED***

type TIPCServiceName struct ***REMOVED***
	Type     uint32
	Instance uint32
	Domain   uint32
***REMOVED***

type TIPCEvent struct ***REMOVED***
	Event uint32
	Lower uint32
	Upper uint32
	Port  TIPCSocketAddr
...
type TIPCGroupReq struct ***REMOVED***
	Type     uint32
	Instance uint32
	Scope    uint32
	Flags    uint32
...
type FsverityDigest struct ***REMOVED***
	Algorithm uint16
	Size      uint16
***REMOVED***

type FsverityEnableArg struct ***REMOVED***
	Version        uint32
...
type NexthopGrp struct ***REMOVED***
	Id     uint32
	Weight uint8
	Resvd1 uint8
	Resvd2 uint16
...
type WatchdogInfo struct ***REMOVED***
	Options  uint32
	Version  uint32
	Identity [32]uint8
***REMOVED***

type PPSFData struct ***REMOVED***
	Info    PPSKInfo
	Timeout PPSKTime
***REMOVED***

type PPSKParams struct ***REMOVED***
	Api_version   int32
	Mode          int32
...
type EthtoolDrvinfo struct ***REMOVED***
	Cmd          uint32
	Driver       [32]byte
	Version      [32]byte
	Fw_version   [32]byte
...
type (
	HIDRawReportDescriptor struct ***REMOVED***
		Size  uint32
		Value [4096]uint8
	***REMOVED***
	HIDRawDevInfo struct ***REMOVED***
		Bustype uint32
		Vendor  int16
		Product int16
	***REMOVED***
...
type (
	EraseInfo struct ***REMOVED***
		Start  uint32
		Length uint32
	***REMOVED***
	EraseInfo64 struct ***REMOVED***
		Start  uint64
		Length uint64
	***REMOVED***
	MtdOobBuf struct ***REMOVED***
		Start  uint32
		Length uint32
		Ptr    *uint8
	***REMOVED***
	MtdOobBuf64 struct ***REMOVED***
		Start  uint64
		Pad    uint32
		Length uint32
		Ptr    uint64
	***REMOVED***
	MtdWriteReq struct ***REMOVED***
		Start  uint64
		Len    uint64
		Ooblen uint64
		Data   uint64
	...
	***REMOVED***
	MtdInfo struct ***REMOVED***
		...
		_         uint64
	***REMOVED***
	RegionInfo struct ***REMOVED***
		Offset      uint32
		Erasesize   uint32
		Numblocks   uint32
		Regionindex uint32
	***REMOVED***
	OtpInfo struct ***REMOVED***
		Start  uint32
		Length uint32
		Locked uint32
	***REMOVED***
	NandOobinfo struct ***REMOVED***
		Useecc   uint32
		Eccbytes uint32
		Oobfree  [8][2]uint32
		Eccpos   [32]uint32
	***REMOVED***
	NandOobfree struct ***REMOVED***
		Offset uint32
		Length uint32
	***REMOVED***
	NandEcclayout struct ***REMOVED***
		Eccbytes uint32
		Eccpos   [64]uint32
		Oobavail uint32
		Oobfree  [8]NandOobfree
	***REMOVED***
	MtdEccStats struct ***REMOVED***
		Corrected uint32
		Failed    uint32
		Badblocks uint32
		Bbtblocks uint32
...
type LandlockRulesetAttr struct ***REMOVED***
	Access_fs uint64
***REMOVED***

type LandlockPathBeneathAttr struct ***REMOVED***
...
type CANBitTiming struct ***REMOVED***
	Bitrate      uint32
	Sample_point uint32
	Tq           uint32
	Prop_seg     uint32
...
type CANBitTimingConst struct ***REMOVED***
	Name      [16]uint8
	Tseg1_min uint32
	Tseg1_max uint32
	Tseg2_min uint32
...
type CANClock struct ***REMOVED***
	Freq uint32
***REMOVED***

type CANBusErrorCounters struct ***REMOVED***
	Txerr uint16
	Rxerr uint16
***REMOVED***

type CANCtrlMode struct ***REMOVED***
	Mask  uint32
	Flags uint32
***REMOVED***

type CANDeviceStats struct ***REMOVED***
	Bus_error        uint32
...
type KCMAttach struct ***REMOVED***
	Fd     int32
	Bpf_fd int32
***REMOVED***

type KCMUnattach struct ***REMOVED***
	Fd int32
***REMOVED***

type KCMClone struct ***REMOVED***
	Fd int32
***REMOVED***
