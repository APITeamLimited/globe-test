...
func SysctlUvmexp(name string) (*Uvmexp, error) ***REMOVED***
	...
	***REMOVED***
	...
	var u Uvmexp
	if err := sysctl(mib, (*byte)(unsafe.Pointer(&u)), &n, nil, 0); err != nil ***REMOVED***
		return nil, err
	***REMOVED***
	if n != SizeofUvmexp ***REMOVED***
		return nil, EIO
	***REMOVED***
	return &u, nil
***REMOVED***
...
func Getdirentries(fd int, buf []byte, basep *uintptr) (n int, err error) ***REMOVED***
	...
	***REMOVED***
	*basep = uintptr(off)
	if unsafe.Sizeof(*basep) == 8 ***REMOVED***
		return
	***REMOVED***
	if off>>32 != 0 ***REMOVED***
