...
Mksysnum is a Go program located at `$***REMOVED***GOOS***REMOVED***/mksysnum.go` (or `mksysnum_$***REMOVED***GOOS***REMOVED***.go`
...
### `zerrors_$***REMOVED***GOOS***REMOVED***_$***REMOVED***GOARCH***REMOVED***.go`
