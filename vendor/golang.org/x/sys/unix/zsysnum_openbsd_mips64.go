...
const (
	...
	SYS_MSYSCALL       = 37  // ***REMOVED*** int sys_msyscall(void *addr, size_t len); ***REMOVED***
	...
	SYS___REALPATH     = 115 // ***REMOVED*** int sys___realpath(const char *pathname, char *resolved); ***REMOVED***
	...
	SYS___TMPFD        = 164 // ***REMOVED*** int sys___tmpfd(int flags); ***REMOVED***
