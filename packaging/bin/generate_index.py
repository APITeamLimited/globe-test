...
def process_dir(top_dir, opts):
    ...
    if opts.verbose:
        print(f'Traversing dir ***REMOVED***path_top_dir.absolute()***REMOVED***')
...
<head>
    ...
    <style>
    * ***REMOVED*** padding: 0; margin: 0; ***REMOVED***
    ...
    ***REMOVED***
    ...
    th:first-child,
    td:first-child ***REMOVED***
        width: 5%;
    ***REMOVED***

    th:last-child,
    td:last-child ***REMOVED***
        width: 5%;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    td:nth-child(2) ***REMOVED***
        width: 80%;
    ***REMOVED***

    td:nth-child(3) ***REMOVED***
        padding: 0 20px 0 20px;
    ***REMOVED***

    th:nth-child(4),
    td:nth-child(4) ***REMOVED***
        text-align: right;
    ***REMOVED***

    td:nth-child(2) svg ***REMOVED***
        position: absolute;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    tr.clickable ***REMOVED***
        cursor: pointer;
    ***REMOVED***
    tr.clickable a ***REMOVED***
        display: block;
    ***REMOVED***
...
""")
    ...
    for entry in sorted_entries:
        ...
        if (not entry.is_symlink()) and not os.access(str(entry), os.W_OK):
            print(f"*** WARNING *** entry ***REMOVED***entry.absolute()***REMOVED*** is not writable! SKIPPING!")
            continue
        if opts.verbose:
            print(f'***REMOVED***entry.absolute()***REMOVED***')
        ...
        <tr class="file">
            <td></td>
            <td>
                <a href="***REMOVED***entry_path***REMOVED***">
                    <svg width="1.5em" height="1em" version="1.1" viewBox="0 0 265 323"><use xlink:href="#***REMOVED***entry_type***REMOVED***"></use></svg>
                    <span class="name">***REMOVED***entry.name***REMOVED***</span>
                </a>
            </td>
            <td data-order="***REMOVED***size_bytes***REMOVED***">***REMOVED***size_pretty***REMOVED***</td>
            <td class="hideable"><time datetime="***REMOVED***last_modified_iso***REMOVED***">***REMOVED***last_modified_human_readable***REMOVED***</time></td>
            <td class="hideable"></td>
        </tr>
""")
