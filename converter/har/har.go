...
func (e byRequestDate) Len() int ***REMOVED*** return len(e) ***REMOVED***

// Swap swaps entries by position.
func (e byRequestDate) Swap(i, j int) ***REMOVED*** e[i], e[j] = e[j], e[i] ***REMOVED***

// Less returns whether the entry at i has a StartedDateTime before the entry at j.
func (e byRequestDate) Less(i, j int) bool ***REMOVED***
        return e[i].StartedDateTime.Before(e[j].StartedDateTime)
***REMOVED***

func Read(filePath string) (*HAR, error) ***REMOVED***
