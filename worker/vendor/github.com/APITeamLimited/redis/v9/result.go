...
func NewMapStringStringResult(val map[string]string, err error) *MapStringStringCmd ***REMOVED***
...
func NewMapStringIntCmdResult(val map[string]int64, err error) *MapStringIntCmd ***REMOVED***
