 ...
 */
type blockSplitterLiteral struct ***REMOVED***
	alphabet_size_     uint
...
func initBlockSplitterLiteral(self *blockSplitterLiteral, alphabet_size uint, min_block_size uint, split_threshold float64, num_symbols uint, split *blockSplit, histograms *[]histogramLiteral, histograms_size *uint) ***REMOVED***
...
func blockSplitterFinishBlockLiteral(self *blockSplitterLiteral, is_final bool) ***REMOVED***
...
func blockSplitterAddSymbolLiteral(self *blockSplitterLiteral, symbol uint) ***REMOVED***
