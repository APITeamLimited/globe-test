...
// it returns ok==false.
func (mi *MessageInfo) getPointer(m protoreflect.Message) (p pointer, ok bool) ***REMOVED***
...
func (mi *MessageInfo) makeStructInfo(t reflect.Type) structInfo ***REMOVED***
	si := structInfo***REMOVED***
		...
		fieldsByNumber:        map[protoreflect.FieldNumber]reflect.StructField***REMOVED******REMOVED***,
		oneofsByName:          map[protoreflect.Name]reflect.StructField***REMOVED******REMOVED***,
		oneofWrappersByType:   map[reflect.Type]protoreflect.FieldNumber***REMOVED******REMOVED***,
		oneofWrappersByNumber: map[protoreflect.FieldNumber]reflect.Type***REMOVED******REMOVED***,
	***REMOVED***
...
func (mi *MessageInfo) New() protoreflect.Message ***REMOVED***
	...
	if r, ok := m.(protoreflect.ProtoMessage); ok ***REMOVED***
