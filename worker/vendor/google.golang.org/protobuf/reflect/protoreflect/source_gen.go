...
func (p *SourcePath) appendFileDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendEnumDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendServiceDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendFieldDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendFileOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendSourceCodeInfo(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendDescriptorProto_ExtensionRange(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendOneofDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendMessageOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendDescriptorProto_ReservedRange(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendEnumValueDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendEnumOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendEnumDescriptorProto_EnumReservedRange(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendMethodDescriptorProto(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendServiceOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendFieldOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendUninterpretedOption(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendSourceCodeInfo_Location(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendExtensionRangeOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendOneofOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendEnumValueOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendMethodOptions(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
...
func (p *SourcePath) appendUninterpretedOption_NamePart(b []byte) []byte ***REMOVED***
	if len(*p) == 0 ***REMOVED***
		return b
	***REMOVED***
	switch (*p)[0] ***REMOVED***
