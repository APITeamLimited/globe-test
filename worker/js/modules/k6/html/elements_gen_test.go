...
func TestGenElementsTestTextProperties(t *testing.T) ***REMOVED***
	t.Parallel()
	rt := getTestRuntimeWithDoc(t, testGenElems)

	textTests := []struct ***REMOVED***
		id       string
		property string
		data     string
	***REMOVED******REMOVED***
...
func TestGenElementsBoolProperties(t *testing.T) ***REMOVED***
	t.Parallel()
	rt := getTestRuntimeWithDoc(t, testGenElems)

	boolTests := []struct ***REMOVED***
		idTrue   string
		idFalse  string
		property string
	***REMOVED******REMOVED***
	...
	***REMOVED***
	...
	for _, test := range boolTests ***REMOVED***
		...
		***REMOVED*** else if vT.Export() != true ***REMOVED***
		...
		***REMOVED*** else if vF.Export() != false ***REMOVED***
			t.Errorf("Expected false for property name '%s' on element id '#%s'", test.property, test.idFalse)
		***REMOVED***
	***REMOVED***
***REMOVED***

func TestGenElementsIntProperties(t *testing.T) ***REMOVED***
	t.Parallel()
	rt := getTestRuntimeWithDoc(t, testGenElems)

	intTests := []struct ***REMOVED***
		id       string
		property string
		data     int
	***REMOVED******REMOVED***
...
func TestGenElementsNullProperties(t *testing.T) ***REMOVED***
	t.Parallel()
	rt := getTestRuntimeWithDoc(t, testGenElems)
	nullTests := []struct ***REMOVED***
		id       string
		property string
	***REMOVED******REMOVED***
...
func TestGenElementsURLProperties(t *testing.T) ***REMOVED***
	t.Parallel()
