...
func assertRequestMetricsEmitted(t *testing.T, sampleContainers []workerMetrics.SampleContainer, method, url, name string, status int, group string) ***REMOVED***
	if name == "" ***REMOVED***
		name = url
	***REMOVED***
	...
	for _, sampleContainer := range sampleContainers ***REMOVED***
		for _, sample := range sampleContainer.GetSamples() ***REMOVED***
			...
			if tags["url"] == url ***REMOVED***
				...
				case workerMetrics.HTTPReqDurationName:
					seenDuration = true
				case workerMetrics.HTTPReqBlockedName:
					seenBlocked = true
				case workerMetrics.HTTPReqConnectingName:
					seenConnecting = true
				case workerMetrics.HTTPReqTLSHandshakingName:
					seenTLSHandshaking = true
				case workerMetrics.HTTPReqSendingName:
					seenSending = true
				case workerMetrics.HTTPReqWaitingName:
					seenWaiting = true
				case workerMetrics.HTTPReqReceivingName:
					seenReceiving = true
				***REMOVED***
...
func assertRequestMetricsEmittedSingle(t *testing.T, sampleContainer workerMetrics.SampleContainer, expectedTags map[string]string, metrics []string, callback func(sample workerMetrics.Sample)) ***REMOVED***
	t.Helper()
...
func newRuntime(t testing.TB) (
	*httpmultibin.HTTPMultiBin, *libWorker.State, chan workerMetrics.SampleContainer, *goja.Runtime, *ModuleInstance,
) ***REMOVED***
...
func TestRequestAndBatch(t *testing.T) ***REMOVED***
	...
	***REMOVED***)
	t.Run("HTTP/2", func(t *testing.T) ***REMOVED***
		workerMetrics.GetBufferedSamples(samples) // Clean up buffered samples from previous tests
		_, err := rt.RunString(sr(`
	...
	t.Run("Params", func(t *testing.T) ***REMOVED***
		for _, literal := range []string***REMOVED***`undefined`, `null`***REMOVED*** ***REMOVED***
			t.Run(literal, func(t *testing.T) ***REMOVED***
				...
				`), literal))
				assert.NoError(t, err)
				assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", sr("HTTPBIN_URL/headers"), "", 200, "")
			***REMOVED***)
		***REMOVED***
		...
		t.Run("cookies", func(t *testing.T) ***REMOVED***
			t.Run("access", func(t *testing.T) ***REMOVED***
				...
				***REMOVED***
				`))
				assert.NoError(t, err)
				assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", sr("HTTPBIN_URL/cookies/set?key=value"), "", 302, "")
			***REMOVED***)
			...
			t.Run("vuJar", func(t *testing.T) ***REMOVED***
				...
				`))
				assert.NoError(t, err)
				assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", sr("HTTPBIN_URL/cookies"), "", 200, "")
			***REMOVED***)
				...
				t.Run("set cookie after redirect", func(t *testing.T) ***REMOVED***
					...
					***REMOVED***))
					...
					assertRequestMetricsEmitted(
						t,
						workerMetrics.GetBufferedSamples(samples),
						"GET",
			...
			***REMOVED***)
			...
			t.Run("secure", func(t *testing.T) ***REMOVED***
				...
				***REMOVED***
				`))
				assert.NoError(t, err)
				assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", sr("HTTPSBIN_IP_URL/cookies"), "", 200, "")
			***REMOVED***)
		...
		***REMOVED***)
		...
		t.Run("auth", func(t *testing.T) ***REMOVED***
			t.Run("basic", func(t *testing.T) ***REMOVED***
				...
				`, url))
				assert.NoError(t, err)
				assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", urlExpected, urlExpected, 200, "")
			***REMOVED***)
			t.Run("digest", func(t *testing.T) ***REMOVED***
				t.Run("success", func(t *testing.T) ***REMOVED***
					...
					sampleContainers := workerMetrics.GetBufferedSamples(samples)
		...
		t.Run("tags", func(t *testing.T) ***REMOVED***
			...
			***REMOVED***
			...
			t.Run("name/none", func(t *testing.T) ***REMOVED***
				...
				`))
				assert.NoError(t, err)
				assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET",
	...
	***REMOVED***)
	...
	t.Run("GET", func(t *testing.T) ***REMOVED***
		...
		t.Run("Tagged", func(t *testing.T) ***REMOVED***
			...
			`)
			assert.NoError(t, err)
			assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", sr("HTTPBIN_URL/get?a=1&b=2"), sr("HTTPBIN_URL/get?a=$***REMOVED******REMOVED***&b=$***REMOVED******REMOVED***"), 200, "")
		***REMOVED***)
	***REMOVED***)
	t.Run("HEAD", func(t *testing.T) ***REMOVED***
		...
		`))
		assert.NoError(t, err)
		assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "HEAD", sr("HTTPBIN_URL/get?a=1&b=2"), "", 200, "")
	***REMOVED***)
	...
	t.Run("OPTIONS", func(t *testing.T) ***REMOVED***
		...
		`))
		require.NoError(t, err)
		assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "OPTIONS", sr("HTTPBIN_URL/?a=1&b=2"), "", 200, "")
	***REMOVED***)
	...
	t.Run("DELETE", func(t *testing.T) ***REMOVED***
		...
		`))
		require.NoError(t, err)
		assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "DELETE", sr("HTTPBIN_URL/delete?test=mest"), "", 200, "")
	***REMOVED***)
	...
	***REMOVED***
	for method, fn := range postMethods ***REMOVED***
		t.Run(method, func(t *testing.T) ***REMOVED***
			...
			require.NoError(t, err)
			assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), method, sr("HTTPBIN_URL/")+strings.ToLower(method), "", 200, "")
	...
	t.Run("Batch", func(t *testing.T) ***REMOVED***
		...
		***REMOVED***)
		t.Run("PUT", func(t *testing.T) ***REMOVED***
			...
			***REMOVED***`))
			assert.NoError(t, err)
			assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "PUT", sr("HTTPBIN_URL/put"), "", 200, "")
		***REMOVED***)
	***REMOVED***)
...
func checkErrorCode(t testing.TB, tags *workerMetrics.SampleTags, code int, msg string) ***REMOVED***
	...
	***REMOVED***
	...
	for _, testCase := range testCases ***REMOVED***
		...
		t.Run(testCase.name, func(t *testing.T) ***REMOVED***
			...
			***REMOVED***
			cs := workerMetrics.GetBufferedSamples(samples)
...
func TestRedirectMetricTags(t *testing.T) ***REMOVED***
	...
	***REMOVED***))
	...
	checkTags := func(sc workerMetrics.SampleContainer, expTags map[string]string) ***REMOVED***
	...
	for _, versionTest := range tlsVersionTests ***REMOVED***
		...
		t.Run(versionTest.Name, func(t *testing.T) ***REMOVED***
			...
			***REMOVED******REMOVED***
			...
			assert.NoError(t, err)
			assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", realURL, "", 200, "")
		***REMOVED***)
	***REMOVED***
	...
	t.Run("ocsp_stapled_good", func(t *testing.T) ***REMOVED***
		...
		***REMOVED***
		...
		_, err := rt.RunString(fmt.Sprintf(`
			...
			`, website))
		assert.NoError(t, err)
		assertRequestMetricsEmitted(t, workerMetrics.GetBufferedSamples(samples), "GET", website, "", 200, "")
	***REMOVED***)
***REMOVED***
