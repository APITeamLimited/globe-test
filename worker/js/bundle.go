...
func (b *Bundle) Instantiate(logger logrus.FieldLogger, vuID uint64, workerInfo *libWorker.WorkerInfo) (*BundleInstance, error) ***REMOVED***
...
func (b *Bundle) instantiate(logger logrus.FieldLogger, rt *goja.Runtime, init *InitContext, vuID uint64, workerInfo *libWorker.WorkerInfo) (err error) ***REMOVED***
	...
	***REMOVED***
	...
	if init.compatibilityMode == libWorker.CompatibilityModeExtended ***REMOVED***
