...
var configMapTestCases = []configMapTestCase***REMOVED***
	...
	***REMOVED***
		...
		exp***REMOVED***custom: func(t *testing.T, cm libWorker.ScenarioConfigs) ***REMOVED***
			...
			endOffset, isFinal := libWorker.GetEndOffset(schedReqs)
			...
			endOffset, isFinal = libWorker.GetEndOffset(totalReqs)
	...
	***REMOVED***
		...
		exp***REMOVED***custom: func(t *testing.T, cm libWorker.ScenarioConfigs) ***REMOVED***
			...
			assert.Equal(t, true, isFinal)
			assert.Equal(t, uint64(12), libWorker.GetMaxPlannedVUs(schedReqs))
			assert.Equal(t, uint64(12), libWorker.GetMaxPossibleVUs(schedReqs))
			...
			assert.Equal(t, 130*time.Second, endOffset)
			assert.Equal(t, true, isFinal)
			assert.Equal(t, uint64(4), libWorker.GetMaxPlannedVUs(schedReqs))
			assert.Equal(t, uint64(4), libWorker.GetMaxPossibleVUs(schedReqs))
			...
			assert.Equal(t, true, isFinal)
			assert.Equal(t, uint64(0), libWorker.GetMaxPlannedVUs(schedReqs))
			assert.Equal(t, uint64(0), libWorker.GetMaxPossibleVUs(schedReqs))
	...
	***REMOVED***
		...
		exp***REMOVED***custom: func(t *testing.T, cm libWorker.ScenarioConfigs) ***REMOVED***
			...
			assert.Equal(t, true, isFinal)
			assert.Equal(t, uint64(13), libWorker.GetMaxPlannedVUs(schedReqs))
			assert.Equal(t, uint64(13), libWorker.GetMaxPossibleVUs(schedReqs))
	...
	***REMOVED***
		...
		exp***REMOVED***custom: func(t *testing.T, cm libWorker.ScenarioConfigs) ***REMOVED***
			...
			assert.Equal(t, true, isFinal)
			assert.Equal(t, uint64(20), libWorker.GetMaxPlannedVUs(schedReqs))
			assert.Equal(t, uint64(30), libWorker.GetMaxPossibleVUs(schedReqs))
	...
	***REMOVED***
		...
		exp***REMOVED***custom: func(t *testing.T, cm libWorker.ScenarioConfigs) ***REMOVED***
			...
			***REMOVED***
			...
			assert.Equal(t, true, isFinal)
			assert.Equal(t, uint64(20), libWorker.GetMaxPlannedVUs(schedReqs))
			assert.Equal(t, uint64(50), libWorker.GetMaxPossibleVUs(schedReqs))
