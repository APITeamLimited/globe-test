...
func TestCryptoAlgorithms(t *testing.T) ***REMOVED***
	...
	***REMOVED***)
	...
	t.Run("MD4", func(t *testing.T) ***REMOVED***
		...
		if (hash !== correct) ***REMOVED***
			throw new Error("Hash mismatch: " + hash);
		***REMOVED***`)
		assert.NoError(t, err)
	***REMOVED***)

	t.Run("MD5", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("SHA1", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("SHA256", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("SHA384", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("SHA512", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("SHA512_224", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("SHA512_256", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("RIPEMD160", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
...
func TestStreamingApi(t *testing.T) ***REMOVED***
	if testing.Short() ***REMOVED***
		return
	***REMOVED***
	...
	***REMOVED***)
	...
	t.Run("UpdateOnce", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
	...
	***REMOVED***)
	...
	t.Run("UpdateMultiple", func(t *testing.T) ***REMOVED***
		_, err := common.RunString(rt, `
		const correctHex = "5eb63bbbe01eeed093cb22bb8f5acdc3";
...
func TestOutputEncoding(t *testing.T) ***REMOVED***
	if testing.Short() ***REMOVED***
		return
	***REMOVED***
	...
	t.Run("Valid", func(t *testing.T) ***REMOVED***
		...
		***REMOVED***
		...
		function arraysEqual(a, b) ***REMOVED***
		  if (a === b) return true;
...
func TestHMac(t *testing.T) ***REMOVED***
	...
	***REMOVED***
	for algorithm, value := range testData ***REMOVED***
		rt.Set("correctHex", rt.ToValue(value))
		rt.Set("algorithm", rt.ToValue(algorithm))
		t.Run(algorithm+" hasher: valid", func(t *testing.T) ***REMOVED***
			_, err := common.RunString(rt, `
		...
		***REMOVED***)
		...
		t.Run(algorithm+" wrapper: valid", func(t *testing.T) ***REMOVED***
			_, err := common.RunString(rt, `
	...
	***REMOVED***
	...
	invalidData := map[string]string***REMOVED***
...
func TestAWSv4(t *testing.T) ***REMOVED***
	...
	_, err := common.RunString(rt, `
		...
		let HmacSHA256 = function(data, key) ***REMOVED***
