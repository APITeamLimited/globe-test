...
func New() *GlobalHTTP ***REMOVED***
	return &GlobalHTTP***REMOVED******REMOVED***
***REMOVED***

// GlobalHTTP is a global HTTP module for a k6 instance/test run
type GlobalHTTP struct***REMOVED******REMOVED***

// NewModuleInstancePerVU returns an HTTP instance for each VU
func (g *GlobalHTTP) NewModuleInstancePerVU() interface***REMOVED******REMOVED*** ***REMOVED*** // this here needs to return interface***REMOVED******REMOVED***
	return &HTTP***REMOVED*** // change the below fields to be not writable or not fields
