...
func (*HTTP) ExpectedStatuses(ctx context.Context, args ...goja.Value) *expectedStatuses ***REMOVED*** //nolint: golint
...
func (h *HTTP) SetResponseCallback(ctx context.Context, val goja.Value) ***REMOVED***
