...
func getPartialConfig(flags *pflag.FlagSet) (Config, error) ***REMOVED***
	opts, err := getOptions(flags)
	if err != nil ***REMOVED***
		return Config***REMOVED******REMOVED***, err
	***REMOVED***

	return Config***REMOVED***Options: opts***REMOVED***, nil
***REMOVED***
...
func readDiskConfig(globalState *globalState) (Config, error) ***REMOVED***
	...
	***REMOVED***
	...
	if err != nil ***REMOVED***
		return Config***REMOVED******REMOVED***, fmt.Errorf("couldn't load the configuration from %q: %w", globalState.flags.configFilePath, err)
	***REMOVED***
	var conf Config
	err = json.Unmarshal(data, &conf)
	if err != nil ***REMOVED***
		return Config***REMOVED******REMOVED***, fmt.Errorf("couldn't parse the configuration from %q: %w", globalState.flags.configFilePath, err)
	***REMOVED***
	return conf, nil
***REMOVED***
...
func getConsolidatedConfig(globalState *globalState, cliConf Config, runnerOpts lib.Options) (conf Config, err error) ***REMOVED***
	...
	***REMOVED***
	...
	if _, err = metrics.GetResolversForTrendColumns(conf.SummaryTrendStats); err != nil ***REMOVED***
		return conf, err
	***REMOVED***
