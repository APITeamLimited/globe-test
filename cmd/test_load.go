...
func (lt *loadedTest) initializeFirstRunner(gs *globalState) error ***REMOVED***
	...
	***REMOVED***
	...
	case testTypeJS:
		...
		runner, err := js.New(lt.preInitState, lt.source, lt.fileSystems, redis.NewClient(&redis.Options***REMOVED***
			Addr:     "localhost:6379",
	...
	case testTypeArchive:
		...
		***REMOVED***
		...
		case testTypeJS:
			...
			lt.initRunner, err = js.NewFromArchive(lt.preInitState, arc, redis.NewClient(&redis.Options***REMOVED***
				Addr:     "localhost:6379",
				Password: "", // no password set
				DB:       0,  // use default DB
			***REMOVED***))
