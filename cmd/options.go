...
func getOptions(flags *pflag.FlagSet) (lib.Options, error) ***REMOVED***
	opts := lib.Options***REMOVED***
		...
		SetupTimeout:    types.NullDuration***REMOVED***Duration: types.Duration(60 * time.Second), Valid: false***REMOVED***,
		TeardownTimeout: types.NullDuration***REMOVED***Duration: types.Duration(60 * time.Second), Valid: false***REMOVED***,
	...
	***REMOVED***
	...
	if flags.Changed("execution-segment") ***REMOVED***
	...
	***REMOVED***
	...
	if flags.Changed("execution-segment-sequence") ***REMOVED***
	...
	***REMOVED***
	...
	if err != nil ***REMOVED***
		return opts, err
	***REMOVED***
	if flags.Changed("block-hostnames") ***REMOVED***
	...
	***REMOVED***
	...
	if err != nil ***REMOVED***
		return opts, err
	***REMOVED***
	if flags.Changed("local-ips") ***REMOVED***
	...
	***REMOVED***
	...
	if flags.Changed("summary-trend-stats") ***REMOVED***
		...
		if errSts != nil ***REMOVED***
			return opts, errSts
		***REMOVED***
		if _, errSts = metrics.GetResolversForTrendColumns(trendStats); err != nil ***REMOVED***
			return opts, errSts
		***REMOVED***
	...
	***REMOVED***
	...
	if dns, err := flags.GetString("dns"); err != nil ***REMOVED***
		return opts, err
	***REMOVED*** else if dns != "" ***REMOVED***
		if err := opts.DNS.UnmarshalText([]byte(dns)); err != nil ***REMOVED***
			return opts, err
		***REMOVED***
	***REMOVED***
