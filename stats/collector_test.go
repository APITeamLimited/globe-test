...
func TestAdd(t *testing.T) ***REMOVED***
	...
	c.Add(Sample***REMOVED***Stat: &stat, Values: Values***REMOVED***"value": 12345***REMOVED******REMOVED***)
...
func TestAddNoStat(t *testing.T) ***REMOVED***
	c := Collector***REMOVED******REMOVED***
	c.Add(Sample***REMOVED***Values: Values***REMOVED***"value": 12345***REMOVED******REMOVED***)
	assert.Equal(t, 0, len(c.Batch))
***REMOVED***

func TestAddNoValues(t *testing.T) ***REMOVED***
	c := Collector***REMOVED******REMOVED***
	c.Add(Sample***REMOVED***Stat: &Stat***REMOVED***Name: "test"***REMOVED******REMOVED***)
	assert.Equal(t, 0, len(c.Batch))
***REMOVED***

func TestAddFixesTime(t *testing.T) ***REMOVED***
	c := Collector***REMOVED******REMOVED***
	c.Add(Sample***REMOVED***Stat: &Stat***REMOVED***Name: "test"***REMOVED***, Values: Values***REMOVED***"value": 12345***REMOVED******REMOVED***)
