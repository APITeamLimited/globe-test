...
func generateTestMetricSamples(t testing.TB) ([]metrics.SampleContainer, func(io.Reader)) ***REMOVED***
	...
	***REMOVED***
	expected := []string***REMOVED***
		`***REMOVED***"type":"Metric","data":***REMOVED***"name":"my_metric1","type":"gauge","contains":"default","thresholds":["rate<0.01","p(99)<250"],"submetrics":[***REMOVED***"name":"my_metric1***REMOVED***a:1,b:2***REMOVED***","suffix":"a:1,b:2","tags":***REMOVED***"a":"1","b":"2"***REMOVED******REMOVED***]***REMOVED***,"metric":"my_metric1"***REMOVED***`,
		...
		`***REMOVED***"type":"Metric","data":***REMOVED***"name":"my_metric2","type":"counter","contains":"data","thresholds":[],"submetrics":null***REMOVED***,"metric":"my_metric2"***REMOVED***`,
