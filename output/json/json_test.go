...
func getValidator(t *testing.T, expected []string) func(io.Reader) ***REMOVED***
...
func generateTestMetricSamples(t *testing.T) ([]stats.SampleContainer, func(io.Reader)) ***REMOVED***
