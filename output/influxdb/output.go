...
func (o *Output) batchFromSamples(containers []metrics.SampleContainer) (client.BatchPoints, error) ***REMOVED***
	...
	***REMOVED***
	cache := map[*metrics.SampleTags]cacheItem***REMOVED******REMOVED***
	...
	go func() ***REMOVED***
		...
		***REMOVED***
		...
		if err := o.Client.Write(batch); err != nil ***REMOVED***
			...
			if strings.Contains(err.Error(), "unauthorized access") ***REMOVED***
		...
		***REMOVED***
		...
		if t > o.Config.PushInterval.TimeDuration() ***REMOVED***
