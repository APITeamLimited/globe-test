...
type Config struct ***REMOVED***
	...
	//       by the AggregationOutlier***REMOVED***Radius,CoefLower,CoefUpper***REMOVED*** options)
...
func (c Config) Apply(cfg Config) Config ***REMOVED***
	...
	***REMOVED***
	if cfg.AggregationSkipOutlierDetection.Valid ***REMOVED***
		c.AggregationSkipOutlierDetection = cfg.AggregationSkipOutlierDetection
	***REMOVED***
	if cfg.AggregationOutlierAlgoThreshold.Valid ***REMOVED***
