...
func startJobScheduling(ctx context.Context, orchestratorClient *redis.Client, orchestratorId string, executionList *ExecutionList,
	workerClients libOrch.WorkerClients, storeMongoDB *mongo.Database, creditsClient *redis.Client) ***REMOVED***
	...
	go func() ***REMOVED***
		for range scheduler.C ***REMOVED***
			...
			checkForQueuedJobs(ctx, orchestratorClient, workerClients, orchestratorId, executionList, storeMongoDB, creditsClient)
		***REMOVED***
	***REMOVED***()
