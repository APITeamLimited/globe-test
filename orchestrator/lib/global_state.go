	...
	***REMOVED***
	...
	if parsed["level"] == "error" ***REMOVED***
		if parsed["error"] != nil ***REMOVED***
			go lib.HandleStringError(w.ctx, w.client, w.jobId, w.orchestratorId, parsed["error"].(string))
		***REMOVED*** else ***REMOVED***
			go lib.HandleStringError(w.ctx, w.client, w.jobId, w.orchestratorId, parsed["msg"].(string))
		***REMOVED***
		return
	***REMOVED***

	go lib.DispatchMessage(w.ctx, w.client, w.jobId, w.orchestratorId, string(p), "STDOUT")
