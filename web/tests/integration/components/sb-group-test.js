...
moduleForComponent('sb-group', 'Integration | Component | sb group', ***REMOVED***
  integration: true
***REMOVED***);
...
test('it renders', function(assert) ***REMOVED***
  ...
  this.render(hbs`***REMOVED******REMOVED***sb-group***REMOVED******REMOVED***`);

  assert.equal(this.$().text().trim(), '');

  // Template block usage:
  this.render(hbs`
    ***REMOVED******REMOVED***#sb-group***REMOVED******REMOVED***
      template block text
    ***REMOVED******REMOVED***/sb-group***REMOVED******REMOVED***
  `);
